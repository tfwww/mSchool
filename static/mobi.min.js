...
Mobi.autoFixGWebTop = function(f) {
    ...
    if (f !== 2 && f !== 7 && f !== 8) {
        ...
        if (d) {
            ...
            d = jm("<div id='fk-gWebPlaceholdPT' style='height:" + k + "px;'></div>");
            jm(h).prepend(d)
        }
        return
    }
    ...
    j.style.top = k + "px";
    var d = Mobi.getPreviewObject("fk-gWebPlaceholdPT");
    var a = Mobi.getPreviewObject("header");
    if (d) {
        d.style.height = (a.offsetHeight + k) + "px"
    } else {
        d = jm("<div id='fk-gWebPlaceholdPT' style='height:" + (a.offsetHeight + k) + "px;'></div>");
        jm(h).prepend(d)
    }
};
...
Mobi.ing = function(o, p, l) {
    var e = (o == null || o == "") ? "正在处理...": o;
    var n = "";
    if (p == "" || p == null || p == 0) {
        n = "<div class='icon-errorTigs'></div>"
    } else {
        if (p == 1) {
            n = "<div class='icon-succeedTigs'></div>"
        } else {
            if (p == -1) {
                n = ""
            }
    ...
    if (j.indexOf("2052") >= 0) {
        ...
        if (i > 13 && i < 39) {
            i = 15;
            e = o.substring(0, 13) + "<br>" + o.substring(13)
        } else {
            if (i > 39) {
                i = 15;
                e = o.substring(0, 13) + "<br>" + o.substring(13, 39) + "<br>" + o.substring(39)
            }
        }
    } else {
        i = parseFloat(o.length) / 2;
        if (i > 15) {
            var h = o.substring(0, 30).lastIndexOf(" ");
            if (o.charAt(30) != "" && i < 50) {
                if (h < 15) {
                    h = 30
                }
                e = o.substring(0, h) + "<br>" + o.substring(h)
            } else {
                if (i > 50) {
                    var f = o.substring(30, 50).lastIndexOf(" ");
                    e = o.substring(0, h) + "<br>" + o.substring(h, f) + "<br>" + o.substring(f)
                }
            }
            i = 15
        }
    ...
    var c = parseInt(Math.random() * 10000);
    var m = '<div id="' + c + '" class="mobiTips" style=\'width:' + i + "; '><div id=\"mobiMsg" + c + '" class="mobiMsg">' + n + "<div class=''>" + e + "</div></div></div>";
    b.html(m);
    if (!l) {
        window.setTimeout(function() {
            b.css("visibility", "hidden");
...
Mobi.initForms = function() {
    ...
    for (var b = 0; b < c.length; b++) {
        ...
        if (e) {
            e = e.replace("module", "");
            if (a.getAttribute("_autoHeight") != 1 && !(jm(a).hasClass("formStyle52") || jm(a).hasClass("formStyle53"))) {
...
Mobi.fixFontSizeDeviation = function() {
    var j = document.querySelector("#webModuleContainer"),
    p = j.querySelectorAll(".form");
    for (var u = 0; u < p.length; u++) {
        var c = p[u],
        n = c.getAttribute("id"),
        B = jm(c).hasClass("formStyle51") || jm(c).hasClass("formStyle52") || jm(c).hasClass("formStyle53") || jm(c).hasClass("formStyle54");
        if (n) {
            n = n.replace("module", "");
            var c = Mobi.getPreviewObject("module" + n);
            if (!c) {
                continue
            }
            var z = c.querySelector(".formBannerTitle"),
            f = c.querySelector(".formMiddleContent"),
            e = c.querySelector(".photoModule"),
            s = jm(z).find(".titleCenter"),
            y = jm(z).find(".titleTextIcon"),
            v = jm(c).css("margin-left"),
            q = jm(c).css("margin-right"),
            o = jm(c).css("margin-top"),
            a = jm(c).css("margin-bottom"),
            h = jm(z).css("height"),
            r = jm(f).css("margin-left"),
            m = jm(f).css("margin-right"),
            l = jm(f).css("margin-top"),
            x = jm(f).css("margin-bottom"),
            A = jm(f).attr("_innerType"),
            d,
            w,
            t,
            b,
            ...
            if (A == 0 && !B) {
                if (!Fai.top._manageMode) {
                    ...
                    Fai.top.Mobi.setModuleStyleCss(n, ".formMiddleContent" + n, "margin-bottom", "0.5rem");
                    Fai.top.Mobi.setModuleStyleCss(n, ".formMiddle" + n, "padding-bottom", "0.25rem")
                }
            }
            if (v != "0px") {
                c.style.marginLeft = parseInt(v.replace("px", "")) / _htmlFontSize + "rem"
            }
            if (q != "0px") {
                c.style.marginRight = parseInt(q.replace("px", "")) / _htmlFontSize + "rem"
            }
            if (o != "0px") {
                c.style.marginTop = parseInt(o.replace("px", "")) / _htmlFontSize + "rem"
            }
            if (a != "0px") {
                c.style.marginBottom = parseInt(a.replace("px", "")) / _htmlFontSize + "rem"
            }
            d = h.replace("px", "") / _htmlFontSize;
            z.style.height = d + "rem";
            if (z.getAttribute("_bannerAutoHeight") == 0) {
                if (!Fai.top._manageMode) {
                    s.css("height", d + "rem");
                    s.css("line-height", d + "rem");
                    y.css("height", d + "rem");
                    y.css("line-height", d + "rem")
                } else {
                    Fai.top.Mobi.setModuleStyleCssList(n, [{
                        cls: ".formBannerTitle" + n + " .titleCenter" + n,
                        key: "height",
                        value: d + "rem"
                    },
                    {
                    ...
                    {
                        cls: ".formBannerTitle" + n + " .titleTextIcon" + n,
                        key: "height",
                        value: d + "rem"
                    },
                    {
            ...
            if (r != "0px") {
                w = parseInt(r.replace("px", "")) / _htmlFontSize;
                if (!Fai.top._manageMode) {
                    f.style.marginLeft = w + "rem"
                } else {
                    Fai.top.Mobi.setModuleStyleCss(n, ".formMiddleContent" + n, "margin-left", w + "rem")
                }
            }
            if (m != "0px") {
                t = parseInt(m.replace("px", "")) / _htmlFontSize;
                if (!Fai.top._manageMode) {
                    f.style.marginRight = t + "rem"
                } else {
                    Fai.top.Mobi.setModuleStyleCss(n, ".formMiddleContent" + n, "margin-right", t + "rem")
                }
            }
            if (l != "0px") {
                b = parseInt(l.replace("px", "")) / _htmlFontSize;
                if (!Fai.top._manageMode) {
                    f.style.marginTop = b + "rem"
                } else {
                    Fai.top.Mobi.setModuleStyleCss(n, ".formMiddleContent" + n, "margin-top", b + "rem")
                }
            } else {
                if (l == "0px") {
                    if (!Fai.top._manageMode) {
                        ...
                        Fai.top.Mobi.setModuleStyleCss(n, ".photoModule", "margin-top", "0")
                    }
                }
            }
            if (x != "0px") {
                k = parseInt(x.replace("px", "")) / _htmlFontSize;
                if (!Fai.top._manageMode) {
                    f.style.marginBottom = k + "rem"
                } else {
                    Fai.top.Mobi.setModuleStyleCss(n, ".formMiddleContent" + n, "margin-bottom", k + "rem")
                }
            } else {
                if (x == "0px") {
                    if (!Fai.top._manageMode) {
                        jm(e).css("marginBottom", "0");
                        jm(".formMiddle" + n).css("paddingBottom", "0")
                    } else {
                        Fai.top.Mobi.setModuleStyleCss(n, ".photoModule", "margin-bottom", "0");
                        Fai.top.Mobi.setModuleStyleCss(n, ".formMiddle" + n, "padding-bottom", "0")
                    }
                }
            }
        }
...
Mobi.onlineServiceInputWord = function() {
    ...
    var h = document.querySelectorAll("input[type='text']"),
    f = document.querySelectorAll("textArea"),
    e = [],
    a = document.getElementById("webCustomerServiceBox"),
    d = false;
    if (a) {
        d = a.querySelectorAll(".service").length > 0 ? true: false
    }
    if (!a || !d) {
        return
    }
    ...
    for (var c = 0; c < e.length; c++) {
        e[c].addEventListener("blur",
        function() {
            a.style.display = "block"
        },
        false);
        e[c].addEventListener("focus",
        function() {
...
Mobi.initWebPage = function(f) {
    ...
    var s, h = jm("#webPagePanel" + q);
    if (h.length !== 0) {
        h.remove();
        h = jm("#webPagePanel" + q)
    }
    var m = "webPagePanelRight";
    var l = false;
    if (o === "left") {
        m = "webPagePanelLeft"
    } else {
        if (o === "top") {
            ...
            if (o === "bottom") {
                m = "webPagePanelBottom"
            }
        }
    }
    var r = "";
    if (c) {
        r = "<div class='webPagePanelBg' style='z-index:999'></div>"
    }
    var d = 0;
    var b = 0;
    jm("#" + q).bind("click",
    ...
    var p = function() {
        if (h.length == 0 || s == undefined) {
            jm("#g_web").append("<div id='webPagePanel" + q + "' class='webPagePanel' style='z-index:1000'>" + r + "</div>");
            h = jm("#webPagePanel" + q);
            if (n) {
                h.append(n);
                s = jm(n);
            ...
            s.addClass(m);
            s.addClass("webPagePanel");
            h.show();
            s.show();
            setTimeout(function() {
                s.addClass("webPagePanelShow")
            });
            if (c) {
                Mobi.bindTouchAndClickEvent(jm("#webPagePanel" + q + " .webPagePanelBg"),
                function(z) {
                    s.removeClass("webPagePanelShow");
                    s.removeClass("webPagePanelShow");
                    jm("#g_body").css({
                        overflow: "",
                        height: "",
                    ...
                    jm("#webPagePanel" + q).css("z-index", "-1");
                    window.scrollTo(0, b);
                    return false
                })
            }
            ...
            for (var x = 0; x < w.length; x++) {
                var y = w[x].trim();
                Mobi.bindTouchAndClickEvent(jm(y),
                function(z) {
                    s.removeClass("webPagePanelShow");
                    jm("#g_body").css({
                        overflow: "",
                    ...
                    jm("#webPagePanel" + q).css("z-index", "-1");
                    window.scrollTo(0, b);
                    if (q == "userCommentId" || q == "postComment") {
                        jm("input,textarea").each(function(B, A) {
                            A.blur()
                        })
                    }
            ...
            Mobi.bindTransitionEnd(s,
            function() {
                if (!s.hasClass("webPagePanelShow")) {
                    h.hide()
                }
            })
        } else {
...
Mobi.initProductGroup = function(l, s, b) {
    if (s == 1 || l == 0) {
        return false
    }
    ...
    if (r) {
        ...
        k.height(jm("body").height() - jm("#webHeaderBox").height() + "px")
    }
    ...
    k.css("height", (m - n) + "px");
    v = k.find(".firstGroup .firstGroupItem");
    v.off(".productNewGroup").on("click.productNewGroup",
    function() {
        if (jm(this).hasClass("checkedItem")) {
            return false
        }
        var z = k.find(".firstGroup .checkedItem"),
        i = k.find(".unFirstGroup .checkedPanel");
        var A = jm(this),
        C = jm(A).attr("data-id"),
        B = jm("#sed_" + C),
        y,
        D;
        z.removeClass("checkedItem");
        i.removeClass("checkedPanel");
        A.addClass("checkedItem");
        B.addClass("checkedPanel");
        z.find(".firstGroupName").removeClass("f-fontColor");
        A.find(".firstGroupName").addClass("f-fontColor");
        if (r) {
            a = 0;
            y = v.find(".J_navSelect").removeClass("fk-navSelect");
            A.find(".J_navSelect").addClass("fk-navSelect");
            a = jm("body")[0].clientWidth / 2 - A[0].getBoundingClientRect().left;
            clearInterval(D);
            if (a > 0) {
    ...
    if (l != 5 && l != 6) {
        ...
        v.each(function(i, y) {
            x = jm(y);
            h = y.offsetWidth + 2 + parseFloat(x.css("margin-right").replace("px", ""));
            q += h
        });
    ...
    function j(E, y) {
        if (E.length == 0 || !y.fileId || y.fileId.length == 0) {
            return
        }
        var C = parseInt(jm(E).parent().attr("data-id"));
        var i = y.fileId;
        var B = y.filePath;
        var D = y.isDefaultColor;
        var z = y.color;
        var A = "ajax/productGroup_h.jsp?cmd=setSingle&id=" + C + "&mIcon=" + i;
        if (!D) {
            A = A + "&mIconColor=" + Fai.top.Fai.encodeUrl(z)
        }
        jm.ajax({
            url: A,
            type: "get",
            ...
            success: function(F) {
                var I = $.parseJSON(F);
                if (I.success) {
                    var J = jm(E).parent().find(".J_itemImage");
                    var H = jm(J).parent();
                    var G = r ? "f-itemImg": "itemImage";
                    H.empty();
                    if (top.Fai.isFontIcon(i)) {
                        if (!D) {
                            H.append("<span class='J_itemImage " + G + " " + B + "' style='color:" + z + "'></span>")
                        } else {
                            H.append("<span class='J_itemImage " + G + " " + B + "'></span>")
                        }
                    } else {
                        H.append("<img  class='J_itemImage " + G + "' src='" + B + "' data-w='" + y.fileWidth + "' data-h='" + y.fileHeight + "' />")
                    }
                    u(jm(H).find(".J_itemImage"));
                    top.Fai.ing(I.msg, true)
                } else {
                    top.Fai.ing(I.msg, true)
                }
            }
    ...
    function u(A) {
        var z = parseInt(jm(A).attr("data-w")),
        B = parseInt(jm(A).attr("data-h")),
        y = r ? "3.0rem": "2.8rem",
        i = r ? "3.0rem": "2.9rem";
        if (z >= B) {
            jm(A).css("width", y).css("height", "auto").css("vertical-align", "middle")
        } else {
            if (B > z) {
                jm(A).css("width", "auto").css("height", i).css("display", "block").css("margin", "0 auto")
            }
        }
    }
};
Mobi.QuickIn = {
    ...
    function h() {
        ...
        var j;
        f(i.targets).find(".quick_in").unbind("click.quickIn").bind("click.quickIn",
        function(l) {
            j = f(this);
            switch (i.type) {
        ...
        f(i.targets).off(".quickIn").on("mouseenter.quickIn",
        function() {
        ...
        if (c.type === "confirm") {
            ...
            var m = b.extend({
                ...
                beforeShow: function(i) {
                    j.touch(b(".fkarea-ui-confirm-submit", i),
                    function() {
                    ...
                    j.touch(b(".fkarea-ui-confirm-no", i),
                    function() {
    ...
    a.prototype = {
        ...
        setPosition: function() {
            if (this.showed) {
                ...
                var k = this.settings.clientWidth || document.documentElement.clientWidth || document.body.clientWidth;
                var e = this.width / 2;
                var c = this.height / 2;
                var d = k / 2 - e;
                var j = h / 2 - c;
                d = Math.floor(Math.max(0, d));
                j = Math.floor(Math.max(0, j));
                var f = "absolute";
                var l = "768px";
                if (jm && jm("#g_web") && jm("#g_web").length > 0) {
                    l = jm("#g_web").css("max-width")
                }
                if (i.settings.fixed) {
                    f = "fixed"
                }
                i.dialogContainer.css({
                    position: f,
                    top: j,
                    width: "100%",
                    left: 0,
...
Mobi.initProductGroupManage = function(b, c) {
    ...
    $(a).mouseover(function() {
        ...
        Mobi.addModuleLayer("module" + b)
    })
};
Mobi.ajaxClick = function(h, f, c) {
    showLoadingAgain = function(k) {
        closeLoading(k);
        var e = ['<div class="ajaxLoadingAgain width" style="margin-top:50px;margin-bottom:50px;text-align:center;">', '<div style="color: #1b7ad1; text-decoration: none; text-align:center; width:100%;cursor:pointer;" onclick="reloadingClick(' + k + ');">加载失败，请点击重新加载</div>', "</div>"];
        jm("#module" + k + " .middleCenter").empty().append(e.join(""))
    };
    ...
    loadingAjaxDom = function(e) {
        ...
        jm.ajax({
            ...
            data: "cmd=getAjaxPageModuleInfo&_colId=" + a + "&_extId=" + j + "&moduleId=" + e + "&href=" + jm.encodeUrl(b),
            error: function(k) {
                d = true;
                closeLoading(e);
                showLoadingAgain(e);
            ...
            success: function(k) {
                ...
                if (k.success) {
                    var l = jm(k.domStr).find(".middleCenter" + e).html();
                    var m = jm("#module" + e).find(".middleCenter" + e);
                    m.html(l);
                    jm.fkEval.call(window, k.scripts)
                } else {
                    showLoadingAgain(e);
                    Mobi.ing(k.msg)
                }
...
Mobi.showTopTips = function() {
    if (jm("#webTips").length > 0) {
        jm("#mobiTipsMarquee").append('<li style="color:red;font-size:14px;margin-left:20px;">免费域名不支持调用第三方代码，请使用已购买的域名进行访问&nbsp;&nbsp;&nbsp;</li>');
        Mobi.topTipMarquee();
        return
    }
    var a = ['<div id="webTips" class="webTips jz-webTips">', '   <div id="mobitips" class="mobitips">', '       <div class="mobiScrollbar">', '           <div class="j-marqueeContainer J_marqueeContainer">', '               <ul class="marquee J_marquee" id="mobiTipsMarquee">', '                  <li style="color:red;font-size:14px;">免费域名不支持调用第三方代码，请使用已购买的域名进行访问&nbsp;&nbsp;&nbsp;</li>', "               </ul>", "           </div>", "       </div>", "   </div>", "</div>", ];
    jm("body").prepend(a.join(""));
...
Mobi.showNavItemContainer = function() {
    ...
    if (m > t) {
        ...
        var B = jm.getCookie("startX") ? parseInt(jm.getCookie("startX")) : 0;
        if (jm.os.supportsTouch) {
            var c = new iScroll(b, {
                x: B,
                scrollX: true,
                ...
                remarkNavLeftRight: A
            });
            A(B, c);
            function A(i, j) {
                var p = j.wrapper.querySelector(".navLeft") ? j.wrapper.querySelector(".navLeft") : j.wrapper.querySelector(".navTouchLeft"),
                F = j.wrapper.querySelector(".navRight") ? j.wrapper.querySelector(".navRight") : j.wrapper.querySelector(".navTouchRight");
                p.className = "navTouchLeft";
                F.className = "navTouchRight";
                if (i < 0) {
        ...
        function() {
            var i = jm(this),
            F = i.offset(),
            p = jm.os.supportsTouch ? c.x: parseInt(y.css("left").replace("px", "")),
            j = parseInt(i.width());
            if (E.right < F.right) {
                jm.setCookie("startX", p - j)
            } else {
                if (E.left > F.left) {
                    y += parseInt(i.width());
                    jm.setCookie("startX", p + j)
...
Mobi.fixNavIconPosition = function() {
    var j = Fai.top._templateLayoutId,
    p = 0,
    t = 1,
    h = 2,
    n = 3,
    ...
    if (m.length < 1 || s.length < 1) {
        return
    }
    b = jm(m[0]);
    u = parseFloat(m[0].offsetWidth);
    b.addClass("fk-fixNavIconStyle");
    o = parseFloat(m[0].offsetWidth);
    f = parseFloat(m[0].offsetHeight);
    b.removeClass("fk-fixNavIconStyle");
    if (u > o) {
        return
    }
    d.each(function(v, w) {
        c = jm(w).parent().attr("id");
...
Mobi.setModuleHeight2 = function(a, k) {
    ...
    var c = _htmlFontSize / 20.5;
    k *= c;
    k = parseInt(k);
    b.style.height = k / _htmlFontSize + "rem";
    var e = b.querySelector(".formBannerTitle" + a);
    var h = b.querySelector(".formMiddle");
    var i = 0;
    if (e.style.display != "none") {
        i = e.offsetHeight
    }
    var f = k - i - Mobi.getFrameHeight(h);
    h.style.height = f / _htmlFontSize + "rem";
    var j = h.querySelector(".middleCenter");
    f = f - Mobi.getFrameHeight(j);
    var d = h.querySelector(".formMiddleContent");
    f = f - Mobi.getFrameHeight(d);
    d.style.height = f / _htmlFontSize + "rem";
    d.style.overflow = "hidden";
    if (jm(b).hasClass("formStyle51")) {
        h.querySelector(".J_packContentList").style.height = f / _htmlFontSize + "rem"
    }
};
...
Mobi.msgBoardAddMsg = function(o, m, b) {
    var a = jm("#reqName").val();
    var i = jm("#reqPhone").val();
    var j = jm("#reqEmail").val();
    var h = jm("#reqContent").val();
    var n = jm("#msgBoardCaptcha").val();
    var c = jm(".notice").show();
    var k = jm(".J_msgBoardCaptcha");
    var f = 0;
    jm("input.msg_isMust").each(function() {
        var q = jm(this).attr("id");
        var r = jm(this).attr("placeholder");
        var p = jm(this).val();
        if (p == "" || p == null) {
            c.html(jm.format(LS.msgBoardInputIsEmpty, jm.encodeHtml(r)));
            Mobi.getPreviewObject(q).focus();
            f = 1;
            return false
        }
        if (q == "reqPhone" && !jm.isPhone(p)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(r)));
            Mobi.getPreviewObject(q).focus();
            f = 1;
            return false
        }
        if (q == "reqEmail" && !jm.isEmail(p)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(r)));
            Mobi.getPreviewObject(q).focus();
            f = 1;
            return false
    ...
    jm("input.msg_ipt").each(function() {
        ...
        var p = jm(this).val();
        var r = jm(this).attr("maxlength");
        if (p.length > r) {
            c.html(jm.format(LS.msgBoardInputMaxLength, jm.encodeHtml(s), r));
            e = 1;
            return false
        }
        if (q == "reqPhone" && p.length && !jm.isPhone(p)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(s)));
            Mobi.getPreviewObject(q).focus();
            e = 1;
            return false
        }
        if (q == "reqEmail" && p.length && !jm.isEmail(p)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(s)));
            Mobi.getPreviewObject(q).focus();
            e = 1;
            return false
    ...
    if (!k.hasClass("msgBoardCaptchaHide")) {
        if (n == null || n == "") {
    ...
    l.reqContent = h;
    l.memberId = (m === undefined) ? 0 : m;
    jm.ajax({
        type: "post",
        url: "ajax/msgBoard_h.jsp",
        data: "cmd=add&msgBdData=" + jm.encodeUrl(jm.toJSON(l)) + "&validateCode=" + jm.encodeUrl(n) + "&moduleId=" + jm.encodeUrl(b),
        error: function() {
        ...
        success: function(p) {
            ...
            if (p.success) {
                ...
                if (p.needCode) {
                    Mobi.msgBoardShowMsg(p.msg);
                    k.removeClass("msgBoardCaptchaHide")
                }
                if (p.hasFW) {
                    Mobi.ing(p.msg);
                    jm(".notice").hide()
...
Mobi.siteFormAdd = function(a, p, n, e, c) {
    ...
    if (o.length > 0) {
        ...
        function(F, D) {
            ...
            H.type = u;
            if (u == 0) {
                var J = jm("#M" + a + "F" + p + "siteFormInput" + A).val();
                if (B && J == "") {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(L)));
                    b = false;
                    return false
                }
                if (J.length > k) {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(L), k));
                    b = false;
                    return false
                }
                H.val = J
                ...
                if (u == 1) {
                    var q = jm("#M" + a + "F" + p + "siteFormTextArea" + A).val();
                    if (B && q == "") {
                        Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(L)));
                        b = false;
                        return false
                    ...
                    if (q.length > d) {
                        Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(L), d));
                        b = false;
                        return false
                    }
                    H.val = q
                    ...
                    if (u == 2) {
                        var w = document.querySelectorAll("input[name='M" + a + "F" + p + "siteFormRadioR" + A + "']:checked");
                        if (B && w.length == 0) {
                            Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(L)));
                            b = false;
                            return false
                        }
                        if (w.length > 0) {
                        ...
                        if (u == 3) {
                            var x = document.querySelectorAll("input[name='M" + a + "F" + p + "siteFormCheckboxR" + A + "']:checked");
                            if (B && x.length == 0) {
                                Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(L)));
                                b = false;
                                return false
                            ...
                            if (u == 4) {
                                var z = document.getElementById("M" + a + "F" + p + "siteFormSelect" + A),
                                C = z.options[z.selectedIndex].value;
                                if (B && (C.length == 0 || C == "none")) {
                                    Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(L)));
                                    b = false;
                                    return false
                                }
                                ...
                                if (u == 5) {
                                    ...
                                    if (u == 6) {
                                        var J = jm("#Mobi" + a + "Calendar" + A + "Pluginsinput").val(),
                                        v = D.dateSetting ? D.dateSetting.type: 0,
                                        y = v == 1 ? jm("#Mobi" + a + "Calendar" + A + "Plugins_endinput").val() : "";
                                        if (B && (J == "" || (v == 1 && y == ""))) {
                                            Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(L)));
                                            b = false;
                                            return false
                                        ...
                                        if (u == 7) {
                                            var r = jm("#module" + a).find("#siteForm" + a + "fileName" + A);
                                            var I = {};
                                            if (B && r.attr("_tmpFileId") == "") {
                                                Mobi.ing("请选择文件上传");
                                                b = false;
                                                return false
                                            }
                                            if (r.attr("_tmpFileId") == "") {
                                                ...
                                                H.val = r.attr("_fileId");
                                                I.tmpFileName = r.attr("_tmpFileName");
                                                I.fileId = H.val;
                                                I.tmpFileId = r.attr("_tmpFileId");
                                                j.push(I)
                                            }
                                        } else {
                                            if (u == 8) {
                                                var K = jm("#M" + a + "F" + p + "siteFormPhoneInput" + A).val();
                                                if (B) {
                                                    if (K == "") {
                                                        Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(L)));
                                                        b = false;
                                                ...
                                                if (u == 9) {
                                                    var G = jm("#M" + a + "F" + p + "siteFormMailInput" + A).val();
                                                    if (B) {
                                                        if (G == "") {
                                                            Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(L)));
                                                            b = false;
                                                            ...
                                                            if (!jm.isEmail(G)) {
                                                                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, jm.encodeHtml(L)));
                                                                b = false;
                                                                return false
                                                            }
                                                        }
                                                    ...
                                                    if (u == 10) {
                                                        var t = jm("#M" + a + "F" + p + "siteFormIndentityInput" + A).val();
                                                        if (B) {
                                                            if (t == "") {
                                                                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(L)));
                                                                b = false;
                                                        ...
                                                        if (u == 11) {
                                                            var s = jm("#M" + a + "F" + p + "siteFormAddressInput" + A).val();
                                                            if (B && s == "") {
                                                                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(L)));
                                                                b = false;
                                                                return false
...
Mobi.initmobiFormTimeBtn = function(f) {
    ...
    for (r = 0; r < n.length; r++) { (function(B) {
            var i = n[B],
            z = i.isStart,
            y = i.elem,
            x = p ? (z ? "fk-datePickStart": "fk-datePickEnd") : "",
            A = v.banPassDate == 1 ? w: new Date(1900, 0, 1),
            C = "";
            if (p) {
                C = z ? "<div class='fk-calendarNav'>请选择开始日期</div>": "<div class='fk-calendarNav'>请选择结束日期</div>"
            }
            y.Calendar({
                inputExtClass: x,
                minDate: A,
                ...
                minHour: q || 0,
                drawNavHeaderHtml: C,
                onBeforeInitCalendar: function(E) {
                    var D = E._options;
                    if (E._container.hasClass("fk-startDateInput")) {
                        E._option("minDate", A);
                        E._option("maxDate", null)
                    }
                    E._input[0].blur();
                ...
                onBeforeCancel: function(E) {
                    var D;
                    if (p && z) {
                        D = E.getTargetOption(E._container[0].id + "_end");
                        D._hideDate(D._container, D)
                    }
                },
                beforeShowTime: function(D, E) {
                    if (v.ot.unSelectTime.length > 0 && jm.inArray(D, v.ot.unSelectTime) > -1) {
                        return false
                    }
                    return true
                },
                beforeShowDay: function(D, E) {
                    return h(D)
                },
                onAfterRefresh: function(F) {
                    var E = F._options,
                    D;
                    if (p) {
                        F._container.find(".ui-state-active").addClass("ui-state-active-hide");
                        if (!z) {
                            F._container.find("td").not(".ui-calendar-unSelectable").eq(0).find(".ui-state-default").addClass("ui-calendar-startDate")
                        }
                    }
                },
                onSelectDate: function(I, J) {
                    if (!p) {
                        return
                    }
                    var G = I.replace(/-/g, "/"),
                    L = new Date(G),
                    Q = new Date(L.getFullYear(), L.getMonth(), L.getDate()).getTime(),
                    K = {
                        minDate: A,
                        maxDate: null
                    },
                    E = J._container.hasClass("fk-startDateInput"),
                    H,
                    F,
                    D,
                    N,
                    ...
                    if (E) {
                        D = J.getTargetOption(J._container[0].id + "_end");
                        P = D._input.val();
                        M = typeof P == "string" ? P.replace(/-/g, "/") : "";
                        N = new Date(M).getTime();
                        if ( !! N && (( !! K.minDate && N < K.minDate.getTime()) || ( !! K.maxDate && N > K.maxDate.getTime()))) {
                            D._input.val("")
                        }
                    } else {
                        D = J.getTargetOption(J._container[0].id.replace("_end", ""))
                    }
                    if ( !! D) {
                        D._option("minDate", new Date(K.minDate));
                        D._option("maxDate", K.maxDate != null ? new Date(K.maxDate) : null);
                        D.switchMonthTo(J._options._selectedMonth, J._options._selectedYear);
                        D.refresh()
                    }
                },
                onAfterSelectDate: function(D, E) {
                    if (z) {}
                },
                onAfterHidePicker: function(D) {
                    if ((p && !z) || !p) {
    ...
    function s(B, i, y) {
        var x, z, A;
        z = jm("<div class='fk-dateInputMaskWrap'></div>");
        x = jm("<div class='fk-dateInputMask'></div>");
        z.insertAfter(B);
        z.append(B);
        z.append(x);
        x.on("click",
        function() {
            jm(i + "input").trigger("click");
            jm(y + "input").trigger("click")
        })
    }
    function h(y) {
        var x = true,
        ...
        if (v.od.t == 1 && jm.inArray(z, v.od.unSelectDay) > -1) {
            x = false
        }
        if (v.od.t == 1 && jm.inArray(z, v.od.openDay) > -1) {
            x = true
        }
        return x
    }
    ...
    jm.ajax({
        ...
        success: function(i) {
            ...
            if (i.success) {
                ...
                if (i.active) {
                    Mobi.memberActive(i.email, i.memName)
                } else {
                    if (i.rt == -3) {
                        Mobi.memberOtherLoginFill(l, f, k, b, 2, i.mobileCtNameList, i.signNeenMobile, a)
                    } else {
                        if (i.rt == -303) {
...
Mobi.wxLogin = function(b, c, f, j, d, i, e, h, a) {
    jm("#" + b).click(function() {
        ...
        if (j == "wxb98d3675b04fbc2f") {
            Mobi.logDog(200314, c)
        }
        if (e) {
        ...
        jm.cookie("_wxLoginKey", i, {
            expires: 1
        });
        window.location.href = f + "wxLogin.jsp?aid=" + c + "&appId=" + j + "&key=" + encodeURIComponent(d) + "&returnUrl=" + encodeURIComponent(document.location.href) + "&authLogin=true"
    })
};
Mobi.wxOpenIdLogin = function(optionList, noRemark, remarkMaxLen, openId, nickName, headImg, url) {
    if (typeof(optionList) == "string") {
        optionList = jm.parseJSON(optionList)
    }
    var hasMobile = Mobi.checkHasMobileOption(optionList);
    ...
    var data = "loginType=4&openId=" + encodeURIComponent(openId);
    if (!otherLoginMust) {
...
Mobi.memberOtherBindOrLogin = function(f, b, c, e, i, h, d, a) {
    var j = [];
    j.push("<div style='height:7.38rem;'>");
    j.push("<div class='avator loginAvatorCircle' style='background-image:url(" + h + ");'></div>");
    j.push("<div class='userName' style='margin-top:0.5rem;'>" + i + "</div>");
    j.push("</div>");
    j.push("<div class='remarkCon'>");
    j.push("<div class='remarkLine'></div>");
    j.push("</div>");
    j.push("<div class='signupSubmitCtrl g_globalLine' style='margin-top:0.6rem;'>");
    j.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon' onclick='Mobi.bindOtherAcctFirst(\"" + d + '","' + e + "\");' value='" + LS.memberOtherLgnBindAcct + "'/>");
    j.push("</div>");
    j.push("<div class='signupSubmitCtrl g_globalLine' style='margin-top:0.78rem;'>");
    if (d == "other_qq") {
        j.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon g_mainColor' style='background:rgb(240,240,245);border:1px solid;' onclick='Mobi.qqWinListener(" + f + ", " + b + "," + c + ',"' + e + '","' + i + '","' + h + '","' + a + "\");' value='" + LS.memberOtherLgnNow + "'/>")
    } else {
        if (d == "other_wb") {
            j.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon g_mainColor' style='background:rgb(240,240,245);border:1px solid;' onclick='Mobi.wbWinListener(" + f + ", " + b + "," + c + ',"' + e + '","' + i + '","' + h + '","' + a + "\");' value='" + LS.memberOtherLgnNow + "'/>")
        } else {
            if (d == "other_wx") {
                j.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon g_mainColor' style='background:rgb(240,240,245);border:1px solid;' onclick='Mobi.wxOpenIdLogin(" + f + ", " + b + "," + c + ',"' + e + '","' + i + '","' + h + '","' + a + "\");' value='" + LS.memberOtherLgnNow + "'/>")
            }
        }
    }
    j.push("</div>");
    ...
    if (!jm("#bindOrLogin .loginContent").children().length) {
        jm("#bindOrLogin .loginContent").append(j.join(""))
    }
    jm("#mLogin").hide();
    jm("#bindOrLogin").show();
...
Mobi.bindOtherAcctFirst = function(c, a) {
    if (c == "other_qq") {
        c = 1
    } else {
        if (c == "other_wb") {
    ...
    b += "</div>";
    b += "<div class='g_globalLine'>";
    b += "<input type='button'  class=' g_button sendIcon' onclick='Mobi.bindOtherAcctFirstSubmit(" + c + ',"' + a + "\")' value='" + LS.memberOtherLgnBindNow + "'/>";
    b += "</div>";
...
Mobi.memberOtherLoginFill = function(i, a, c, k, f, e, h, b) {
    var l = [];
    l.push("<div style='height:5rem;'>");
    if (f == 1 || f == 4) {
        l.push("<div class='avator loginTypeAvator' style='background-image:url(" + k + ");'></div>")
    } else {
        l.push("<div class='avator otherLoginTypeAvator' style='background-image:url(" + k + ");'></div>")
    }
    l.push("<div class='userName' style='margin-top:0.5rem;'>" + a + "</div>");
    l.push("</div>");
    l.push("<div class='remarkCon'>");
    l.push("<div class='remarkLine'></div>");
    l.push("<div class='remarkInfo'>" + LS.memberOtherLgnLastStep + "</div>");
    l.push("</div>");
    var d = "";
    if (Mobi.checkHasMobileOption(i)) {
        d = "tagWidth8"
    }
    var j = "";
    jm.each(i,
    function(o, s) {
        ...
        if (s.otherLoginMust) {
            if ("email" == s.fieldKey) {
                j = "icon-emailIcon g_mainColor"
            } else {
                if ("phone" == s.fieldKey) {
                    j = "icon-phoneIcon g_mainColor"
                } else {
                    if ("name" == s.fieldKey) {
                        j = "icon-nameIcon g_mainColor"
                    } else {
                        j = "icon-customIcon g_mainColor";
                        q = "customIcon"
                    }
                }
            }
            ...
            if ("mobile" == s.fieldKey) {
                l.push("<div class='g_globalLine " + d + "'>");
                l.push("<select id='mobileCt' name='mobileCt' class='itemEdit g_select'>");
                for (var m = 0; m < e.length; m++) {
                    l.push("<option value='" + e[m]["ctName"] + "'>" + e[m]["ctShowName"] + e[m]["ctCode"] + "</option>")
                }
                l.push("</select>");
                l.push("<span class='" + q + "'>" + LS.mobileAreaCode + "</span>");
                l.push("</div>")
            }
            if (s.dropDownType) {
                l.push("<div class='g_globalLine " + d + "'>");
                if (s.must) {
                    l.push("<select id='" + s.fieldKey + "' name='" + s.name + "' class='itemEdit userAddItem isCheckUAI g_select' placeholder='" + r + LS.memberOtherLgnMust + "'>");
                    l.push("<option value=''>" + s.name + LS.memberOtherLgnMust + "</option>")
                } else {
                    l.push("<select id='" + s.fieldKey + "' name='" + s.name + "' class='itemEdit userAddItem g_select' placeholder='" + r + "'>");
                    l.push("<option value=''>" + s.name + "</option>")
                }
                var p = s.dropDownContent.split("&");
                for (var o = 0; o < p.length; o++) {
                    l.push("<option value='" + p[o] + "'>" + p[o] + "</option>")
                }
                l.push("</select><span class='" + j + "'></span>");
                if (q != "") {
                    l.push("<span class='" + q + "'>" + s.name + "</span>")
                }
                l.push("</div>")
            } else {
                l.push("<div class='g_globalLine " + d + "'>");
                if (s.must) {
                    l.push("<input type='text' maxlength='50' id='" + s.fieldKey + "' name='" + s.name + "' class='mustItem isCheckUAI itemEdit userAddItem  g_input' maxlength='50' placeholder='" + r + LS.memberOtherLgnMust + "'><span class='" + j + "'></span>")
                } else {
                    l.push("<input type='text' maxlength='50' id='" + s.fieldKey + "' name='" + s.name + "' class='mustItem itemEdit userAddItem  g_input' maxlength='50' placeholder='" + r + "'><span class='" + j + "'></span>")
                }
                if (q != "") {
                    l.push("<span class='" + q + "'>" + s.name + "</span>")
                }
    ...
    if (h) {
        l.push("<div class='g_globalLine'>");
        l.push("<input id='memberSignupCaptcha' type='text' class='captchaText g_input' maxlength='4' placeholder='" + LS.EnterVerificationCode + "'/><img id='signupCaptchaImg'  class='captchaImg' src='validateCode.jsp?" + (Math.random() * 1000) + "' onclick='Mobi.changeValidateCode(jm(\"#signupCaptchaImg\"))' /><div style='clear:both'></div>");
        l.push("</div>");
        l.push("<div class='g_globalLine'>");
        l.push("<input id='messageAuthCode' type='text' class='captchaText g_input' maxlength='6' placeholder='" + LS.inputMobileCode + "' /><div id='messageAuthCodeClick' onclick='Mobi.getSignMobileCode()' class='fk-sign-getMobileCode' title='" + LS.getMobileCode + "'>" + LS.getMobileCode + "</div><div style='clear:both'></div>");
        l.push("</div>")
    }
    l.push("<div class='signupSubmitCtrl g_globalLine " + d + "' style='margin-top:1rem;'>");
    l.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon' onclick='Mobi.memberOtherLoginSubmit(\"" + a + '", ' + f + ', "' + c + '", "' + b + '", "' + k + "\")' value='" + LS.login + "'/>");
    l.push("</div>");
    jm("#fillAcctInfo").parents(".g_web, .middleCenter").css("background", "#f0f0f5");
    if (!jm("#fillAcctInfo .loginContent").children().length) {
        jm("#fillAcctInfo .loginContent").append(l.join(""))
    }
    jm("#mLogin").hide();
    jm("#bindOrLogin").hide();
...
Mobi.memberOtherLoginAdd = function(b, c, k, j, d, e, i, f, h, a) {
    ...
    if (i == 1) {
        ...
        if (i == 2) {
            ...
            l.push("<div class='firstLine' style='width:5rem;'>" + LS.memberOtherLgnWXUser + ":</div>")
        }
    }
...
Mobi.bindOtherAcct = function(f, e, a, d, c, b) {
    jm("#changeOtherLoginAcct").click(function() {
        ...
        h += "</div>";
        h += "<div class='g_globalLine'>";
        h += "<input type='button'  class=' g_button sendIcon' onclick='Mobi.bindOtherAcctSubmit(" + f + ", true, " + j + ")' value='" + LS.memberOtherLgnBindNow + "'/>";
        h += "</div>";
        ...
        jm("#signUp").click(function() {
            ...
            Mobi.signUp(f, e, a, d, j, c, b)
        })
    })
};
Mobi.signUp = function(f, j, a, c, h, e, i) {
    var d = false;
    var l = [],
    b = "";
    j = jm.parseJSON(j);
    ...
    var k = "";
    l.push("<div class='g_globalLine " + b + "'>");
    l.push("<input type='text' maxlength='50' id='memberSignupAcct' class='mustItem itemEdit userAddItem g_input' placeholder='" + LS.memberSignupRegisterAcctEmpty + LS.memberOtherLgnMust + "'><span class='icon-userIcon g_mainColor'></span>");
    l.push("</div>");
    l.push("<div class='g_globalLine " + b + "'>");
    l.push("<input type='password'  maxlength='20' id='memberSignupPwd' class='mustItem itemEdit icon-pswIcon userAddItem g_input' placeholder='" + LS.memberDialogPleaseEnterPwd + LS.memberOtherLgnMust + "'><span class='icon-pswIcon g_mainColor'></span>");
    l.push("</div>");
    l.push("<div class='g_globalLine " + b + "'>");
    l.push("<input type='password'  maxlength='20' id='memberSignupRepwd' class='mustItem itemEdit icon-pswIcon userAddItem g_input' placeholder='" + LS.memberDialogPleaseEnterPwd2 + LS.memberOtherLgnMust + "'><span class='icon-pswIcon g_mainColor'></span>");
    l.push("</div>");
    jm.each(j,
    function(o, r) {
        var p = "";
        ...
        var q = "";
        if (r.placeholder == r.name) {
            q = LS.memberOtherLgnPleaseInput + r.name
        } else {
            q = r.placeholder
        }
        if ("mobile" == r.fieldKey) {
            l.push("<div class='g_globalLine " + b + "'>");
            l.push("<select id='mobileCt' name='mobileCt' class='itemEdit g_select'>");
            for (var m = 0; m < e.length; m++) {
                l.push("<option value='" + e[m]["ctName"] + "'>" + e[m]["ctShowName"] + e[m]["ctCode"] + "</option>")
            ...
            l.push("</select>");
            l.push("<span class='" + p + "'>" + LS.mobileAreaCode + "</span>");
            l.push("</div>")
        }
        l.push("<div class='g_globalLine " + b + "'>");
        if (r.must) {
            l.push("<input type='text' maxlength='50' id='" + r.fieldKey + "' name='" + r.name + "' class='mustItem isCheckUAI itemEdit userAddItem  g_input' maxlength='50' placeholder='" + q + LS.memberOtherLgnMust + "'><span class='" + k + "'></span>")
        } else {
            l.push("<input type='text' maxlength='50' id='" + r.fieldKey + "' name='" + r.name + "' class='itemEdit userAddItem  g_input' maxlength='50' placeholder='" + q + "'><span class='" + k + "'></span>")
        }
        if (p != "") {
            l.push("<span class='" + p + "'>" + r.name + "</span>")
        }
        l.push("</div>")
    });
    if (a) {
        l.push("<div class='g_globalLine " + b + "'>");
        l.push("<input type='text' class='itemEdit g_input userAddItem' id='memberSignupRemark' maxlength='200' placeholder='" + LS.memberOtherLgnRemark + "'><span class='icon-msgIcon g_mainColor'></span>");
        l.push("</div>")
    }
    if (i) {
        l.push("<div class='g_globalLine'>");
    ...
    if (h == 1) {
        l.push("<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:12rem;'>" + LS.signByQQCanLogin + "</div>")
    } else {
        if (h == 2) {
            l.push("<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:13.5rem;'>" + LS.signByWbCanLogin + "</div>")
        } else {
            l.push("<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:13.5rem;'>" + LS.signByWXCanLogin + "</div>")
        }
    }
    l.push("<div class='signupSubmitCtrl g_globalLine " + b + "'>");
    l.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon' onclick='Mobi.bindOtherAcctSubmit(" + f + ", false, " + h + ");' value='" + LS.memberOtherLgnSignUp + "'/>");
    l.push("</div>");
    if (!jm("#mSignUp .loginContent").children().length) {
        jm("#mSignUp .loginContent").append(l.join(""))
    }
    jm("#mSignUp").show();
    jm("#bindOtherAcct").hide();
...
Mobi.bindOtherAcctFirstSubmit = function(e, a) {
    var b = "cmd=bindOtherAcctFirst";
    var d = {};
    var f = jm("#bindUser").val();
    var c = jm("#bindPassword").val();
    if (f == null || f == "") {
    ...
    jm.ajax({
        type: "post",
        url: "ajax/member_h.jsp?" + b,
        data: "info=" + jm.encodeUrl(jm.toJSON(d)) + "&loginType=" + e + "&uid=" + jm.encodeUrl(a),
        error: function() {
        ...
        success: function(h) {
            ...
            if (i.success) {
                if (i.fromBind) {
                    Mobi.memberActive(i.mail, i.memName)
                } else {
                    if (i.active) {
                        Mobi.memberActive(d.email, d.acct)
                    } else {
                            ...
                            if (i.rt == -6) {
                                ...
                                if (i.rt == -4) {
                                    ...
                                    if (i.rt == -3) {
                                        ...
                                        if (i.rt == Mobi.otherLoginErrno.acctAlreadyBind) {
...
Mobi.bindOtherAcctSubmit = function(k, a, h) {
    var q = "";
    var t = {};
    if (a) {
        Mobi.logDog(200199, 5);
        q = "cmd=bindOtherAcct";
        var l = jm("#bindUser").val();
        ...
        if (jm("#memberSignupRemark").length > 0) {
            p = jm("#memberSignupRemark").val();
            var u = jm("#memberSignupRemark").attr("maxlength");
            if (p.length > u) {
                Mobi.ing(jm.format(LS.memberSignupRegisterRemarkMaxLength, u));
        ...
        jm("#mSignUp .userAddItem").each(function() {
            ...
            t[userAddItemID] = f;
            if (typeof(m) != "undefined" && m != null && f.length > m) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemMaxLength, b, m));
    ...
    jm.ajax({
        type: "post",
        url: "ajax/member_h.jsp?" + q,
        data: "info=" + jm.encodeUrl(jm.toJSON(t)) + "&mid=" + k + "&loginType=" + h,
        error: function() {
            Mobi.ing(LS.memberSignupRegisterError)
        },
        success: function(v) {
            ...
            if (w.success) {
                if (w.fromBind) {
                    Mobi.memberActive(w.mail, w.memName)
                } else {
                    if (w.active) {
                        Mobi.memberActive(t.email, t.acct)
                    } else {
                        document.location.reload()
                    }
                }
            } else {
                if (w.msg == "该帐号已绑定到其他帐号") {
                                ...
                                if (w.rt == -6) {
                                    ...
                                    if (w.rt == -4) {
                                        ...
                                        if (w.rt == -3) {
                                            ...
                                            if (w.rt == Mobi.otherLoginErrno.acctAlreadyBind) {
                                                Mobi.ing(LS.memberOtherLgnAcctAlreadyBind)
                                            } else {
                                                Mobi.ing(LS.memberSignupRegisterError)
                                            }
...
Mobi.memberOtherLoginSubmit = function(name, loginType, openId, url, avator) {
    ...
    jm.ajax({
        ...
        data: "info=" + jm.encodeUrl(jm.toJSON(info)) + "&loginType=" + loginType + "&openId=" + encodeURIComponent(openId),
        error: function() {
            Mobi.ing(LS.memberSignupRegisterError)
        },
        success: function(result) {
...
Mobi.memberSignupSubmit = function(b) {
    ...
    jm(".userAddItem").each(function() {
        ...
        r[userAddItemID] = e;
        if (typeof(k) != "undefined" && k != null && e.length > k && f == "input") {
    ...
    jm.ajax({
        ...
        success: function(t) {
            ...
            if (u.success) {
                if (u.active) {
                    Mobi.memberActive(r.email, r.acct, b,
                    function() {})
                } else {
                    if (u.rt == 0) {
                        Fai.top.location.href = "login.jsp?errno=-303"
...
Mobi.memberAddrInfoOpera = function(b, c, v, s) {
    var j = c,
    y = "",
    l = "",
    f = j.length,
    ...
    jm("#addrInfoList .orderAddAddrInfo").click(function() {
        ...
        if (f < 6) {
            ...
            y = "addAddr";
            x = "ajax/member_h.jsp?cmd=set&id=" + b
        } else {
    ...
    function() {
        ...
        if (jm(this).attr("class") == "edit") {
            l = jm(this).attr("_index")
        } else {
            l = jm(this).parent().attr("_item")
        }
        y = "editAddr";
        x = "ajax/member_h.jsp?cmd=set&id=" + b;
        var F = j[l];
        jm("#editAddrInfo").find(".propItemValue").each(function() {
            var N = jm(this).attr("_field");
            jm(this).val(F[N]);
            if ("mobile" == N) {
                if ("mobileCt" in F) {
        ...
        if (M != null) {
            ...
            if (!I) {
                ...
                var G = "";
                if (v == 2052 || v == 1028) {
                    L = site_cityUtil.getInfo(M.streetCode).name;
                    J = site_cityUtil.getInfo(M.countyCode).name;
                    H = site_cityUtil.getInfo(M.cityCode).name;
                    G = site_cityUtil.getInfo(M.provinceCode).name
                } else {
                    L = site_cityUtil.getInfoEn(M.streetCode).name;
                    J = site_cityUtil.getInfoEn(M.countyCode).name;
                    H = site_cityUtil.getInfoEn(M.cityCode).name;
                    G = site_cityUtil.getInfoEn(M.provinceCode).name
                }
                if (M.provinceCode == 990000) {
                ...
                jm("#areaBoxInput").attr("area1", M.provinceCode);
                jm("#areaBoxInput").attr("area2", M.cityCode);
                jm("#areaBoxInput").attr("area3", M.countyCode);
                jm("#areaBoxInput").attr("area4", M.streetCode);
                jm("#areaBox1 .group_item[pid='" + M.provinceCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + M.cityCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + M.countyCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + M.streetCode + "']").click()
            } else {
                jm("#allArea").val(M.provinceCode);
                jm("#allArea").change();
                jm("#areaBox2 .group_item[cid='" + M.cityCode + "']").click();
                jm("#areaBox2 .group_item[cid='" + M.countyCode + "']").click()
            }
            jm("#addrInfo_street").val(M.streetAddr)
        }
        var K = F.isDefault
    });
    ...
    function() {
        ...
        l = jm(this).parents(".selectedArea").parent().attr("_item");
        var F = {};
        F.isDefault = 1;
        a.opera = y;
        a._item = l;
        a.addrInfo = F;
        c[l]["isDefault"] = F.isDefault;
        var G = this;
        jm.ajax({
            type: "post",
            ...
            success: function(I) {
                ...
                if (J.success) {
                    ...
                    jm(G).find(".text").text(LS.mallDefault);
                    jm(G).parents(".addrInfo").find(".cutOut").css("display", "none");
                    j[l].isDefault = 1
                } else {
                    Mobi.ing(J.msg)
                }
    ...
    function() {
        ...
        var I = "";
        var F = false;
        P.parent().find(".propItemValue").each(function() {
            U = jm(this).attr("_field");
            J = jm(this).val();
            I = jm(this).attr("_prop");
            F = jm(this).attr("_required") == "1" ? true: false;
            if (F && (J == null || J == "")) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, I));
                this.focus();
                Q = false
            }
            if (U == "email" && J.length > 0) {
                if (!jm.isEmail(J)) {
                    Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, I));
                    this.focus();
                    Q = false
            ...
            if (U == "mobile" && J.length > 0) {
                if (!Mobi.isNationMobile(J)) {
                    Mobi.ing(LS.mobileNumRegular);
                    this.focus();
                    J = "";
                    Q = false
                }
                G.mobileCt = jm(this).parent().find("#mobileCt").val()
            }
            if (U == "mobile" && J.length <= 0) {
                G.mobileCt = ""
            }
        ...
        var O = !(jm("#allArea").val() == "os" || jm("#allArea").val() == "cn");
        var L = jm("#areaBoxInput").attr("area4");
        var H = jm("#areaBoxInput").attr("area3");
        var N = jm("#areaBoxInput").attr("area2");
        var M = jm("#areaBoxInput").attr("area1");
        var T = jm("#addrInfo_street");
        F = P.parent().find("#addrInfo_street").attr("_required") == "1" ? true: false;
        if (F) {
        ...
        if (jm("#allArea").length == 1) {
            S = jm("#areaBoxInput").val().replace(/-/g, "") + jm("#addrInfo_street").val()
        }
        G.addr = S;
        G.isDefault = K;
        a.opera = y;
                        ...
                        if (y == "editAddr") {
                            if (K) {
                                jm("#addrInfoList").find(".addrInfo").each(function() {
                                    ...
                                    if (jm(this).attr("_item") == l) {
                                        jm(this).find(".name").text(G.name);
                                        jm(this).find(".phone").text(ab);
                                        jm(this).find("#addr").text(G.addr);
                                        addrInfo = jm(this)
                                    }
                                })
                            } else {
                            ...
                            if (y == "addAddr") {
                                ...
                                var aa = j.length;
                                var Y = [];
                                Y.push("<div class='addrInfo' _item=" + aa + ">");
                                Y.push("<div class='" + (K ? "": "middle") + " info_name' style='width:100%;'>");
                                Y.push("<div class='nameAndPhone'><span class='name'>" + G.name + "</span><span class='phone'>" + ab + "</span></div><div class='address'><span id='addr'>" + G.addr + "</span></div>");
                                Y.push("</div>");
                                Y.push("<div class='selectedArea' style='width: 100%;float:left;'>");
                                Y.push("<div class='left'>");
                                Y.push("<div class='selectedDiv'><label for='input" + aa + "'><input type='radio' class='checkbox-comp' id='input" + aa + "' name='defaultLogo'><span class='text'>设为默认</span></label></div>");
                                Y.push("</div>");
                                Y.push("<div class='right'>");
                                Y.push("<div class='edit' _index=" + aa + "><span>编辑</span></div><div class='cutOut'><span>删除</span></div>");
                                Y.push("</div>");
                                Y.push("</div>");
                                Y.push("</div>");
                                jm("#addrInfo").append(Y.join(""));
                                j.push(G);
                                jm("#editAddrInfo").hide();
                                jm("#addrInfoList").show()
                            }
    ...
    function() {
        var H = jm(this);
        l = H.parents(".selectedArea").parent().attr("_item");
        a.opera = "delAddr";
        a._item = l;
        var F = function(J, I) {
            jm.ajax({
                type: "post",
                url: "ajax/member_h.jsp?cmd=set&id=" + J,
                data: "info=" + jm.encodeUrl(jm.toJSON(a)),
                error: function() {
                    Mobi.ing(LS.systemError)
                },
    ...
    function(F, G) {
        o += "<div class='pv_group' style='" + (G[0] == "OS" ? "display:none;": "") + "'>";
        o += "<div class='group_head'>" + G[0] + "</div>";
        o += "<div class='group_content'>";
        jm.each(G[1],
        function(I, H) {
            if (v == 2052 || v == 1028) {
                o += "<div class='group_item' pid='" + H + "' pname='" + site_cityUtil.getInfo(H).name + "'>" + site_cityUtil.simpleProvinceNameStr(site_cityUtil.getInfo(H).name) + "</div>"
            } else {
                o += "<div class='group_item' pid='" + H + "' pname='" + site_cityUtil.getInfoEn(H).name + "'>" + site_cityUtil.simpleProvinceNameStrEn(site_cityUtil.getInfoEn(H).name) + "</div>"
            }
        });
        o += "</div>";
        o += "</div>"
    });
    jm("#areaBox1 .pv_content").html("").append(o);
    jm("#allArea").change(function() {
        ...
        if (jm("#allArea").val() == "cn" || jm("#allArea").val() == "os") {
            ...
            var F = d(jm("#allArea").val());
            jm("#sec_box .sec_content").append(F);
    ...
    function() {
        ...
        jm("#areaBoxInput").val("");
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + F);
        jm("#areaBoxInput").removeAttr("lastArea");
        jm("#areaBoxInput").removeAttr("lastAreaType");
        jm("#areaBoxInput").attr("area1", G);
        jm("#areaBoxInput").attr("area2", "");
        jm("#areaBoxInput").attr("area3", "");
        jm("#areaBoxInput").attr("area4", "");
        var I = "";
        if (v == 2052 || v == 1028) {
            I = t(site_cityUtil.getCities(G))
        } else {
            I = t(site_cityUtil.getCitiesEn(G))
        }
        var H = jm(I).html();
    ...
    function() {
        ...
        var G = jm("#areaBoxInput").attr("lastAreaType");
        if (G != null && G != "") {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().substring(0, jm("#areaBoxInput").val().indexOf("-")))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + F);
        jm("#areaBoxInput").attr("lastArea", "-" + F);
        jm("#areaBoxInput").attr("lastAreaType", "city");
        jm("#areaBoxInput").attr("area2", H);
        jm("#areaBoxInput").attr("area3", "");
        jm("#areaBoxInput").attr("area4", "");
        var J = "";
        if (v == 2052 || v == 1028) {
            J = k(site_cityUtil.getCounty(H))
        } else {
            J = k(site_cityUtil.getCountyEn(H))
        }
        var I = jm(J).html();
    ...
    function() {
        ...
        var K = jm("#areaBoxInput").attr("lastArea");
        var H = jm("#areaBoxInput").attr("lastAreaType");
        ...
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + G);
        jm("#areaBoxInput").attr("lastArea", "-" + G);
        jm("#areaBoxInput").attr("lastAreaType", "county");
        jm("#areaBoxInput").attr("area3", I);
        jm("#areaBoxInput").attr("area4", "");
        var F = "";
        if (v == 2052 || v == 1028) {
            F = w(site_cityUtil.getStreet(I))
        } else {
            F = w(site_cityUtil.getStreetEn(I))
        }
        var J = jm(F).html();
        ...
        jm("#street_box").append(F)
    });
    jm("#street_box").delegate(".group_item", "click",
    function() {
        var F = jm(this).attr("cname");
        var H = jm(this).attr("cid");
        var I = jm("#areaBoxInput").attr("lastArea");
        var G = jm("#areaBoxInput").attr("lastAreaType");
        if (G != null && G == "street") {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().replace(I, ""))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + F);
        jm("#areaBoxInput").attr("lastArea", "-" + F);
        jm("#areaBoxInput").attr("lastAreaType", "street");
        jm("#areaBoxInput").attr("area4", H);
        jm("#areaBox1").hide();
        jm("#areaBoxClose").click()
    });
    ...
    function() {
        ...
        var J = jm("#areaBoxInput").attr("lastArea");
        var G = jm("#areaBoxInput").attr("lastAreaType");
        if (G != null && G != "" && jm("#areaBoxInput").val().indexOf("-") != -1) {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().substring(0, jm("#areaBoxInput").val().indexOf("-")))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + F);
        jm("#areaBoxInput").attr("lastArea", "-" + F);
        ...
        jm("#thd_box .thd_content").append(I)
    });
...
Mobi.loadCouponList = (function(i) {
    function j(s, r) {
        this.mid = s;
        this.flag = r
    }
    ...
    function a() {
        var u = p;
        var s = i(".couponListPanel");
        var r = [];
        r.push('<div class="tabList">');
        r.push('<div class="coupon-tab"><span><span class="">' + LS.notUse + '(</span><span class="coupon-amount">' + o[0].length + "</span><span>)</span></span><em></em></div>");
        r.push('<div class="coupon-tab"><span><span>' + LS.used + '(</span><span class="coupon-amount">' + o[1].length + "</span><span>)</span></span><em></em></div>");
        r.push('<div class="coupon-tab"><span><span>' + LS.expired + '(</span><span class="coupon-amount">' + o[2].length + "</span><span>)</span></span><em></em></div>");
        r.push("</div>");
        r.push("<div id='showCouponList'>");
        r.push(l());
        r.push("</div>");
        s.append(r.join(""));
        if (u.flag) {
        ...
        var t = jm("body").height()
    }
    function h(s) {
        var v = "fk-coupon-tab-active",
        r = jm(".coupon-tab");
        r.attr("style", "");
        r.find("em").attr("style", "");
        r.removeClass(v);
        var t = jm(".coupon-tab").eq(s),
        u = jm(".g_button").css("background-color");
        t.css({
            background: u,
            color: "#fff",
            borderColor: u
        ...
        t.find("em").css({
            borderColor: u + "transparent transparent transparent"
        });
        t.addClass(v)
    }
    function f(r) {
        var s = jm(".coupon-tab").eq(r);
        s.addClass("coupon-tab-selected").siblings(".coupon-tab").removeClass("coupon-tab-selected")
    }
    function b() {
    ...
    function q() {
        ...
        function() {
            if (jm(this).index() != d) {
                ...
                i(".show-coupon-list").remove();
                i(".coupon-empty").remove();
                i("#showCouponList").append(l())
            }
        });
        ...
        function() {
            var u = i(this).parents(".coupon-warp");
            var v = u.attr("data_id");
            var t = LS.delCouponWillUnavail;
            if (d != 0) {
                t = LS.confirmDelCoupon
            }
            var s = {
                textClass: "confirm",
                content: t,
                callback: function() {
                    o[d].splice((n[d] - 1) * m, 1);
                    i.ajax({
                        url: "ajax/member_h.jsp?cmd=delCoupon",
                        data: "mid=" + r.mid + "&cdid=" + v,
                        dataType: "json",
                        success: function(w) {
                            if (w.success) {
                                u.remove();
                                i(".coupon-tab").eq(d).find(".coupon-amount").text(o[d].length)
                            }
                        },
                        error: function() {}
                    });
    ...
    function l() {
        ...
        var t = [];
        if (s.length == 0) {
            t.push("<div class='coupon-empty'>");
            t.push("<div class='icon-coupons1'></div>");
            var u = "";
            if (d == 0) {
                u = jm.format(LS.notHasCoupon, LS.notUse)
            } else {
                if (d == 1) {
                    u = jm.format(LS.notHasCoupon, LS.used)
                } else {
                    if (d == 2) {
                        u = jm.format(LS.notHasCoupon, LS.expired)
                    }
                }
            }
            t.push("<div class='showMsg'>" + u + "</div>");
            t.push("</div>")
        } else {
            t.push("<div class='show-coupon-list'>");
            i.each(s,
            function(x, w) {
                if (d != 0) {
                    w.bg = 7
                }
                t.push("<div class='coupon-warp' data_id='" + w.cdId + "'>");
                t.push("<div class='coupon-code'>" + LS.couponNumber + "：" + w.redeemCode + "</div>");
                t.push("<div class='coupon-data'>");
                t.push("<div>" + LS.Event + LS.name + "：" + jm.encodeHtml(w.couponName) + "</div>");
                t.push("<div>" + LS.useConditionOrderOver + Fai.top.choiceCurrencyVal + w.orderMinPrice + "</div>");
                t.push("<div style='overflow:visible;'>" + LS.vilidaty + "：" + w.validity + "</div>");
                t.push("</div>");
                t.push("<div class='coupon' data_id='" + w.cdId + "'>");
                t.push("<div class='coupon-left coupon-" + e[w.bg] + "-left'></div>");
                t.push("<div class='coupon-content coupon-color-" + e[w.bg] + "'>");
                t.push("<div class='couponSavePrice'><span class='priceSign'>" + Fai.top.choiceCurrencyVal + "</span><span class='couponPrice'>" + w.savePrice + "</span></div>");
                t.push("</div>");
                t.push("<div class='coupon-right coupon-" + e[w.bg] + "-right'></div>");
                t.push("<div class='coupon-watermark'>券</div>");
                if (d == 2) {
                    t.push('<div class="fk-coupon-expired"></div>')
                }
                t.push("</div>");
                t.push("</div>")
            });
...
Mobi.memberHeadPic = function(b, a) {
    ...
    i.initBind = function() {
        var D = this;
        s = n(".picArea .coverImg"),
        p = n(".picArea"),
        m = n("#headPic");
        m.on({
            load: function() {
                h = n(this)[0].offsetTop;
                b = n(this)[0].offsetLeft;
                o = Math.min(n(this)[0].height, n(this)[0].width);
                k = h + n(this)[0].height / 2 - o / 2;
                e = b + n(this)[0].width / 2 - o / 2;
                m.css({
                    top: h + "px",
                    left: b + "px"
                });
        ...
        n("#memberHeadPic").click(function() {
            var E = setInterval(function() {
                if (n("#headPic")[0].complete) {
                    n("#profile").hide();
                    n(".middleCenter").css("padding-bottom", "0");
                    var F = n("#editMemberHeadPic");
                    F.css("height", n(window).height() + "px");
                    n("#editMemberHeadPic").show();
                    if (Mobi.deviceTypeIsMobi()) {
                        n("#coverBox").remove()
                    }
                    p.css("height", n(window).height() - Math.floor(n(".loginHeader").height()) - Math.floor(n(".editHeadPicFooter").height()) + "px");
                    c = Number(p.height());
                    r = Number(p.width());
                    h = (c - m.height()) / 2;
                    b = (r - m.width()) / 2;
                    if (n.toJSON(D.headPicJson) == "{}" || D.headPicJson.thumbId == "") {
                        k = h;
                        e = b;
                        o = Number(m.width())
                    } else {
                        var G = D.headPicJson.imgW / m.width();
                        k = h + D.headPicJson.top / G;
                        e = b + D.headPicJson.left / G;
                        o = D.headPicJson.width / G
                    }
                    m.css({
                        top: h + "px",
                        left: b + "px"
                    });
                    d = Math.min(m.width(), m.height());
                    l();
                    q();
                    clearInterval(E)
                }
        ...
        n(".editHeadPicFooter .saveBtn").click(function() {
            var E = n(this).attr("mid");
            var F = n(this).attr("newimg");
            var H = n(this).attr("oldimgid");
            var G = {};
            if (!F && !H) {
                n("#editMemberHeadPic").hide();
                n("#profile").show();
                return
            }
            D.headPicJson.width = Math.round(o);
            D.headPicJson.top = Math.round(k - h);
            D.headPicJson.left = Math.round(e - b);
            D.headPicJson.imgH = Math.round(m[0].height);
            D.headPicJson.imgW = Math.round(m[0].width);
            if (F != null) {
                $.ajax({
                    type: "post",
                    url: "ajax/member_h.jsp?cmd=cimg",
                    data: "oldImgId=" + H + "&mid=" + E + "&newImg=" + n.encodeUrl(F),
                    async: false,
                    error: function() {
                        Mobi.ing(LS.memberProfileError)
                    },
                    success: function(I) {
                        I = JSON.parse(I);
                        if (I.success) {
                            D.headPicJson.thumbId = I.fileId
                        }
                    }
                })
            } else {
                D.headPicJson.thumbId = H
            }
            G.headPic = D.headPicJson;
            $.ajax({
                type: "post",
                async: false,
                url: "ajax/member_h.jsp?cmd=set",
                data: "id=" + E + "&info=" + n.encodeUrl(n.toJSON(G)),
                error: function() {
                    Mobi.ing(LS.memberProfileError)
                },
                success: function(I) {
                    var J = jQuery.parseJSON(I);
                    if (J.success) {
                        D.headPicJson.path = m.attr("src");
                        Mobi.initMemberHeadPic(D.headPicJson);
                        n("#editMemberHeadPic").hide();
                        n("#profile").show();
        ...
        var t, z, x, A, x, y, u, w, v;
        n(".picArea").on({
            touchstart: function(E) {
                var G = E.touches.length;
                t = s[0].offsetTop;
                z = s[0].offsetLeft;
                o = s[0].width;
                if (G == 1) {
        ...
        n(".picArea").on({
            mousedown: function(F) {
                ...
                B = true;
                var E = F.target.id;
                if (E == "coverBox" || E == "coverImg") {
                    C(0)
                } else {
                    if (E == "dragBotCenter" || E == "dragRightCenter" || E == "dragRightBot") {
                        C(1)
                    } else {
                        if (E == "dragLeftCenter" || E == "dragLeftBot") {
                            C(2)
                        } else {
                            if (E == "dragTopCenter" || E == "dragRightTop") {
                                C(3)
                            } else {
                                if (E == "dragLeftTop") {
                                    C(4)
    ...
    function l() {
        ...
        n(".picArea .coverRing").css({
            width: o - 2 + "px",
            height: o - 2 + "px",
            top: h + "px",
            left: b + "px"
        });
        n(".picArea .coverBox").css({
            width: o + "px",
            height: o + "px",
            top: h - 1 + "px",
            left: b - 1 + "px"
        });
        n(".picArea .cover1").css({
            width: "100%",
            height: k + "px",
            top: 0,
            left: 0
        });
        n(".picArea .cover2").css({
            width: b + "px",
            height: o + "px",
            top: h + "px",
            left: 0
        });
        n(".picArea .cover4").css({
            width: r - o - b + "px",
            height: o + "px",
            top: h + "px",
            left: o + b + "px"
        });
        n(".picArea .cover5").css({
            width: "100%",
            height: c - o - h + "px",
            top: o + h + "px",
            left: 0
    ...
    function q() {
        if (o < 100) {
            ...
            if (o > Math.min(m[0].height, m[0].width)) {
                o = Math.min(m[0].height, m[0].width)
            }
        }
        if (k < h) {
            k = h
        ...
        if (k >= h && k <= h + m[0].height - o && e >= b && e <= b + m[0].width - o) {
            s.css({
                width: o + "px",
                height: o + "px",
                top: k + "px",
    ...
    function a(A) {
        ...
        x = A.touches[0].pageX;
        v = A.touches[1].pageX;
        z = A.touches[0].pageY - document.body.scrollTop;
        y = A.touches[1].pageY - document.body.scrollTop;
        if (!x || !v) {
            return
        }
        if (x <= v) {
        ...
        t = {
            dist: Math.round(Math.sqrt(Math.pow(x - v, 2) + Math.pow(z - y, 2))),
            x: Math.round(u),
            y: Math.round(w)
        };
        return t
...
Mobi.memberProfileSubmit = function(j, a, h) {
    var c = {};
    if (a) {
        if (h) {
            var d = jm("#oldPsw").val();
        ...
        c[f] = b;
        if (b.length > k) {
            Mobi.ing(jm.format(LS.memberProfileUserEditItemMaxLength, f, k));
    ...
    jm.ajax({
        type: "post",
        url: "ajax/member_h.jsp?cmd=set",
        data: "id=" + j + "&info=" + jm.encodeUrl(jm.toJSON(c)),
        error: function() {
            Mobi.ing(LS.memberProfileError)
        },
        success: function(l) {
...
Mobi.manageLogin = function() {
    ...
    if (window.parent == window) {
        if (Fai.top._templateFrameId == 2001 || Fai.top._templateFrameId == 2003) {
...
Mobi.memberFdPwd = function(a, d) {
    ...
    function b(j, i, f) {
        var h = Fai.top.jm,
        e;
        if (h.type(i) !== "array" || h.type(j) !== "string") {
            return ""
        }
        e = i.length;
        while (e) {
            e--;
            if (h.type(i[e]) === "string") {
                i[e] = [f, i[e], f].join("")
            }
        }
        return j + "(" + i.join(",") + ")"
...
Mobi.initPhotoSwipe = function(a, d, h, e, c) {
    var j = Mobi.getPreviewObject("imgName" + a);
    jm(j).html(d[0]);
    var i = Mobi.getJQMobi();
    ...
    i("#photoSwipe" + a).swipehandle(f, {
        ...
        callback: function(l) {
            ...
            if (!b[l]) {
                b[l - b.length].className = "on";
                jm(j).html(d[l - b.length])
            } else {
                b[l].className = "on";
                jm(j).html(d[l])
            }
    ...
    i("#photoSwipe" + a).find(".imageDiv").show();
...
Mobi.initDefScaleImage = function(c) {
    if (c) {
        var j = c.querySelectorAll("img"),
        h = c.clientWidth,
        i = 0;
        var a = c.querySelectorAll(".photoImageItem");
        var k = c.querySelectorAll(".imageMiddleSpan");
        if (j) {
            for (var l = 0; l < j.length; l++) {
                var b = parseInt(j[l].getAttribute("vwidth") ? j[l].getAttribute("vwidth") : 1),
                m = parseInt(j[l].getAttribute("vheight") ? j[l].getAttribute("vheight") : 1),
                e = m / b;
                if (e === NaN) {
                    continue
                }
                ...
                d = h / 417;
                if (d <= f) {
                    jm(j[l]).css("width", f * 417 + "px");
                    jm(j[l]).css("height", "417px");
                    jm(j[l]).css("maxWidth", "initial");
                    jm(j[l]).css("marginLeft", ((h - f * 417) / 2) + "px");
                    jm(k[l]).css("display", "none")
                } else {
                    jm(j[l]).css("height", h / f + "px");
                    jm(j[l]).css("width", h + "px");
                    jm(j[l]).css("marginTop", ((417 - h / f) / 2) + "px");
                    jm(k[l]).css("display", "none")
                }
            }
            if (h * i != 0) {
                c.style.height = Math.floor(h * i) + "px"
            }
        }
    }
};
Mobi.initPhotoImageSwipe = function(a, e) {
    ...
    b("#" + a).swipehandle(d, {
        ...
        callback: function(j, f) {
            var i = f.querySelector("img"),
            h = i.getAttribute("lazysrc");
            if ( !! h && !i.src) {
                i.src = h;
                i.onload = function() {}
            }
    ...
    jm("#" + a.photoParent).find(">." + a.photo).each(function() {
        ...
        c.mouseover(function() {
            ...
            var d = [{
                operationText: "编辑图册",
                className: "edit",
                evalScript: "Mobi.logDog(100048, 0);top.Mobi.popupWindow({title:'编辑图册', frameSrcUrl:'" + a.frameSrcUrl + "&id=" + h + "&_mobi=1', width:750, height:560 })"
            },
            {
                operationText: "删除图册",
                className: "close",
    ...
    top.Fai.addPopupBodyWindowBtn(d, {
        ...
        click: function() {
            ...
            $.ajax({
                ...
                success: function(i) {
                    top.Fai.successHandle(i, "删除成功", "", a, b, 1);
...
Mobi.initModulePhotoDetailSwipe = function(w, u, l) {
    if (u.length < 1) {
        return
    }
    var k = [];
    if (l) {
        k = document.querySelectorAll("#" + w + " .photoGroup-img")
    } else {
        k = document.querySelectorAll("#" + w + " img")
    }
    var c = [],
    r = 0;
    ...
    if (l) {
        var m = [];
        var h = Math.min(u.length, k.length);
        for (var s = 0; s < h; s++) {
            if (k[s].nodeName === "DIV") {
    ...
    var e = {
        ...
        uiDetailCallBack: function(j, A, i) {
            var x = this;
            jm(j).html("");
            var C = u[v.currentIndex],
            z = C.groupId,
            B = C.id,
            y = C.name;
            jm(i).html(y);
            jm(A).addClass(f.Carousel.CssClasses.itemLoading);
            jm.ajax({
                type: "post",
                url: "ajax/photo_h.jsp",
                data: "cmd=getInfo&id=" + jm.encodeUrl(B) + "&groupId=" + jm.encodeUrl(z),
                error: function() {
                    Mobi.ing(LS.systemError)
                },
                success: function(D) {
                    jm(j).html(D);
                    var G = j.querySelectorAll("img");
                    if (G.length === 0) {
                        x.detailScroll && x.detailScroll.destroy();
                        x.detailScroll = null;
                        x.destroyScroll = new iScroll(A);
                        jm(A).removeClass(f.Carousel.CssClasses.itemLoading)
                    } else {
    ...
    v = f.attach(k, e);
    v && v.addEventHandler(f.EventTypes.onCaptionAndToolbarShow,
    function(i) {
        if (this.scroll) {
            this.scroll.destroy()
        }
    ...
    if (l) {
        v.addEventHandler(f.EventTypes.onDisplayImage,
        function(y) {
            var i = y.target.currentIndex;
            if (i > 1) {
                var j = u[i + 1],
                x = y.target.cache.images[y.target.currentIndex + 1],
                z;
                if (x) {
                    z = x.imageEl;
                    z.src = j.picPath;
    ...
    function p(j, i) {
        ...
        Mobi.recoverPhotoSwipeImgSize(i)
    }
};
...
Mobi.PhotoDetailSwipeForJumpCtrl = function(a) {
    ...
    jm.ajax({
        ...
        success: function(p) {
            ...
            function(t) {
                var i = t.target.currentIndex,
                s, r, q;
                if (i > 1) {
                    r = b[i + 1];
                    s = t.target.cache.images[t.target.currentIndex + 1];
                    if (s) {
                        q = s.imageEl;
                        q.src = r.picPath;
                        Mobi.recoverPhotoSwipeImgSize(q)
                    }
                }
            })
        }
...
Mobi.photoCrossedSlideSecSwipe = function(a, e, b) {
    ...
    f = c,
    j = parseInt(jm(h).width()),
    l = 0,
    i = jm(".photoCrossedSlideSec", h);
    function d(n) {
        var m = 0;
        m += parseFloat(n.width());
        m += (parseFloat(n.css("padding-left")) + parseFloat(n.css("padding-right")));
        m += (parseFloat(n.css("border-left-width")) + parseFloat(n.css("border-right-width")));
        m += (parseFloat(n.css("margin-left")) + parseFloat(n.css("margin-right")));
        return m
    }
    if (i.length > 0) {
        l = d(jm(i[0])) * i.length
...
Mobi.initPhotoGroupSwipe = function(b) {
    ...
    i = f("#" + b).swipehandle(c, {
        ...
        callback: function(l) {
            ...
            e.find(".J_curPhotoNumber").text(j)
        }
    });
...
Mobi.photoCardInit = function(t) {
    ...
    j.each(function(i, x) {
        ...
        switch (i) {
        case 0:
            jm(x).addClass("f-showPic_1");
            break;
        case 1:
            jm(x).removeClass("f-showPic_1 f-showPic_2 f-showPic_3").addClass("f-showPic_2");
            break;
        case 2:
            jm(x).removeClass("f-showPic_1 f-showPic_2 f-showPic_3").addClass("f-showPic_3");
            break;
        default:
            jm(x).removeClass("f-showPic_1 f-showPic_2 f-showPic_3").addClass("f-showPic_0")
        }
    });
    ...
    function o(B, A, G) {
        ...
        z.addClass(C);
        B.each(function(i, H) {
            jm(H).removeClass("f-showPic_0 f-showPic_1 f-showPic_2 f-showPic_3")
        });
        F[0] = z.index();
        for (D = 1; D <= x; D++) {
            F[D] = D <= E ? ((F[0] + D) % E) : -1
        ...
        B.each(function(i, H) {
            switch (i) {
            case F[1]:
                jm(H).addClass("f-showPic_1");
                break;
            case F[2]:
                jm(H).addClass("f-showPic_2");
                break;
            case F[3]:
                jm(H).addClass("f-showPic_3");
                break;
            case F[0]:
                break;
            default:
                jm(H).addClass("f-showPic_0")
            }
        })
    }
    function f(i, D, B, C) {
    ...
    i(p);
    function p() {
        i(".formStyle34").each(function(q, r) {
            var s = i(r);
            c(s)
        })
    }
    function h(r) {
        ...
        s = r.find(".J_photoGroupAll");
        if (s.hasClass("J_photoGroupAll4")) {
            q = 4
        }
        if (s.hasClass("J_photoGroupAll5")) {
            q = 5
        }
        d(q).destory(r);
        k(r)
    ...
    function m(s, r) {
        ...
        var q = s.find(".J_photoGroupAll");
        q.off("mousedown.photoGroup").off("mouseup.photoGroup");
        if (r === false) {
            return
        }
        q.on("mousedown.photoGroup",
        function() {
    ...
    function j(v, s) {
        var r = v.find(".J_photoGroupAll"),
        q,
        w;
        if (!r.hasClass("J_photoGroupAll4") && !r.hasClass("J_photoGroupAll5")) {
            return
        }
        q = r.find(".J_photoGroup-img-mask");
        q.off("mousedown.photoGroupScan mouseup.photoGroupScan");
        q.remove();
        if (s === false) {
            return
        }
        ...
        r.find(".f-photoGroup-a").each(function(z, y) {
            var B = i(y),
            A = B.find(".f-photoGroup-img"),
            x = (A.height() / window._htmlFontSize + "rem"),
            C;
            if (B.find(".J_photoGroup-img-mask").length === 0) {
                C = i("<div class='f-photoGroup-img-mask J_photoGroup-img-mask'></div>");
                C.height(x);
                B.append(C)
            }
        });
        r.find(".J_photoGroup-img-mask").off("mousedown.photoGroupScan mouseup.photoGroupScan").on("mousedown.photoGroupScan", t).on("mouseup.photoGroupScan", u);
        function t(x) {
            w.time = new Date();
            w.startX = x.pageX;
            w.startY = x.pageY
        ...
        function u(x) {
            ...
            z.parent().find(".f-photoGroup-img").click()
        }
    }
    function b(s, r) {
        var v = a(),
        u;
        s.off(v.downLink).off(v.clickLink);
        if (r === false) {
            return
        }
        u = {
        ...
        s.on(v.downLink, ".J_photoGroup-a", t).on(v.clickLink, ".J_photoGroup-a", q);
        function t(w) {
            var x = e.photoGroup.utils.getPosByEvent(w);
            u.startX = x.pageX;
            u.startY = x.pageY;
            u.time = new Date()
        }
        function q(w) {
            var z = e.photoGroup.utils.getPosByEvent(w),
            x = new Date(),
            y = false;
            u.endX = z.pageX;
            u.endY = z.pageY;
    ...
    function o(s, q) {
        ...
        if (i.isFunction(r.bindWithEditLayer)) {
            r.bindWithEditLayer(s, q)
        }
    }
    function d(q) {
        var s = {
    ...
    function e(l) {
        if (!l.touches && !l.changedTouches) {
            return {}
        }
        return (l.touches[0] || l.changedTouches[0])
    }
    function j(n) {
        var m = n.pageX || e(n).pageX,
        l = n.pageY || e(n).pageY;
        return {
            pageX: m,
            pageY: l
    ...
    function i(l) {
        var n = d(l),
        m = d(l).find(".J_photoGroup-img-mask");
        if (m.length > 0) {
            return m
        }
        return n.find(".J_photoGroup-img")
    }
    function f(n) {
        var m = n.find(".J_photoGroupAll"),
        l;
        if (m.hasClass("J_photoGroupAll1")) {
            l = 1
        } else {
            if (m.hasClass("J_photoGroupAll2")) {
                l = 2
            } else {
                if (m.hasClass("J_photoGroupAll3")) {
                    l = 3
                } else {
                    if (m.hasClass("J_photoGroupAll4")) {
                        l = 4
                    } else {
                        if (m.hasClass("J_photoGroupAll5")) {
                            l = 5
                        }
                    }
                }
    ...
    function h(p, l, q) {
        var o = d(p)[0].getBoundingClientRect(),
        n = false,
        m = false;
        if (l >= o.left && l <= o.right) {
            n = true
        }
        if (q >= o.top && q <= o.bottom) {
            m = true
        }
        return n && m
    }
} (Mobi, jm)); (function(d, i, l, h) {
    var o = l(i),
    e = {
        moveX: 0,
        moveY: 0,
    ...
    function p(r) {
        ...
        i(".formStyle34").forEach(function(t, s) {
            b(i(t))
        })
    }
    function b(v, s) {
        var w = m(),
        u = v.find(".J_photoGroupAll5"),
        r = d.photoGroup.utils,
        t = r.getStyleType(v);
        v.off(w.moduleMouseLeave).off(w.moduleMouseEnter);
        if (s === false) {
            return
        }
        v.on(w.moduleMouseEnter,
        function(x) {
            c(v)
        }).on(w.moduleMouseLeave,
        function(x) {
            c(v, false)
        });
        if ([4, 5].indexOf(t) > -1) {
    ...
    function c(v, r) {
        var u = v.find(".J_photoGroupAll-wrap"),
        t = v.find(".J_photoGroupStyle"),
        w = m(),
        s = d.photoGroup.utils;
        t.off(w.imgMouseLeave).off(w.imgMouseEnter);
        if (r === false) {
            return
        }
        t.on(w.imgMouseEnter,
        function(C) {
            var z = i(this),
            y = d.photoGroup.utils,
            A = y.getImgByCard(z),
            B = y.getStyleType(v),
            x = z.data("fk-is-enter");
            if (B === 4 && !z.hasClass("f-active")) {
                return
            }
            if (B === 5 && z.index() !== 0) {
                return
            ...
            o.add(A, v);
            z.data("fk-is-enter", "true")
        }).on(w.imgMouseLeave,
        function(y) {
            var x = i(this);
            $img = d.photoGroup.utils.getImgByCard(x),
            flag = x.data("fk-is-enter");
            if (flag !== "true") {
                return
            }
            o.remove($img, v);
            x.data("fk-is-enter", "false")
        })
    }
    function q(t, r) {
        var s = t.find(".J_photoGroupAll-wrap"),
        u = m();
        t.off(u.transBefore).off(u.transAfter);
        if (r === false) {
            return
        }
        t.on(u.transBefore,
    ...
    function j(u) {
        ...
        n(u, e);
        s.each(function(w, v) {
            var x = d.photoGroup.utils.getImgByCard(v);
            o.remove(x, u)
        });
        o.ctrl(u, false)
    }
    function f(u) {
        var r = d.photoGroup.utils,
        t = a(u).active,
        s = r.getImgByCard(t);
        n(u, e, false);
        if (!r.isInDom(t, e.moveX, e.moveY)) {
            return
        }
        o.ctrl(u);
        o.add(s, u)
    ...
    function n(t, u, r) {
        var s = t.find(".J_photoGroupAll-wrap"),
        v = m();
        s.off(v.wrapMousemove);
        if (r === false) {
            return
        }
        s.on(v.wrapMousemove,
        function(w) {
            u.moveX = w.clientX;
            u.moveY = w.clientY
        })
    ...
    function k(s) {
        var r = s.find(".J_photoGroup-img-mask");
        if (r.length > 0) {
            return r
        }
        return s.find(".J_photoGroup-img")
    }
    function m() {
        return {
...
function(c) {
    ...
    function f(n, m) {
        var o = m.offset(),
        p = n[0].getBoundingClientRect();
        n.css({
            left: o.right - p.width,
            top: o.bottom - p.height
        })
    }
    function e(m) {
        var n = m.attr("id");
    ...
    function j(q) {
        var m = c(q).parent().find(".J_photoGroup-img"),
        p = m.attr("_groupid"),
        v = $("#photoGroup" + p),
        u = v.find(".J_photoGroup-title"),
        w = u.text(),
        o = "",
        t,
        r,
        s,
        n;
        t = "Fai.top.Mobi.popupWindow({title:'编辑图册', frameSrcUrl:'" + l(p) + "', width:770, height:560});";
        r = {
            operationText: "编辑图册",
            className: "edit_2",
            evalScript: t
        };
        s = "Mobi.deletePhotoGroupManage('" + p + "', '" + Fai.top.Fai.encodeHtmlJs(w) + "', '', 0)";
        n = {
            operationText: "删除图册",
            className: "close_2",
            evalScript: s
    ...
    function l(o) {
        var m = Fai.top.location,
        n = m.origin,
        r = m.pathname,
        q = r.split("/"),
        p;
        q.pop();
        q.push("photoGroupEdit.jsp");
        p = Fai.top._siteDomain + q.join("/") + "?fromManage=true&mobiSettingState=3&id=" + o;
        return p
    }
    function b(m) {
        var n = c(m);
        if (!n.hasClass("J_photoGroup-img")) {
            n = n.parent().find(".J_photoGroup-img")
        }
        return n
    }
}); (function(b, e, c) {
    ...
    function a(q) {
        var p = q.find(".J_photoGroupAll-wrap"),
        r = i();
        p.off(r.dragStart).off(r.selectStart).off(r.dragOriginStart)
    }
    function o(t) {
        var s = t.find(".J_photoGroupAll-wrap"),
        p = t.find(".J_photoGroupStyle"),
        q = 0,
        r = p.eq(0);
        p.addClass(k.small);
        if (r.length > 0) {
        ...
        p.each(function(w, v) {
            var u = e(v);
            q += parseFloat(u.width());
            q += parseFloat(u.css("margin-left"));
            q += parseFloat(u.css("margin-right"))
        });
        s.width(q + "px")
    }
    function m(r) {
    ...
    function l(u) {
        var s = u.find(".J_photoGroupAll-wrap"),
        w = i(),
        v = j();
        s.off(w.dragStart).off(w.selectStart).off(w.dragOriginStart).on(w.dragStart, q).on(w.selectStart, t).on(w.dragOriginStart, t);
        function t(x) {
            x.preventDefault()
        }
        function q(x) {
            var z = n.getPosByEvent(x),
            y = i();
            v.isStart = true;
            v.startX = z.pageX;
            v.startY = z.pageY;
            s.off(y.dragMove).on(y.dragMove, r).off(y.dragEnd).on(y.dragEnd, p)
        }
        function r(y) {
            var x = n.getSliderDir(v.startX, v.startY, v.moveX, v.moveY),
            z;
            if (!v.isStart) {
                return
            }
        ...
        function p(z) {
            var B = n.getPosByEvent(z),
            y = B.pageX - v.startX,
            A = i(),
            x = (v.isStart && v.isMove && !v.isTrans);
            Mobi.openDocScroll();
            s.off(A.dragMove).off(A.dragEnd);
            if (x && v.isXMove) {
                if (y < 0) {
                    v.currIndex++
                } else {
            ...
            v.isXMove = v.isStart = v.isMove = void 0
        }
    }
    function d(p, t, z, q) {
        var w = p.find(".J_photoGroupStyle"),
        y,
        s = i(),
        v = true,
        r = ["-ms-", "", "moz", "-webkit-"],
        ...
        if (t.currIndex < 0) {
            ...
            if (t.currIndex >= w.length) {
                t.currIndex = w.length - 1;
                v = false
            }
        }
        x = w.eq(t.oldIndex).find(".J_photoGroup-img");
        if (t.oldIndex === t.currIndex) {
            return
        }
        u = w.eq(t.currIndex);
        y = w.eq(t.oldIndex);
        ...
        u.addClass(k.active);
        t.isTrans = true;
        u.off(s.transEnd).on(s.transEnd,
        function(B) {
            var A = e(B.target).find(".J_photoGroup-img-mask");
            t.isTrans = false;
            u.off(s.transEnd);
            t.oldIndex = t.currIndex;
            z.trigger("transitionAfter", [B])
        });
        t.disLeft -= m(u);
        z.trigger("transitionBefore", [q]);
        e(r).each(function(B, D) {
            var A = D + "transform",
            C = "translate(" + (t.disLeft) + "px,0)";
            p.css(A, C)
        })
    }
    function i() {
    ...
    function a(o) {
        ...
        p = i();
        n.off(p.dragStart).off(p.selectStart).off(p.dragOrginStart)
    }
    function m(q) {
        var p = q.find(".J_photoGroupAll-wrap"),
        o = p.find(".J_photoGroupStyle").find(".J_photoGroup-a"),
        n = o.height() + "px";
        if (o.find(".J_photoGroup-detail").length === 0) {
            p.css({
                height: n,
    ...
    function k(s) {
        var p = s.find(".J_photoGroupAll"),
        u = i(),
        t = c();
        if (p.find(".J_photoGroupStyle").length <= 1) {
            return
        }
        p.off(u.dragStart).off(u.selectStart).off(u.dragOrginStart).on(u.dragStart, o).on(u.dragOrginStart, ".J_photoGroup-a", r).on(u.selectStart, r);
        function r(v) {
            v.preventDefault()
        }
        function o(v) {
            var w = l.getPosByEvent(v);
            t.startX = w.pageX;
            t.startY = w.pageY;
            t.isStart = true;
            p.off(u.dragMove).off(u.dragEnd).on(u.dragMove, ".J_photoGroupStyle", q).on(u.dragEnd, ".J_photoGroupStyle", n)
        }
        function q(w) {
            var x = l.getPosByEvent(w),
            v;
            if (!t.isStart) {
                return
            }
            if (!t.isMove) {
                t.isMove = true;
                v = l.getSliderDir(t.startX, t.startY, t.endX, t.endY);
                if (v === void 0) {
                    return
                }
                if (v === true) {
        ...
        function n(y) {
            ...
            t.endX = z.pageX;
            t.endY = z.pageY;
            p.off(u.dragMove).off(u.dragEnd);
            if (v && w && t.isXMove) {
                j(p, s, t)
            }
            t.isStart = t.isMove = t.isXMove = void 0
        }
    }
    function j(s, w, p) {
        var y = s.find(".J_photoGroupStyle"),
        t = y.eq(0),
        x = y.eq(1),
        u = y.eq(2),
        v = y.eq(3),
        ...
        function q(B) {
            ...
            A.removeClass(o.toOne).removeClass(o.toTwo).removeClass(o.toThree);
            t.removeClass(o.dir);
            D.append(t);
            p.isAnimate = false;
            w.trigger("transitionAfter")
        }
    }
    function i() {
        var o, n;
    ...
    function e() {
        ...
        b(".formStyle48").each(function(h, i) {
            b(i).on("mouseenter.bindEditLayer",
            function() {
                d(b(this))
    ...
    function d(i, h) {
        var j = i.find(".f-photoGroupItem");
        j.off("mouseenter.editLayer mouseleave.editLayer");
        if (h === false) {
            return
        }
        j.on("mouseenter.editLayer",
        function() {
            var r = b(this),
            t = r.find(".f-photoGroupR-title").text().trim(),
            l = r.attr("id"),
            n = l.replace("photoGroupR", ""),
            q = "Fai.top.Mobi.popupWindow({title:'编辑图册', frameSrcUrl:'" + c(n) + "', width:770, height:560});",
            o = {
                operationText: "编辑图册",
                className: "edit_2",
                evalScript: q
            },
            p = "Mobi.deletePhotoGroupManage('" + n + "', '" + Fai.top.Fai.encodeHtmlJs(t) + "', '', 0)",
            k = {
                operationText: "删除图册",
                className: "close_2",
                evalScript: p
            ...
            s = [o, k],
            m;
            m = a.addEditLayer(r, s, 6);
            m.css({
                left: r.offset().right - m.width() - 2,
                top: r.offset().bottom - m.height() - 2
            })
    ...
    function c(j) {
        ...
        k;
        l.pop();
        l.push("photoGroupEdit.jsp");
        k = Fai.top._siteDomain + l.join("/") + "?fromManage=true&mobiSettingState=3&id=" + j;
        return k
    }
} (Mobi, jm));
...
Mobi.initProductRestrict = function(k, h, f, d, i, b) {
    if (k) {
        var a = "";
        if (i) {
            a = "#productMallOptionPanel" + b
        }
        var j = 0;
        if (d.count != null) {
            j = d.count
        ...
        e = -1;
        if (h > 1 && f != 0) {
            jm(a + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
            jm(a + " #limitAmountDiv").text("( " + LS.minAmount + " : " + h + " ; " + LS.maxAmount + " : " + l + " )");
            c = h;
            e = l
        } else {
            if (h == 1 && f != 0) {
                jm(a + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                jm(a + " #limitAmountDiv").text("( " + LS.maxAmount + " : " + l + " )");
                e = l
            } else {
                if (h > 1 && f == 0) {
                    jm(a + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                    jm(a + " #limitAmountDiv").text("( " + LS.minAmount + " : " + h + " )");
                    c = h
                }
            }
        }
        jm(a + " #productNum").val(c);
        jm(a + " #productNum").unbind("change");
        jm(a + " #productNum").change(function() {
            var m = jm(a + " #productNum").val();
            var n = 1;
            if (jm.isInteger(m)) {
                n = parseInt(m)
            }
            if (n < c || n == c) {
                n = c;
                jm(a + " #g_decrease , .g_decrease").addClass("g_opacity50");
                jm(a + " #g_increase , .g_increase").removeClass("g_opacity50");
                if (e < c || e == c) {
                    jm(a + " #g_increase , .g_increase").addClass("g_opacity50")
                }
            } else {
                if (e != -1 && (n > e || n == e)) {
                    n = e;
                    jm(a + " #g_decrease , .g_decrease").removeClass("g_opacity50");
                    jm(a + " #g_increase , .g_increase").addClass("g_opacity50")
                } else {
                    if (n > 9999998) {
                        n = 9999999;
            ...
            jm(a + " #productNum").val(n)
        });
        jm(a + " #productNum").change();
        jm(a + " #g_decrease , .g_decrease").click(function() {
            var m = jm(a + " #productNum").val();
            var n = 1;
            if (jm.isInteger(m)) {
                n = parseInt(m)
        ...
        jm(a + " #g_increase , .g_increase").click(function() {
            var m = jm("#productNum").val();
            var n = 1;
            if (jm.isInteger(m)) {
                n = parseInt(m)
            }
...
Mobi.initProductOptions = function(h, s, c, p, k, n, a, q, t, f) {
    var u = false;
    jm.each(h,
    function(y, z) {
        if (z.t == null) {
    ...
    j = "";
    if (a == 1) {
        d = jm("#productMallOptionPanel" + q + " .J-op-box");
        v = jm("#productMallOptionPanel" + q + " .mallOptionImg"),
        r = d.find(".J-op");
        j = "#productMallOptionPanel" + q
    }
    var o = [];
    var i = jm("#mallPrice").html();
    var l = jm("#mallAmount").html();
    var b = jm("#mallWeight").html();
    if (l <= 0) {
        w(r.find("label"));
        r.find("label").attr("isEmptyAmount", "1")
    } else {
        jm.each(h,
        function(y, A) {
            if (A.oAmount <= 0 && r.length <= 1) {
                var z = r.find("label[data='" + A.t2 + "']");
                w(z);
                jm(z).attr("isEmptyAmount", "1")
            } else {
                if (A.oAmount <= 0) {
                    o.push(A.t2)
                }
    ...
    jm(r).each(function(y) {
        var z = jm(this);
        z.find("label").click(function() {
            if (jm(this).attr("isEmptyAmount") == "1") {
                return
            }
            var I = jm(this);
            if (!I.hasClass("isSelected")) {
                if (I.parent().find(".optionSelected").length > 0) {
                    I.parent().find(".optionSelected").removeClass("optionSelected isSelected")
                }
                I.addClass("optionSelected isSelected");
                var G = I.attr("data");
                z.attr("option_data", G)
            } else {
                I.parent().find(".optionSelected").removeClass("optionSelected isSelected");
                jm("#" + I.attr("for")).prop("checked", false);
                I.parents(".J-op").removeAttr("option_data");
                jm("#mallPrice").html(i);
                jm("#mallAmount").html(l);
                jm("#mallWeight").html(b);
                if (p) {
            ...
            if (r.length > 1 && s) {
                var aa = "";
                var ad = 0;
                r.each(function(af, ag) {
                    if (jm(r[af]).find(".optionSelected").length <= 0) {
                        aa += "x_"
                    } else {
                        aa += jm(r[af]).find(".optionSelected").attr("data") + "_"
                    }
                });
                ...
                function(af, ag) {
                    if (x(aa, ag.t2)) {
                        if (ag.flag != 0 && !isNaN(ag.oAmount)) {
                            ad += ag.oAmount
                        }
                    }
                });
                jm(j + " #mallAmount").text(ad)
            }
            var N = d.find(".optionSelected");
            if (v.length > 0) {
                var Z = I.attr("_indeptPic");
                if (Z != null) {
                    v.attr("src", Z)
                }
            }
            if (r.length == N.length) {
                var E = "",
                T, F, A, J, L;
                jm(N).each(function(af) {
                    if (u) {
                        E += jm(this).attr("data") + "_"
                    } else {
                        E += jm(this).attr("data")
                    }
                });
                ...
                if (p) {
                    jm(j + " #limitAmountDiv").text("");
                    var B = 0;
                    var ae = k.optionsCount;
                    if (ae != null && ae.d != null) {
                        for (var X = 0; X < ae.d.length; X++) {
                            if ((ae.d[X].t + "_") == E) {
                                B = ae.d[X].c
                            }
                        }
                    ...
                    var W = -1;
                    if (A > 1 && J != 0) {
                        jm(j + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                        jm(j + " #limitAmountDiv").text("( " + LS.minAmount + " : " + A + " ; " + LS.maxAmount + " : " + H + " )");
                        S = A;
                        W = H
                    } else {
                        if (A == 1 && J != 0) {
                            jm(j + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                            jm(j + " #limitAmountDiv").text("( " + LS.maxAmount + " : " + H + " )");
                            W = H
                        } else {
                            if (A > 1 && J == 0) {
                                jm(j + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                                jm(j + " #limitAmountDiv").text("( " + LS.minAmount + " : " + A + " )");
                                S = A
                            }
                        }
                    }
                    jm(j + " #productNum").val(S);
                    jm(j + " #productNum").unbind("change");
                    jm(j + " #productNum").bind("change",
                    function() {
                        var af = jm(j + " #productNum").val();
                        var ag = 1;
                        if (jm.isInteger(af)) {
                            ag = parseInt(af)
                        }
                        if (ag < S || ag == S) {
                            ag = S;
                            jm(j + " #g_decrease , .g_decrease").addClass("g_opacity50");
                            jm(j + " #g_increase , .g_increase").removeClass("g_opacity50")
                        } else {
                            if (W != -1 && (ag > W || ag == W)) {
                                ag = W;
                                jm(j + " #g_decrease , .g_decrease").removeClass("g_opacity50");
                                jm(j + " #g_increase , .g_increase").addClass("g_opacity50")
                            } else {
                                if (ag > 9999998) {
                                    ag = 9999999;
                                    jm(j + " #g_decrease , .g_decrease").removeClass("g_opacity50");
                        ...
                        jm(j + " #productNum").val(ag)
                    });
                    jm(j + " #productNum").change();
                    jm(j + " #g_decrease , .g_decrease").unbind("click.dc2");
                    jm(j + " #g_increase , .g_increase").unbind("click.ic2");
                    jm(j + " #g_decrease , .g_decrease").bind("click.dc2",
                    function() {
                        var af = jm(j + " #productNum").val();
                        var ag = 1;
                        if (jm.isInteger(af)) {
                    ...
                    jm(j + " #g_increase , .g_increase").bind("click.ic2",
                    function() {
                        var af = jm(j + " #productNum").val();
                        var ag = 1;
                        if (jm.isInteger(af)) {
                ...
                if (s) {
                    jm(j + " #mallAmount").text(F)
                }
                if (T == null) {
                    Mobi.onlyChangeSalePrice(c, n, a, q)
                } else {
                    Mobi.onlyChangeSalePrice(T, n, a, q)
                }
                if (L != null) {
                    jm(j + " #mallWeight").text(L + f)
                }
            }
            if (r.length != N.length && r.length != 1) {
                m()
            }
            if ((r.length - 1) <= N.length && r.length != 1) {
                var R = "";
                r.each(function(af, ag) {
                    if (jm(r[af]).find(".isSelected").length <= 0) {
                        R += "x_"
                    } else {
                        R += jm(r[af]).find(".isSelected").attr("data") + "_"
                    }
                });
                if (R != "") {
                ...
                var K = "";
                r.each(function(af, ah) {
                    var ag = jm(r[af]).find(".isSelected");
                    if (ag.length <= 0) {
                        K = jm(r[af])
                    }
                });
                if (K != "") {
                    var ab = K.find("label");
                    ab.each(function(af, ah) {
                        var ag = R.replace("x", jm(ab[af]).attr("data"));
                        if (jm.inArray(ag, o) >= 0) {
                            w(ab[af]);
                            jm(ab[af]).attr("isEmptyAmount", "1")
                        } else {
                            e(ab[af])
                        }
                    })
                    ...
                    r.each(function(af, ah) {
                        var ag = jm(r[af]).find("label");
                        ag.each(function(ak, aj) {
                            if (jm(ag[ak]).hasClass("isSelected")) {
                                return
                            }
                            var ai = R.split("_");
                            ai[af] = jm(ag[ak]).attr("data");
                            var al = ai.join("_");
                            if (jm.inArray(al, o) >= 0) {
                                w(ag[ak]);
                                jm(ag[ak]).attr("isEmptyAmount", "1")
                            } else {
                                e(ag[ak])
                            }
                        })
            ...
            for (var X = 0; X < r.length; X++) {
                var M = r.eq("" + X + "");
                if (M.find(".optionSelected").length > 0) {
                    Y.push(M.find(".optionSelected").attr("data"))
                } else {
                    break
                }
            }
            var V = false;
            if (Y.length <= r.length && Y.length > 1) {
                var P = Y.length;
                for (var X = 0; X < P; X++) {
                    jm.each(h,
                    function(ag, ai) {
                        var ah = ai.t2;
                        var af = ah.split("_");
                        if (ai.flag == undefined) {
                            ai.flag = 1
                        }
                        if (ai.flag == 1 && arrHasSameBegin(af, Y)) {
                            V = true;
                            return false
                        }
                    });
                    if (!V) {
                        var Q = r.eq(Y.length - 1).find("label");
                        r.eq(Y.length - 1).removeAttr("option_data");
                        Q.removeClass("optionSelected isSelected");
                        var O = Y.pop();
                        Q.each(function() {
                            if (jm(this).attr("data") == O) {
                                jm(this).hide()
                            }
                        })
                    } else {
            ...
            var ac = r.index(z);
            for (var U = ac; U < Y.length; U++) {
                var C = Y.slice(0, U + 1);
                V = false;
                for (var X = C.length; X < r.length; X++) {
                    var D = r.eq("" + X + "");
                    D.find("label").each(function() {
                        var af = jm(this).attr("data");
                        V = false;
                        jm.each(h,
                        function(ah, aj) {
                            var ai = aj.t2;
                            ...
                            if (af == ag[X] && aj.flag == 1 && arrHasSameBegin(ag, C)) {
                                V = true;
                                return false
                            }
                        });
    ...
    function w(y) {
        jm(y).css("border-style", "dashed").css("color", "#CDCDCD");
        jm("#" + jm(y).attr("for")).attr("disabled", true)
    }
    function e(y) {
        jm(y).css("border-style", "").css("color", "");
        jm(y).attr("isEmptyAmount", "");
        jm("#" + jm(y).attr("for")).removeAttr("disabled")
    }
    function m() {
...
Mobi.onlyChangeSalePrice = function(h, f, e, c) {
    ...
    var i = Mobi.salePromotionDetail.salePromotionParam;
    ...
    if (i.saleType == "1") {
        var d = parseFloat(i.other.ruleData.d[0].m);
        var a = 0;
        if (i.other.ruleData.s == "1") {
            a = h * (d / 10)
        } else {
            a = h - d
        }
...
Mobi.waterFall = function(y, B, z, m, h, l, n) {
    var c = parseInt(jm("#" + B + " .productWaterFall .style8Img").width());
    var j = _htmlFontSize;
    var o = (c * l) / (h * j);
    o = parseFloat(o.toFixed(4));
    var v = (c * m) / (z * j);
    v = parseFloat(v.toFixed(4));
    var C = jm("#" + B + " .paramPadding .paramName").css("font-size");
    if (typeof C != "object") {
        var p = C.substring(0, C.indexOf("p")) / j;
        p = parseFloat(p) + 0.2;
        jm("#" + B + " .productWaterFall .paramPadding .paramName").css("line-height", p + "rem");
    ...
    if (n == s) {
        if (Mobi.getBrowserType() == Mobi.BrowserType.FIREFOX) {
            jm("#" + B + " .productWaterFall .paramPadding .paramName").height(p + "rem")
        } else {
            jm("#" + B + " .productWaterFall .paramPadding .paramName").height(p - 0.08 + "rem")
        }
    } else {
        jm("#" + B + " .productWaterFall .paramPadding .paramName").height(p / 2 + "rem")
    }
    if (y.length == 1) {
        jm("#" + B + " .productWaterFall .style8Img").height(o + "rem");
        jm("#" + B + " .productWaterFall").eq(t).css({
            "vertical-align": "top"
        })
    } else {
        if (y.length == 2) {
            for (var t = 0; t < y.length; t++) {
                if (t % 2 == 0) {
                    jm("#" + B + " .productWaterFall .style8Img").eq(t).height(o + "rem");
                    jm("#" + B + " .productWaterFall").eq(t).css({
                        "vertical-align": "top"
                    })
                } else {
                    if (t % 2 == 1) {
                        var A = 0;
                        jm("#" + B + " .productWaterFall .style8Img").eq(t).height(v + "rem");
                        jm("#" + B + " .productWaterFall").eq(t).css({
                            position: "absolute",
                            top: A + "rem"
                        });
                        var d = parseFloat(jm("#" + B + " .productWaterFall .commonProRight").parent().parent().parent().height());
                        var q = parseFloat(jm("#" + B + " .productWaterFall .firstLastPro").parent().parent().parent().height());
                        d = d / j;
                        q = q / j;
                        if (q < d) {
                            d = d + 10 / j;
                            jm("#" + B + " .productWaterFall .firstLastPro").parent().parent().parent().parent().height(d + "rem")
                        }
                    }
                }
            }
                ...
                if (t == 0) {
                    ...
                    if (r + 1 == y.length) {
                        ...
                        if (y.length % 2 == 1) {
                            ...
                            if (y.length % 2 == 0) {
                                var b = parseFloat(jm("#" + B + " .productWaterFall .commonProRight").parent().parent().parent().height());
                                b = (b) / j;
                                var w = (b + 0.5) * ((t + 1) / 2 - 1);
                                jm("#" + B + " .productWaterFall").eq(t).css({
                                    position: "absolute",
                        ...
                        jm("#" + B + " .productWaterFall .style8Img").eq(t).height(v + "rem");
                        var b = parseFloat(jm("#" + B + " .productWaterFall .commonProRight").parent().parent().parent().height());
                        var a = parseFloat(jm("#" + B + " .productWaterFall .commonProRight").parent().parent().parent().width());
                        b = (b) / j;
                        if (t % 2 == 0) {
                            jm("#" + B + " .productWaterFall").eq(t).css({
                                "vertical-align": "top"
    ...
    if (Fai.top._manageMode) {
        var e = $("#" + B),
        E = e.find(".productWaterFall"),
        D = e.attr("_productselect") == "true" ? true: false,
        x,
        f;
        E.each(function(i, k) {
            x = $(k);
            f = x.attr("topswitch") == "off";
            waterFallImg = x.find(".waterFallImg");
            waterFallImg.wrap("<div class='J_productListImgWrap fk-productListImgWrap'></div>");
            if (f && !D) {
                x.find(".J_productListImgWrap").append("<div class='f-productListTopFlag' >置顶</div>")
            }
        })
    }
};
...
Mobi.productCrossedSlide = function(a, d, f, b) {
    ...
    if (typeof i != "object") {
        var k = i.substring(0, i.indexOf("p")) / h + 0.2;
    ...
    if (b == e) {
        if (Mobi.getBrowserType() == Mobi.BrowserType.FIREFOX) {
            ...
            jm("#" + a + " .productCrossedSlide .paramPadding .paramName").height(k - 0.08 + "rem")
        }
    } else {
        jm("#" + a + " .productWaterFall .paramPadding .paramName").height(k / 2 - 0.1 + "rem")
    }
...
Mobi.productCrossedSlideSec = function(a, d, f, b) {
    ...
    if (b == e) {
        if (Mobi.getBrowserType() == Mobi.BrowserType.FIREFOX) {
            ...
            jm("#" + a + " .productCrossedSlideSec .paramPadding .paramName").height(k - 0.08 + "rem")
        }
    } else {
        jm("#" + a + " .productWaterFall .paramPadding .paramName").height(k / 2 - 0.1 + "rem")
    }
...
Mobi.productCrossedSlideSecSwipe = function(b, H) {
    var k = Mobi.getPreviewObject(b),
    o = Mobi.getPreviewObject(H),
    J = k,
    M = parseInt(jm(o).width()),
    j = 0,
    C = o.querySelectorAll(".productCrossedSlideSec"),
    i = _htmlFontSize,
    x = C.length * 0.5 * i,
    F = jm(o),
    D = jm("#" + b),
    ...
    function K(N) {
        F.off("mouseup.prod");
        F.off("mousemove.prod");
        F.off("mouseout.prod")
    }
    function z(N) {
        D.find("div.style9Img").trigger("horizonScroll");
        D.append(E);
        r = u = N.pageX;
        q = t = N.pageY;
        F.off("mousemove.prod").on("mousemove.prod", I);
        F.off("mouseup.prod").on("mouseup.prod", B);
        F.off("mouseout.prod").on("mouseout.prod", K);
        N.preventDefault();
        N.stopPropagation()
    }
    function I(O) {
    ...
    function y(Q, S, P, R) {
        ...
        return N / O > 1 ? true: false
    }
    function s(N) {
        var O = N.touches.length > 0 ? N.touches[0] : N.chengedTouches[0];
        return {
            pageX: O.pageX,
            pageY: O.pageY
        }
    ...
    function h(N) {
        ...
        r = u = O.pageX;
        q = t = O.pageY;
        F.off("touchmove.prod").on("touchmove.prod", A);
        F.off("touchend.prod").on("touchend.prod", w);
        D.append(E)
    }
    function A(N) {
        var O = s(N);
    ...
    function w(N) {
        E.remove();
        n = r = q = u = t = undefined;
        F.off("touchmove.prod", A);
        F.off("touchend.prod", w)
    }
    if (C.length > 0) {
        j = C[0].offsetWidth * C.length
    }
    j += x;
    if (j > M) {
        if (navigator.appVersion.match(/MSIE [\d.]+/)) {
        ...
        j = j + 10;
        jm(J).css("width", j + "px");
        var p = jm.getCookie("startX") ? parseInt(jm.getCookie("startX")) : 0;
        if (Mobi.isPC()) {
            F.css({
                position: "relative",
                height: parseInt(D.height()) + "px"
            });
            D.css({
                position: "absolute",
                left: 0,
            ...
            F.off("mousedown.prod").on("mousedown.prod", z);
            F.off("mousedown.prodItem").on("mousedown.prodItem", ".J_prodItem",
            function() {
                l = jm(".editLayer");
                m = D.offset().left
            });
            F.off("click.checkMove").on("click.checkMove",
            function() {
                if (L) {
                    d = false
                } else {
            ...
            F.off("click.prodLink").on("click.prodLink", ".J_prodItem-a",
            function(N) {
                return d
            })
        } else {
            ...
            F.off("touchstart.prod").on("touchstart.prod", h);
            ...
            D.children().off("touchmove.banIScroll").on("touchmove.banIScroll",
            function(N) {
                if (n === true) {
                    N.stopPropagation()
                }
    ...
    D.find(".productCrossedSlideSec").show()
};
...
Mobi.productNewDetailEventInit = function(f) {
    ...
    j = document.getElementById("productNewDetailPanel" + z),
    p = j.querySelector(".productNewDetail .productInfoSize"),
    r = A.querySelector(".icon-gClose.proBack"),
    k = A.querySelector(".icon-noProduct.proShopping"),
    l = A.querySelector(".tabBody .userCommentInfo"),
    h = A.querySelector(".icon-gOther.proOther"),
    w = A.querySelector(".icon-share.proShare"),
    C = A.querySelector(".proOtherPanel"),
    a = j.querySelector(".J_productImmediatelyBug"),
    t = j.querySelector(".productMallBuy"),
    v = j.querySelector(".productMallShop"),
    ...
    var B = jm(".productMallShop").html(),
    s = jm(".productMallBuyPanel").html(),
    q = Mobi.initWebPage({
    ...
    function() {
        ...
        var G = jm(".productMallBuyPanel");
        G.html(B);
        var D = Fai.top._templateFrameId;
        var E = jm(".productMallBuyPanel .productAddMall");
        var F = (D >= 1015 && D < 2000);
        if (D < 2000 || D >= 3000) {
            E.css("margin-left", "0.45rem");
            if (D == 1014) {
                E.css("margin-left", "0.85rem")
            }
        }
        if (F) {
            E.css({
            ...
            G.find(".mallThemeAddCartBtn").css("margin-left", "")
        }
    ...
    var i = false;
    function x() {
        var E = document.getElementById("productMallOptionPanel"),
        F = document.getElementById("g_body").clientHeight,
        J = E.querySelector(".productMallOptionContentPanel"),
        D = E.querySelector(".productMallOptionContent"),
        G = E.querySelector(".productMallOptionMargin"),
        I = E.querySelectorAll(".productMallOptionContent>div"),
        H = true
    }
    var e;
    jm("#productNewDetailPanel" + z + " .J_productAddMall").bind("click",
    function() {
        jm(".productMallBuyPanel").html(s);
        e = 0;
        q()
    });
...
Mobi.sharePage = function(l) {
    ...
    for (var c in j) {
        var a = j[c].url,
        e = j[c].icon;
        if (e == "baidu_tieba" && Fai.top._isFaiHost) {
            k += "<a hidefocus='true' class='shareLink' href='javascript:;' onclick='Mobi.ing(\"" + LS.shareNot + "\");'><div class='shareNewIcon g_iconMiddle icon-" + e + "'></div><div class='shareText icon-" + e + "-text'></div></a>"
        } else {
            if (e == "Weixin") {
                shareIcon = true;
                k += "<a hidefocus='true' class='shareLink' id='shareLinkWeixin' href='javascript:;'><div class='shareNewIcon g_iconMiddle icon-" + e + "'></div><div class='shareText icon-" + e + "-text'></div></a>"
            } else {
        ...
        if ((parseInt(c) + 1) % 8 === 0) {
            f.push("<div class='swipImgBox'>" + k + "</div>");
            k = ""
        }
    }
    ...
    var h = "<div class='shareListPanel' id='shareListPanel'><div class='shareListContent'><div class='shareTitle'>" + LS.shareIt + "</div><div class='shareListShow' id='shareListShowSwipe' " + i + "><div class='shareListSwipe'>" + f.join("") + "</div>";
    if (j.length > 8) {
...
Mobi.onPbCommFileUploadEvent = function(j, f) {
    if (j == "upload") {
        ...
        var a = f.width;
        var h = f.height;
        Mobi.pbCommImgTableCtrl(d, i, c, e, b)
    }
};
...
Mobi.showSaleTimeCountDown = function(j, d, i, k, h, b) {
    var c = "";
    var a = LS.salePromotionBegin;
    var f = LS.salePromotionEnd;
    var e = 0;
    Mobi.salePromotionDetail.showType = i;
    ...
    Mobi.salePromotionDetail.saleCountTimeInterval = setInterval(function() {
        var p = parseInt(e / (3600 * 24));
        var l = parseInt(e / 3600) - (p * 24);
        var m = parseInt(e / 60) - (p * 24 * 60) - (l * 60);
        var o = parseInt(e % 60);
        if (Fai.top._lcid != 2052 && Fai.top._lcid != 1028) {
            if (l < 10) {
                l = "0" + l
        ...
        e--;
        if (k == 1) {
            jm(".showSaleTimeClass").html("&nbsp;&nbsp;" + jm.format(c, p, l, m, o))
        }
        if (e < 0) {
            if (i == 1) {
                e = d;
                ...
                if (Mobi.salePromotionDetail.salePromotionParam.saleType == "1") {
                    var n = jm(".J_salePrePrice").html();
                    if (n != null) {
                        jm(".J_saleMallPrice").html(n)
                    }
                }
...
Mobi.setPrImageMaxHeight = function(f, b) {
    var d = jm("#module" + f),
    b = d.find(b),
    c = b.find("img"),
    e = 0,
...
Mobi.showMallCartScreen = function(e, d, c, b, i) {
    var a = jm(".productMallOptionPanel");
    jm("#module" + e + " .J_fk-mallCart").bind("click",
    function() {
        var n = i && i.replace ? (i.replace(/&nbsp;/gi, " ").replace(/&lt;/gi, "<").replace(/&gt;/g, ">").replace(/&#92;/gi, "\\").replace(/&#39;/gi, "'").replace(/&quot;/gi, '"').replace(/\<br\/\>/gi, "\n").replace(/&amp;/gi, "&")) : i;
        jm("#productMallOptionPanel_mcs_" + e + " .productMallOptionContent").append(n);
        a = jm(".productMallOptionPanel");
        var l = jm(this).attr("id") || "";
        var k = false;
        var j = {};
        var p = "";
        var o = "";
        ...
        if (k) {
            ...
            jm.ajax({
                ...
                success: function(q) {
                    var t = jm.parseJSON(q);
                    if (t.success) {
                        var v = t.pinfo;
                        var u = t.showOptionHtml;
                        var s = t.script;
                        var r = t.otherHtml;
    ...
    function f(A, m, C, r) {
        a = jm(".productMallOptionPanel");
        var t = A.id;
        a.attr("id", "productMallOptionPanel" + t);
        var o = r.mallAmountHtml || "";
        var v = r.mallWeightHtml || "";
        var x = r.mallPriceHtml || "";
        var w = A.mallPrice;
        var n = w.toFixed(2);
        var j = n;
        var z = "";
        ...
        if (s != "" || z != "") {
            var y = parseFloat(z) * b * 0.01;
            var D = parseFloat(s) * b * 0.01;
            j = D + "~" + y
        }
        jm("#choiceCurrency").text(d);
        jm("#mallPrice").text(j);
        a.find(".mallOptionImg").attr("src", A.picPath);
        a.find(".productMallAmount").html(o);
        a.find(".productMallWeight").html(v);
        a.find(".productDetailName").html("<div class='productName g_middleColor'><div class='productNameWrap' style='word-break:break-all;white-space: normal;overflow:hidden;text-overflow:ellipsis;'></div></div>" + x);
        a.find(".productNameWrap").text(A.name);
        a.find(".J-op-box").html(m);
        ...
        l.innerHTML = 'jm(window).bind("pageshow", function(){jm("#productNum").change();});';
        l.id = "opScript2_" + e;
...
Mobi.bookingBoxBind = function(b) {
    ...
    c.push("<span class='g_close icon-gClose'></span><span class='title pageTitle'>" + LS.onlineBooking + "</span>");
    c.push("</div>");
    c.push("</div>");
...
Mobi.bookingBoxInit = function(b, e) {
    var d = b.moduleId;
    jm("#module" + d).remove();
    var f = e.content.st;
    var c = [];
    c.push("<div id='module" + b.moduleId + "'>");
    c.push("<div class='siteForm fk-siteForm-v " + (f == 1 ? "verticalShowTye": "") + "'>");
    ...
    function(h, j) {
        ...
        c.push(Mobi.genBookingInputStr(j, b, e))
    });
    if (b.validation) {
        if (f == 1) {
    ...
    c.push("<div class='siteFormAddButton " + (f == 1 ? "verticalShowTye": "") + "'>\n");
...
Mobi.mobiBookingSubmitAdd = function(b) {
    ...
    n = m,
    c = true,
    k = b.Def_LIMIT_INPUT_MAXLENTH,
    e = b.Def_LIMIT_TEXTAREA_MAXLEN,
    l = b.validation,
    i = jm("#M" + a + "siteFormValidateCode").val(),
    j = [];
    if (n.length < 1) {
        return false
    }
    ...
    function(C, A) {
        ...
        E.must = y;
        if (s == 0) {
            var G = jm.trim(jm("#M" + a + "siteFormInput" + x).val());
            if (y && G == "") {
                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(I)));
                c = false;
                return false
            }
            if (G.length > k) {
                Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(I), k));
                c = false;
                return false
            }
            E.val = G
            ...
            if (s == 1) {
                var o = jm.trim(jm("#M" + a + "siteFormTextArea" + x).val());
                if (y && o == "") {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(I)));
                    c = false;
                    return false
                ...
                if (o.length > e) {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(I), e));
                    c = false;
                    return false
                }
                E.val = o
                ...
                if (s == 2) {
                    var u = document.querySelectorAll("input[name='M" + a + "siteFormRadioR" + x + "']:checked");
                    if (y && u.length == 0) {
                        Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(I)));
                        c = false;
                        return false
                    }
                    if (u.length > 0) {
                    ...
                    if (s == 3) {
                        var v = document.querySelectorAll("input[name='M" + a + "siteFormCheckboxR" + x + "']:checked");
                        if (y && v.length == 0) {
                            Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(I)));
                            c = false;
                            return false
                        ...
                        if (s == 4) {
                            var z = jm("#M" + a + "siteFormSelect" + x).val();
                            if (y && (z.length == 0 || z == "none")) {
                                Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(I)));
                                c = false;
                                return false
                            }
                            ...
                            if (s == 5) {
                                ...
                                if (s == 6) {
                                    var G = jm("#Mobi" + a + "Calendar" + x + "Pluginsinput").val(),
                                    t = A.dateSetting ? A.dateSetting.type: 0,
                                    w = t == 1 ? jm("#Mobi" + a + "Calendar" + x + "Plugins_endinput").val() : "";
                                    if (y && (G == "" || (t == 1 && w == ""))) {
                                        Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(I)));
                                        c = false;
                                        return false
                                    ...
                                    if (s == 7) {
                                        var p = jm("#module" + a).find("#siteForm" + a + "fileName" + x);
                                        var F = {};
                                        if (y && p.attr("_tmpFileId") == "") {
                                            Mobi.ing("请选择文件上传");
                                            c = false;
                                            return false
                                        }
                                        if (p.attr("_tmpFileId") == "") {
                                            E.val = ""
                                        } else {
                                            E.val = p.attr("_fileId");
                                            F.tmpFileName = p.attr("_tmpFileName");
                                            F.fileId = E.val;
                                            F.tmpFileId = p.attr("_tmpFileId");
                                            j.push(F)
                                        }
                                    } else {
                                        if (s == 8) {
                                            var H = jm.trim(jm("#M" + a + "siteFormPhoneInput" + x).val());
                                            if (y && H == "") {
                                                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(I)));
                                                c = false;
                                                return false
                                            }
                                            if (!Mobi.isNationMobile(H) && H != "") {
                                                Mobi.ing(LS.mobileNumRegular);
                                                c = false;
                                                return false
                                            }
                                            ...
                                            if (s == 9) {
                                                var D = jm.trim(jm("#M" + a + "siteFormMailInput" + x).val());
                                                if (y && D == "") {
                                                    Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(I)));
                                                    c = false;
                                                    return false
                                                ...
                                                if (!jm.isEmail(D) && D != "") {
                                                    Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, jm.encodeHtml(I)));
                                                    c = false;
                                                    return false
                                                }
                                                E.val = D
                                                ...
                                                if (s == 10) {
                                                    var r = jm.trim(jm("#M" + a + "siteFormIndentityInput" + x).val());
                                                    if (y && r == "") {
                                                        Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(I)));
                                                        c = false;
                                                        return false
                                                    ...
                                                    if (s == 11) {
                                                        var q = jm("#M" + a + "siteFormAddressInput" + x).val();
                                                        if (y && q == "") {
                                                            Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(I)));
                                                            c = false;
                                                            return false
    ...
    var f = "pid=" + jm("#bookingPanelTriggle").data("pid") + "&submitContentList=" + jm.encodeUrl(jm.toJSON(h)) + "&vCodeId=" + a + "&validateCode=" + i + "&tmpFileList=" + jm.encodeUrl(jm.toJSON(j));
    Mobi.ing(LS.siteFormSubmitIng, -1);
    jm.ajax({
        type: "get",
        ...
        success: function(o) {
            ...
            if (o.success) {
                ...
                var p = d[b.Def_BookingSubmit_JUMP_URL];
                setTimeout(function() {
                    p.lt == 1 ? (function() {
...
Mobi.genBookingInputStr = function(t, c, h) {
    ...
    if (a == c.Def_ContentList_Type_SINGLE_LINE) {
        s = "<input type='text' class='g_itext' placeholder='" + jm.encodeHtml(b) + "' maxlength='" + c.Def_LIMIT_INPUT_MAXLENTH + "' name='M" + r + "siteFormInput" + j + "' id='M" + r + "siteFormInput" + j + "' />\n"
    } else {
                            ...
                            if (a == c.Def_ContentList_Type_DATE) {
                                ...
                                if (a == c.Def_ContentList_Type_FILE_UPLOAD) {
                                    ...
                                    if (a == c.Def_ContentList_Type_PHONE) {
                                        s = "<input type='number' class='g_itext' maxlength='11' id='M" + r + "siteFormPhoneInput" + j + "' />"
                                    } else {
...
Mobi.initOnlineServiceWidth = function() {
    var a = jm("body");
    if (a.hasClass("mobiCol24") || a.hasClass("mobiCol21")) {
        return
    }
...
Mobi.showMapService = function() {
    ...
    var c = "http://map.baidu.com/mobile/webapp/search/search/qt=s&wd=" + encodeURIComponent(b) + "&c=348&searchFlag=bigBox&version=5&exptype=dep/vt=map/?fromhash=1";
    jm("#webMapServiceBox").addClass("showMapService");
    jm("#mobiSearchMapFrame").attr("src", c);
...
Mobi.showJumpPhone = function() {
    if (Fai.top._onlineServiceJson.phone.phoneInfo.length >= 1) {
        ...
        var d = document.getElementById("g_web");
        ...
        v.id = "tablesDiv";
        c.id = "scrollTable";
        z.className = "phoneDiv";
        v.className = "tablesDiv";
        I.className = "phoneFullBg";
        c.className = "scrollTable";
        s.id = "iScrollDiv";
        d.appendChild(z);
        var E = document.getElementById("phoneDiv");
        E.appendChild(I);
        E.appendChild(v);
        v.appendChild(c);
        var y = document.getElementById("fullbg");
        var b = document.getElementById("tablesDiv");
        var r = document.getElementById("scrollTable");
        r.appendChild(s);
        var F = document.getElementById("iScrollDiv");
        y.style.height = K + "px";
        y.style.width = B + "px";
        y.style.position = "fixed";
        for (var G = 0; G < Fai.top._onlineServiceJson.phone.phoneInfo.length; G++) {
            var L = G + 1;
            var e = decodeURIComponent(Fai.top._onlineServiceJson.phone.phoneInfo[G].name);
            var N = Fai.top._onlineServiceJson.phone.phoneInfo[G].number;
            var l = document.createElement("div");
            l.id = "fullTableDiv" + L;
            l.className = "fullTableDiv";
            F.appendChild(l);
            var h = document.getElementById("fullTableDiv");
            l.innerHTML = "<a id='numberHref_" + Fai.top._onlineServiceJson.phone.type + L + "' href='tel:" + N + "'>";
            var x = E.getElementsByClassName("fullTableDiv")[G].getElementsByTagName("a")[0];
            ...
            q.id = "phoneName" + L;
            A.className = "phoneNumber tableCell";
            A.id = "phoneNumber" + L;
            f.className = "phoneOperation tableCell";
            f.id = "phoneOperation" + L;
            o.id = "phoneLine";
            o.className = "phoneLine";
            D.id = "phoneOperImg" + L;
            D.className = "phoneOperImg";
            H.appendChild(q);
            H.appendChild(A);
            H.appendChild(f);
            F.appendChild(o);
            f.appendChild(D);
            var k = document.getElementById("phoneName" + L);
            var a = document.getElementById("phoneNumber" + L);
            var p = document.getElementById("phoneOperation" + L);
            var J = document.getElementById("phoneOperImg");
        ...
        w.className = "pCancle";
        C.id = "phoneCancle";
        C.className = "phoneCancle";
        b.appendChild(w);
        w.appendChild(C);
        var j = document.getElementById("phoneCancle");
        j.innerHTML = LS.cancel;
        var M = document.documentElement.clientHeight - j.offsetHeight;
        var u = r.offsetHeight;
        if (u > M) {
            c.style.height = (document.documentElement.clientHeight - j.offsetHeight) + "px"
        }
        if (Mobi.deviceTypeIsMobi()) {
...
Mobi.mallServiceList = function() {
    var b = Fai.top._serviceList;
    var m = "<div class='serviceFullBg'></div>",
    h, d, o, c = "",
    n = "",
    a = "",
    f, k, e;
    m += "<div id='J_serviceListPanel' class='serviceListPanel'>";
    for (h = 0, d = b.length; h < d; h++) {
        o = b[h];
        showType = o.showType;
        c = o.classname;
        f = o.serviceType;
        ...
        if (k == "true") {
            ...
            e = o.filePath;
            c = "";
            a = "background-image:url(" + e + ");"
        }
        n = o.color ? ("color:" + o.color + ";") : "";
        if (showType) {
            if (o.serviceType == 0) {
                m += "<div class='serviceItem qqServiceLine'>";
                m += "<a id='qqServiceItem" + h + "' target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin=" + o.serviceAccount + "&site=qq&menu=yes'>";
                m += "<div class='serviceIcon'><span style='" + a + n + ";' class=' serviceIconText " + c + "'></span></div>";
                m += "<div class='serviceName'><span class='serviceNameText'>" + o.showFont + "</span></div>";
                m += "<div class='serviceNumber'><span class='serviceNumberText'>" + o.serviceAccount + "</span></div>";
                m += "</a>";
                m += "</div>"
            } else {
                if (o.serviceType == 1) {
                    m += "<div class='serviceItem weChatServiceLine'>";
                    m += "<a id='weChatServiceItem" + h + "' href='javascript:;' onclick='Mobi.showWeChatService(\"" + o.code + "\")'>";
                    m += "<div class='serviceIcon'><span style='" + a + n + "' class=' serviceIconText " + c + "'></span></div>";
                    m += "<div class='serviceName'><span class='serviceNameText'>" + o.showFont + "</span></div>";
                    m += "<div class='serviceNumber'><span class='serviceNumberText'></span></div>";
                    m += "</a>";
                    m += "</div>"
                } else {
                    if (o.serviceType == 2) {
                        m += "<div class='serviceItem baiduBridgeServiceLine'>";
                        ...
                        m += "<div class='serviceItem phoneServiceLine'>";
                        m += "<a id='phoneServiceItem" + h + "' href='tel:" + o.serviceAccount + "'>";
                        m += "<div class='serviceIcon'><span style='" + a + n + "' class=' serviceIconText " + c + "'></span></div>";
                        m += "<div class='serviceName'><span class='serviceNameText'>" + o.showFont + "</span></div>";
                        m += "<div class='serviceNumber'><span class='serviceNumberText'>" + o.serviceAccount + "</span></div>";
                        m += "</a>";
    ...
    m += "<div id='cancleSer' class='cancleSer'>" + LS.cancel + "</div>";
    m += "</div>";
    jm(m).appendTo(jm("body"));
    ...
    $(".serviceListPanel").mouseover(function() {
        var i = [{
            ...
            display: "text",
            className: "edit",
            evalScript: "setService();"
        }];
        if (Fai.top._manageMode) {
            Mobi.addEditLayer($(this), i, 10)
        }
    });
...
Mobi.unLoadForWechat = function() {
    ...
    if (c) {
        e.onclick = function(f) {
            var m = f.target;
            var h = jm(m).parents("a").attr("href");
            var n;
            if (h.indexOf("mailto:") !== -1 && Mobi.getPreviewWindow().Mobi.isWechat()) {
                ...
                var l = window,
                q = document,
                k = q.querySelector("body"),
                r = q.querySelector(".fk-unloadForWechatBg"),
                o = r ? r.querySelector(".fk-unloadForWechat") : null,
                p = o ? o.querySelector(".f-cross") : null,
                j = l._htmlFontSize / 40;
                k.ontouchmove = function(s) {
                    s.preventDefault()
                };
                if (r == null) {
                    n = "<div class='fk-unloadForWechatBg'>";
                    n += "  <div class='fk-unloadForWechat'>";
                    n += "      <div class='f-crossWrap'>";
                    n += "          <div class='f-cross'></div>";
                    n += "      </div>";
                    n += "      <div class='f-tipImgWrap'>";
                    n += "          <div class='f-tipImg'></div>";
                    n += "      </div>";
                    n += "      <p>微信暂不支持发送邮件功能</p>";
                    n += "      <p>请到浏览器打开！</p>";
                    n += "  </div>";
                    ...
                    q = document;
                    r = q.querySelector(".fk-unloadForWechatBg");
                    o = r.querySelector(".fk-unloadForWechat");
                    p = o.querySelector(".f-cross");
                    o.querySelector(".f-tipImg").style.transform = "scale(" + j + ", " + j + ") ";
                    p.style.transform = "scale(" + j + ", " + j + ")";
                    o.style.top = (l.screen.availHeight - o.clientWidth) / 2 - 60 + "px";
                    o.style.left = (l.screen.availWidth - o.clientWidth) / 2 + "px";
                    p.onclick = i
                } else {
    ...
    if (Mobi.isOpenBaiduBridge()) {
        ...
        if (Fai.top._manageMode) {
            ...
            if (Fai.top._oem) {
                ...
                a.push("<div id='baiduBridgeTips'>开启该功能需先接入百度商桥 <a href='http://jz.faisco.com/blog/604' target='_blank'>接入教程</a></div>")
            }
...
Mobi.initLocater = function() {
    ...
    if (!b) {
        ...
        function(j) {
            ...
            if (i.id === "multiLanguageCtrl") {
                return
            }
            var k = jm(i);
            if (k.closest("#lanSelect").length == 0) {
                Mobi.closeLanSelect()
            }
            j.stopPropagation()
        });
...
Mobi.optionsStr = {};
Mobi.mallBuying = {};
Mobi.mallBuy = function(o, m, a, u) {
    if (typeof(Mobi.mallBuying[o]) == "undefined") {
        Mobi.mallBuying[o] = false
    }
    var l = false;
    ...
    Mobi.mallBuying[o] = true;
    jm("#productNum").change();
    var n = "id=" + o + "&fromDetail=true",
    t = [],
    r = jm(".J-op"),
    k = true;
    if (a == 1) {
        r = jm("#productMallOptionPanel" + o + "[moduleId='" + u + "'] .J-op")
    }
    var c = false;
    jm(r).each(function() {
        if (c) {
        ...
        var z = jm(this),
        j = z.attr("option_name"),
        y = z.attr("data"),
        x = z.attr("type"),
        i = z.attr("option_data");
        if (i) {
            var A = {};
            A.name = y;
            A.value = parseInt(i);
            if (x != null) {
                A.name = y.replace(/^opIndept/, "");
                A.type = parseInt(x)
            }
            t.push(A);
            c = false
    ...
    if (Mobi.optionsStr[v] != "null" && Mobi.optionsStr[v]) {
        var e = Mobi.optionsStr[v].split("_"),
        w = [];
    ...
    if (t.length > 0) {
        n += "&optionList=" + jm.encodeUrl(jm.toJSON(t))
    }
    var b = jm("#productNum");
    if (jm("#productMallOptionPanel" + o + " #productNum").length != 0) {
        b = jm("#productMallOptionPanel" + o + " #productNum")
    }
    var f = b.val(),
    h = 1;
    if (jm.isInteger(f)) {
    ...
    if (m === 1) {
        ...
        d = "addIme";
        n += "&codata=" + jm.toJSON(s)
    }
    jm.ajax({
        type: "post",
        url: "ajax/order_h.jsp?cmd=" + d,
        data: n,
        error: function() {
            Mobi.ing(LS.systemError);
            Mobi.mallBuying[o] = false
            ...
            if (j.success) {
                if (m === 1) {
                    if (window.self != window.top && /(iPhone|iPad|iPod|safari)/i.test(navigator.userAgent.toLowerCase())) {
                        location.href = "mstl.jsp?immeData=" + jm.encodeUrl(jm.toJSON(s))
                    } else {
                ...
                if (j.rt == Mobi.MallAjaxErrno.authMemberNotAllow) {
                    Mobi.ing(j.data + LS.authLevelBuy)
                } else {
...
Mobi.mallCartAmountChange = function(a, c, i, h, k, b, j) {
    var l = jm(".itemLine" + a);
    var d = l.find(".buyNumber");
    var f = d.val();
    var e = 1;
    if (jm.isInteger(f)) {
        e = parseInt(f)
    ...
    if (e < h || e == h) {
        e = h;
        l.find(".icon-minisIcon").addClass("g_opacity50");
        l.find(".icon-plusIcon").removeClass("g_opacity50")
    } else {
        if ((e > k || e == k) && k != 0) {
            e = k;
            Mobi.ing(LS.mallAmountOverFlow, true);
            l.find(".icon-plusIcon").addClass("g_opacity50");
            l.find(".icon-minisIcon").removeClass("g_opacity50")
        } else {
            if (e > b && j) {
                e = b;
                l.find(".icon-plusIcon").addClass("g_opacity50");
    ...
    Mobi.ajaxChangeAmount(e, c, i);
    d.val(e);
    if (e > 1) {
        l.find(".icon-minisIcon").removeAttr("disabled")
    } else {
        l.find(".icon-minisIcon").attr("disabled", "true")
    }
};
Mobi.mallCartAmountPlus = function(a, b, d, j, i, n, c, k) {
    if (jm(a).attr("disabled") != "true") {
        var m = jm(".itemLine" + b);
        var e = m.find(".buyNumber");
        var h = e.val();
        if (jm.isInteger(h)) {
            h = parseInt(h) + 1
        }
        ...
        Mobi.ajaxChangeAmount(h, d, j);
        e.val(h);
        var l = LS.pay;
        var f = Mobi.countSelectNum();
        if (jm(".J_select").length != 0) {
            jm(".cartSettle").val(l + "(" + f + ")")
        }
        if (h > 1) {
...
Mobi.mallCartAmountMinis = function(a, b, c, i, h, k) {
    var l = jm(".itemLine" + b);
    var d = l.find(".buyNumber");
    var f = d.val();
    if (jm.isInteger(f)) {
    ...
    if (f == 0) {
        ...
        Mobi.ajaxChangeAmount(f, c, i);
        d.val(f);
        var j = LS.pay;
        var e = Mobi.countSelectNum();
        if (jm(".J_select").length != 0) {
            jm(".cartSettle").val(j + "(" + e + ")")
        }
        if (f > 1) {
            l.find(".icon-minisIcon").removeAttr("disabled")
        } else {
...
Mobi.initModuleMallAddrInfo = function(z, J, P, t, F) {
    ...
    function(j) {
        ...
        if (jm.inArray("areaBox", i.split(" ")) >= 0) {
            jm("#areaBoxClose").click();
            jm("#areaBox1").hide();
            jm("#areaBox2").hide()
        }
    ...
    function(j, R) {
        ...
        function(S, i) {
            if (t == 2052 || t == 1028) {
                h += "<div class='group_item' pid='" + i + "' pname='" + site_cityUtil.getInfo(i).name + "'>" + site_cityUtil.simpleProvinceNameStr(site_cityUtil.getInfo(i).name) + "</div>"
            } else {
                h += "<div class='group_item' pid='" + i + "' pname='" + site_cityUtil.getInfoEn(i).name + "'>" + site_cityUtil.simpleProvinceNameStrEn(site_cityUtil.getInfoEn(i).name) + "</div>"
            }
        });
        h += "</div>";
        h += "</div>"
    ...
    jm("#allArea").change(function() {
        ...
        if (jm("#allArea").val() == "cn" || jm("#allArea").val() == "os") {
            ...
            var i = u(jm("#allArea").val());
            jm("#sec_box .sec_content").append(i);
            jm("#areaBoxInput").val(jm("#areaBoxInput").val() + jm("#allArea option[value='" + jm("#allArea").val() + "']").text());
            jm(".J_ssq").hide();
            jm(".J_administrativeRegion").show();
            if (i === null || i === undefined || i === "") {
    ...
    function() {
        jm("#areaBox1 .city_content").remove();
        jm("#areaBox1 .county_content").remove();
        var i = jm(this).attr("pname");
        var j = jm(this).attr("pid");
        jm("#areaBox1 .J_areaHead .city").click();
        jm("#areaBoxInput").val("");
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + i);
        jm("#areaBoxInput").removeAttr("lastArea");
        jm("#areaBoxInput").removeAttr("lastAreaType");
        jm("#areaBoxInput").attr("area1", j);
        jm("#areaBoxInput").attr("area2", "");
        jm("#areaBoxInput").attr("area3", "");
        jm("#areaBoxInput").attr("area4", "");
        var S = "";
        if (t == 2052 || t == 1028) {
            S = c(site_cityUtil.getCities(j))
        } else {
            S = c(site_cityUtil.getCitiesEn(j))
        }
        var R = jm(S).html();
        ...
        jm("#city_box").append(S);
        jm("#mallShipTemplate_province_box .group_item[pid='" + j + "']").click()
    });
    jm("#city_box").delegate(".group_item", "click",
    function() {
        jm("#areaBox1 .county_content").remove();
        var i = jm(this).attr("cname");
        var R = jm(this).attr("cid");
        jm("#areaBox1 .J_areaHead .county").click();
        ...
        jm("#areaBoxInput").attr("lastAreaType", "city");
        jm("#areaBoxInput").attr("area2", R);
        jm("#areaBoxInput").attr("area3", "");
        jm("#areaBoxInput").attr("area4", "");
        var T = "";
        if (t == 2052 || t == 1028) {
            T = r(site_cityUtil.getCounty(R))
        } else {
            T = r(site_cityUtil.getCountyEn(R))
        }
        var S = jm(T).html();
        ...
        jm("#county_box").append(T);
        jm("#mallShipTemplate_city_box .group_item[cid='" + R + "']").click()
    });
    jm("#county_box").delegate(".group_item", "click",
    function() {
        jm("#areaBox1 .street_content").remove();
        ...
        var i = "";
        if (t == 2052 || t == 1028) {
            i = Q(site_cityUtil.getStreet(S))
        } else {
            i = Q(site_cityUtil.getStreetEn(S))
        }
        var T = jm(i).html();
        ...
        jm("#street_box").append(i);
        jm("#mallShipTemplate_county_box .group_item[cid='" + S + "']").click()
    });
    jm("#street_box").delegate(".group_item", "click",
    function() {
        var i = jm(this).attr("cname");
        var R = jm(this).attr("cid");
        var S = jm("#areaBoxInput").attr("lastArea");
        var j = jm("#areaBoxInput").attr("lastAreaType");
        if (j != null && j == "street") {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().replace(S, ""))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + i);
        jm("#areaBoxInput").attr("lastArea", "-" + i);
        jm("#areaBoxInput").attr("lastAreaType", "street");
        jm("#areaBoxInput").attr("area4", R);
        jm("#areaBox1").hide();
        jm("#areaBoxClose").click();
        jm("#mallShipTemplate_street_box .group_item[cid='" + R + "']").click()
    });
    jm("#sec_box").delegate(".group_item", "click",
    function() {
        jm("#areaBox2 .thd_content").html("");
        ...
        var j = jm("#areaBoxInput").attr("lastAreaType");
        if (j != null && j != "" && jm("#areaBoxInput").val().indexOf("-") != -1) {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().substring(0, jm("#areaBoxInput").val().indexOf("-")))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + i);
        jm("#areaBoxInput").attr("lastArea", "-" + i);
        ...
        jm("#thd_box .thd_content").append(S);
        jm("#mallShipTemplate_sec_box .group_item[cid='" + R + "']").click()
    });
    jm("#thd_box").delegate(".group_item", "click",
    function() {
        var i = jm(this).attr("cname");
        ...
        jm("#areaBoxInput").attr("lastArea", "-" + i);
        jm("#areaBoxInput").attr("lastAreaType", "thd");
        jm("#areaBoxInput").attr("area3", R);
        jm("#areaBox2").hide();
        jm("#areaBoxClose").click();
        jm("#mallShipTemplate_thd_box .group_item[cid='" + R + "']").click()
    });
            ...
            if (jm("#mallShipTemplate_province").length == 1 && d.addr_info != null) {
                ...
                if (!p) {
                    ...
                    if (t == 2052 || t == 1028) {
                        ...
                        l = site_cityUtil.getInfo(d.addr_info.countyCode).name;
                        M = site_cityUtil.getInfo(d.addr_info.cityCode).name;
                        w = site_cityUtil.getInfo(d.addr_info.provinceCode).name
                    } else {
                        a = site_cityUtil.getInfoEn(d.addr_info.streetCode).name;
                        l = site_cityUtil.getInfoEn(d.addr_info.countyCode).name;
                        M = site_cityUtil.getInfoEn(d.addr_info.cityCode).name;
                        w = site_cityUtil.getInfoEn(d.addr_info.provinceCode).name
                    }
    ...
    function() {
        ...
        for (var T = 0; T < P.length; T++) {
            ...
            if (j == "addr") {
                ...
                jm("#info_addr").text((U ? LS.orderAddr + "：": "") + S.addr)
            }
        }
    ...
    function() {
        ...
        B = false;
        if (jm(this).attr("class") == "edit") {
            y = jm(this).attr("_index")
        } else {
            y = jm(this).parent().attr("_item")
        }
        C = "editAddr";
        var i = D[y];
        jm("#editAddrInfo").find(".propItemValue").each(function() {
            var X = jm(this).attr("_field");
            jm(this).val(i[X])
        });
        var W = i.addr_info;
        if (W != null) {
            ...
            if (!S) {
                ...
                var j = "";
                if (t == 2052 || t == 1028) {
                    V = site_cityUtil.getInfo(W.streetCode).name;
                    T = site_cityUtil.getInfo(W.countyCode).name;
                    R = site_cityUtil.getInfo(W.cityCode).name;
                    j = site_cityUtil.getInfo(W.provinceCode).name
                } else {
                    V = site_cityUtil.getInfoEn(W.streetCode).name;
                    T = site_cityUtil.getInfoEn(W.countyCode).name;
                    R = site_cityUtil.getInfoEn(W.cityCode).name;
                    j = site_cityUtil.getInfoEn(W.provinceCode).name
                }
                ...
                jm("#areaBoxInput").attr("area1", W.provinceCode);
                jm("#areaBoxInput").attr("area2", W.cityCode);
                jm("#areaBoxInput").attr("area3", W.countyCode);
                jm("#areaBoxInput").attr("area4", W.streetCode);
                jm("#areaBox1 .group_item[pid='" + W.provinceCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + W.cityCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + W.countyCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + W.streetCode + "']").click()
            } else {
                jm("#allArea").val(W.provinceCode);
                jm("#allArea").change();
                jm("#areaBox2 .group_item[cid='" + W.cityCode + "']").click();
                jm("#areaBox2 .group_item[cid='" + W.countyCode + "']").click()
            }
            jm("#addrInfo_street").val(W.streetAddr)
        } else {
    ...
    function() {
        ...
        y = jm(this).parents(".selectedArea").parent().attr("_item");
        var i = {};
        i.isDefault = 1;
        k.opera = C;
        k._item = y;
        k.addrInfo = i;
        J[y]["isDefault"] = i.isDefault;
        var j = this;
        jm.ajax({
            type: "post",
            url: "ajax/member_h.jsp?cmd=set&id=" + z,
            ...
            success: function(T) {
                ...
                if (U.success) {
                    ...
                    jm(j).find(".text").text(LS.mallDefault);
                    jm(j).parents(".addrInfo").find(".cutOut").css("display", "none");
                    var S = jm(j).parents(".addrInfo");
                    D[jm(S).attr("_item")]["isDefault"] = 1
                } else {
                    Mobi.ing(U.msg)
                }
            }
    ...
    function() {
        var R = jm(this);
        y = R.parents(".selectedArea").parent().attr("_item");
        k.opera = "delAddr";
        k._item = y;
        var i = function(S, T) {
            jm.ajax({
                type: "post",
                url: "ajax/member_h.jsp?cmd=set&id=" + S,
                data: "info=" + jm.encodeUrl(jm.toJSON(k)),
                error: function() {
                    Mobi.ing(LS.systemError)
                },
                success: function(U) {
                    ...
                    if (W.success) {
                        ...
                        var V = 0;
                        jm("#addrInfoList").find(".addrInfo").each(function() {
                            if (jm(this).attr("_item") == T) {
                                jm(this).remove()
                            } else {
                                jm(this).attr("_item", V);
                                V++
                            }
                        });
                        q--;
    ...
    jm(".orderSaveAddrInfo").click(function() {
        ...
        var aa = "";
        var W = false;
        T.parent().find(".propItemValue").each(function() {
            ae = jm(this).attr("_field");
            i = jm(this).val();
            aa = jm(this).attr("_prop");
            W = jm(this).attr("_required") == "1" ? true: false;
            if (W && (i == null || i == "")) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, aa));
                this.focus();
                ad = false
            }
            if (ae == "email" && i.length > 0) {
                if (!jm.isEmail(i)) {
                    Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, aa));
                    this.focus();
                    ad = false
            ...
            if (ae == "mobile" && i.length > 0) {
                ...
                ag.mobileCt = jm(this).parent().find("#mobileCt").val()
            }
            if (ae == "mobile" && i.length <= 0) {
                ag.mobileCt = ""
            }
        ...
        var R = jm("#allArea");
        var X = !(R.val() == "os" || R.val() == "cn");
        var ab = jm("#areaBoxInput").attr("area4");
        var ac = jm("#areaBoxInput").attr("area3");
        var j = jm("#areaBoxInput").attr("area2");
        var V = jm("#areaBoxInput").attr("area1");
        var S = jm("#addrInfo_street");
        W = T.parent().find("#addrInfo_street").attr("_required") == "1" ? true: false;
        if (W) {
            if (R.val() == null || R.val() == "") {
                Mobi.ing("请选择地区", 1);
                return
        ...
        var Y = "";
        if (R.length == 1) {
            var Z = jm("#areaBoxInput");
            Y = Z.val().replace(/-/g, "") + jm("#addrInfo_street").val()
        }
        ag.addr = Y;
        ag.isDefault = af;
        k.opera = C;
            ...
            jm.ajax({
                ...
                success: function(ap) {
                    ...
                    if (al.success) {
                        ...
                        if (C == "editAddr") {
                            if (jm("#assignItemline").attr("_index") == y) {
                                var ao = ag;
                                jm("#info_name").text(ao.name);
                                jm("#info_phone").text(ao.phone);
                                jm("#assignItemline").attr("_index", y);
                                if (ao.addr == null) {
                                    jm("#info_addr").text("")
                                } else {
                                    jm("#info_addr").text(ao.addr)
                                }
                            }
                            var ai;
                            if (af) {
                                jm("#addrInfoList").find(".addrInfo").each(function() {
                                    ...
                                    if (jm(this).attr("_item") == y) {
                                        jm(this).find(".name").text(ag.name);
                                        jm(this).find(".phone").text(ak);
                                        jm(this).find("#addr").text(ag.addr);
                                        ai = jm(this)
                                    }
                                })
                            } else {
                            ...
                            if (C == "addAddr") {
                                ...
                                var an = D.length;
                                var aj = [];
                                aj.push("<div class='addrInfo' _item=" + an + ">");
                                aj.push("<div class='" + (af ? "": "middle") + " info_name' style='width:100%;'>");
                                aj.push("<div class='nameAndPhone'><span class='name'>" + ag.name + "</span><span class='phone'>" + ak + "</span></div><div class='address'><span id='addr'>" + ag.addr + "</span></div>");
                                aj.push("</div>");
                                aj.push("<div class='selectedArea' style='width: 100%;float:left;'>");
                                aj.push("<div class='left'>");
                                aj.push("<div class='selectedDiv'><label for='input" + an + "'><input type='radio' class='checkbox-comp' id='input" + an + "' name='defaultLogo'><span class='text'>设为默认</span></label></div>");
                                aj.push("</div>");
                                aj.push("<div class='right'>");
                                aj.push("<div class='edit' _index=" + an + "><span>编辑</span></div><div class='cutOut'><span>删除</span></div>");
                                aj.push("</div>");
                                aj.push("</div>");
                                aj.push("</div>");
                                jm("#addrInfo").append(aj.join(""));
                                D.push(ag);
                                jm("#editAddrInfo .g_close").click();
                                jm(".addrInfo").each(function() {
                        ...
                        jm(".addrInfo[_item='" + y + "'] .info_name").click()
                    } else {
                        Mobi.ing(al.msg)
                    }
                }
    ...
    function c(j) {
        ...
        function(R, S) {
            if (t == 2052 || t == 1028) {
                i += "<div class='group_item' cid='" + S.id + "' cname='" + site_cityUtil.getInfo(S.id).name + "'>" + site_cityUtil.simpleCityNameStr(site_cityUtil.getInfo(S.id).name) + "</div>"
            } else {
                i += "<div class='group_item' cid='" + S.id + "' cname='" + site_cityUtil.getInfoEn(S.id).name + "'>" + site_cityUtil.simpleCityNameStrEn(site_cityUtil.getInfoEn(S.id).name) + "</div>"
            }
        });
        i += "</div>";
        return i
    ...
    function r(j) {
        ...
        function(R, S) {
            if (t == 2052 || t == 1028) {
                i += "<div class='group_item' cid='" + S.id + "' cname='" + site_cityUtil.getInfo(S.id).name + "'>" + site_cityUtil.getInfo(S.id).name + "</div>"
            } else {
                i += "<div class='group_item' cid='" + S.id + "' cname='" + site_cityUtil.getInfoEn(S.id).name + "'>" + site_cityUtil.getInfoEn(S.id).name + "</div>"
            }
        });
        i += "</div>";
        return i
    ...
    function u(i) {
        ...
        jm.each(A(R),
        function(S, T) {
            j += "<div class='group_item' cid='" + T.id + "' cname='" + T.name + "'>" + T.name + "</div>"
        });
        return j
    }
};
Mobi.initModuleMallShipTemplate = function(y, b, A, l, r, n, c) {
    var h = A.vType || 1,
    t = A.sco || 0,
    e = A.openItemList;
    var q = LS.mallPleaseChoose,
    x = [],
    j,
    z,
    o,
    ...
    function(E) {
        var D = E.target.className;
        if (!D) {
            return
        }
        if (jm.inArray("areaBox", D.split(" ")) >= 0) {
    ...
    jm.each(site_cityUtil.getAreaGroupsPinYin(),
    function(D, E) {
        k += "<div class='pv_group' style='" + (E[0] == "OS" ? "display:none;": "") + "'>";
        k += "<div class='group_head'>" + E[0] + "</div>";
        k += "<div class='group_content'>";
        jm.each(E[1],
        function(G, F) {
            if (r == 2052 || r == 1028) {
                k += "<div class='group_item' pid='" + F + "' pname='" + site_cityUtil.getInfo(F).name + "'>" + site_cityUtil.simpleProvinceNameStr(site_cityUtil.getInfo(F).name) + "</div>"
            } else {
                k += "<div class='group_item' pid='" + F + "' pname='" + site_cityUtil.getInfoEn(F).name + "'>" + site_cityUtil.simpleProvinceNameStrEn(site_cityUtil.getInfoEn(F).name) + "</div>"
            }
        });
        k += "</div>";
        k += "</div>"
    });
    jm("#mallShipTemplate_areaBox1 .pv_content").html("").append(k);
    jm("#mallShipTemplate_allArea").change(function() {
        ...
        if (jm("#mallShipTemplate_allArea").val() == "cn" || jm("#mallShipTemplate_allArea").val() == "os") {
            ...
            var D = a(jm("#mallShipTemplate_allArea").val());
            jm("#mallShipTemplate_sec_box .sec_content").append(D);
            ...
            jm(".J_ssq").hide();
            jm(".J_administrativeRegion").show();
            var E = jm("#mallShipTemplate_allArea").val();
            f = false;
            if (y === 0 && c) {
                Mobi.mallStlCalcTotal();
                return
                ...
                if (t) {
                    ...
                    function(L, K) {
                        if (K.st === J.type) {
                            var M = false;
                            if (f) {
                                M = jm.inArray(parseInt(E), K.arl) > -1
                            } else {
                                M = jm.inArray(parseInt(E), K.carl) > -1
                            }
                            if (M) {
                                if (K.fc === 1) {
                                    if (h === 1) {
                    ...
                    if (I) {
                        ...
                        F.type = J.type;
                        F.defaultPrice = 0;
                        Mobi.changeShipTplPrice(F);
                        return
                    } else {
                        Mobi.changeShipTplPrice(J)
                    }
                }
                jm.each(J.regionList,
                function(R, U) {
                    var L = false;
                    if (f) {
                        L = jm.inArray(parseInt(E), U.areaList) < 0
                    } else {
                        L = jm.inArray(parseInt(E), U.cusAreaList) < 0
                    }
                    if (L) {
                        Mobi.changeShipTplPrice(J);
                        return true
                    ...
                    var Q = 0,
                    M = U.price,
                    S = U.rha == null ? 1 : U.rha,
                    T = U.ria == null ? 1 : U.ria,
                    O = U.rip || 0;
                    var P = y;
                    if (S > 0) {
                        Q = M;
    ...
    function() {
        jm("#mallShipTemplate_areaBox1 .city_content").remove();
        jm("#mallShipTemplate_areaBox1 .county_content").remove();
        var D = jm(this).attr("pname");
        var E = jm(this).attr("pid");
        jm("#mallShipTemplate_areaBox1 .J_areaHead .city").click();
        jm("#mallShipTemplate_areaBoxInput").val("");
        jm("#mallShipTemplate_areaBoxInput").val(jm("#mallShipTemplate_areaBoxInput").val() + D);
        jm("#mallShipTemplate_areaBoxInput").removeAttr("lastArea");
        jm("#mallShipTemplate_areaBoxInput").removeAttr("lastAreaType");
        jm("#mallShipTemplate_areaBoxInput").attr("area1", E);
        jm("#mallShipTemplate_areaBoxInput").attr("area2", "");
        jm("#mallShipTemplate_areaBoxInput").attr("area3", "");
        jm("#mallShipTemplate_areaBoxInput").attr("area4", "");
        var F = "";
        if (r == 2052 || r == 1028) {
            F = p(site_cityUtil.getCities(E))
        } else {
            F = p(site_cityUtil.getCitiesEn(E))
        }
        jm("#mallShipTemplate_city_box").append(F);
        jm.each(e,
        function(G, H) {
    ...
    function() {
        ...
        jm("#mallShipTemplate_areaBox1 .county_content").remove();
        var D = jm(this).attr("cname");
        var F = jm(this).attr("cid");
        jm("#mallShipTemplate_areaBox1 .J_areaHead .county").click();
        var H = jm("#mallShipTemplate_areaBoxInput").attr("lastArea");
        var E = jm("#mallShipTemplate_areaBoxInput").attr("lastAreaType");
        if (E != null && E != "") {
        ...
        jm("#mallShipTemplate_areaBoxInput").val(jm("#mallShipTemplate_areaBoxInput").val() + "-" + D);
        jm("#mallShipTemplate_areaBoxInput").attr("lastArea", "-" + D);
        jm("#mallShipTemplate_areaBoxInput").attr("lastAreaType", "city");
        jm("#mallShipTemplate_areaBoxInput").attr("area2", F);
        jm("#mallShipTemplate_areaBoxInput").attr("area3", "");
        jm("#mallShipTemplate_areaBoxInput").attr("area4", "");
        var G = "";
        if (r == 2052 || r == 1028) {
            G = i(site_cityUtil.getCounty(F))
        } else {
            G = i(site_cityUtil.getCountyEn(F))
        }
        jm("#mallShipTemplate_county_box").append(G);
        if (y === 0 && c) {
            Mobi.mallStlCalcTotal();
            return
        }
            ...
            if (t) {
                ...
                function(O, N) {
                    if (N.st === M.type) {
                        var P = false;
                        if (f) {
                            P = jm.inArray(parseInt(F), N.arl) > -1
                        } else {
                            P = jm.inArray(parseInt(F), N.carl) > -1
                        }
                        if (P) {
                            if (N.fc === 1) {
                                if (h === 1) {
                ...
                if (L) {
                    ...
                    I.type = M.type;
                    I.defaultPrice = 0;
                    Mobi.changeShipTplPrice(I);
                    return
                } else {
                    Mobi.changeShipTplPrice(M)
                }
            }
            jm.each(M.regionList,
            function(U, X) {
                var O = false;
                if (f) {
                    O = jm.inArray(parseInt(F), X.areaList) < 0
                } else {
                    O = jm.inArray(parseInt(F), X.cusAreaList) < 0
                }
                if (O) {
                    Mobi.changeShipTplPrice(M);
                    return true
                ...
                var T = 0,
                P = X.price,
                V = X.rha == null ? 1 : X.rha,
                W = X.ria == null ? 1 : X.ria,
                R = X.rip || 0;
                var S = y;
                if (V > 0) {
                    T = P;
    ...
    function() {
        jm("#mallShipTemplate_areaBox1 .street_content").remove();
        var E = jm(this).attr("cname");
        var G = jm(this).attr("cid");
        jm("#mallShipTemplate_areaBox1 .J_areaHead .street").click();
        var I = jm("#mallShipTemplate_areaBoxInput").attr("lastArea");
        var F = jm("#mallShipTemplate_areaBoxInput").attr("lastAreaType");
        if (F != null && (F == "street" || F == "county")) {
        ...
        jm("#mallShipTemplate_areaBoxInput").val(jm("#mallShipTemplate_areaBoxInput").val() + "-" + E);
        jm("#mallShipTemplate_areaBoxInput").attr("lastArea", "-" + E);
        jm("#mallShipTemplate_areaBoxInput").attr("lastAreaType", "county");
        jm("#mallShipTemplate_areaBoxInput").attr("area3", G);
        jm("#mallShipTemplate_areaBoxInput").attr("area4", "");
        var D = "";
        if (r == 2052 || r == 1028) {
            D = s(site_cityUtil.getStreet(G))
        } else {
            D = s(site_cityUtil.getStreetEn(G))
        }
        var H = jm(D).html();
        if (H === null || H === undefined || H === "") {
            jm("#mallShipTemplate_areaBox1").hide();
        ...
        jm("#mallShipTemplate_street_box").append(D);
        Mobi.mallStlCalcTotal()
    });
    ...
    function() {
        var D = jm(this).attr("cname");
        var F = jm(this).attr("cid");
        var G = jm("#mallShipTemplate_areaBoxInput").attr("lastArea");
        var E = jm("#mallShipTemplate_areaBoxInput").attr("lastAreaType");
        if (E != null && E == "street") {
            jm("#mallShipTemplate_areaBoxInput").val(jm("#mallShipTemplate_areaBoxInput").val().replace(G, ""))
        }
        jm("#mallShipTemplate_areaBoxInput").val(jm("#mallShipTemplate_areaBoxInput").val() + "-" + D);
        jm("#mallShipTemplate_areaBoxInput").attr("lastArea", "-" + D);
        jm("#mallShipTemplate_areaBoxInput").attr("lastAreaType", "street");
        jm("#mallShipTemplate_areaBoxInput").attr("area4", F);
        jm("#mallShipTemplate_areaBox1").hide();
        jm("#mallShipTemplate_areaBoxClose").click();
        Mobi.mallStlCalcTotal()
    });
    ...
    function() {
        ...
        var H = jm("#mallShipTemplate_areaBoxInput").attr("lastArea");
        var E = jm("#mallShipTemplate_areaBoxInput").attr("lastAreaType");
        if (E != null && E != "" && jm("#mallShipTemplate_areaBoxInput").val().indexOf("-") != -1) {
            jm("#mallShipTemplate_areaBoxInput").val(jm("#mallShipTemplate_areaBoxInput").val().substring(0, jm("#mallShipTemplate_areaBoxInput").val().indexOf("-")))
        }
        jm("#mallShipTemplate_areaBoxInput").val(jm("#mallShipTemplate_areaBoxInput").val() + "-" + D);
        jm("#mallShipTemplate_areaBoxInput").attr("lastArea", "-" + D);
        ...
        jm("#mallShipTemplate_areaBoxInput").attr("area3", "");
        var G = a(F);
        jm("#mallShipTemplate_thd_box .thd_content").append(G);
        if (y === 0 && c) {
            Mobi.mallStlCalcTotal();
            return
        }
        ...
        function(K, M) {
            ...
            function(U, X) {
                var O = false;
                if (f) {
                    O = jm.inArray(parseInt(v), X.areaList) < 0
                } else {
                    O = jm.inArray(parseInt(F), X.cusAreaList) < 0
                }
                if (O) {
    ...
    function() {
        ...
        jm("#mallShipTemplate_areaBoxInput").attr("area3", F);
        jm("#mallShipTemplate_areaBox2").hide();
        jm("#mallShipTemplate_areaBoxClose").click();
        if (y === 0 && c) {
            Mobi.mallStlCalcTotal();
        ...
        function(J, L) {
            if (t) {
                ...
                function(N, M) {
                    if (M.st === L.type) {
                        var O = false;
                        if (f) {
                            O = jm.inArray(parseInt(F), M.arl) > -1
                        } else {
                            O = jm.inArray(parseInt(F), M.carl) > -1
                        }
                        if (O) {
                            if (M.fc === 1) {
                                if (h === 1) {
            ...
            function(T, W) {
                var N = false;
                if (f) {
                    N = jm.inArray(parseInt(v), W.areaList) < 0
                } else {
                    N = jm.inArray(parseInt(F), W.cusAreaList) < 0
                }
                if (N) {
                    Mobi.changeShipTplPrice(L);
                    return true
...
Mobi.initUseCoupon = (function(h) {
    ...
    function i(j) {
        ...
        b = this;
        c.couponList = j;
        c.couponColorList = ["red", "orange", "yellow", "green", "blue", "pink", "purple"],
        d();
        a()
    }
    function d() {
    ...
    function f() {
        ...
        function(m, l) {
            ...
            j.push("<div>" + LS.Event + LS.name + "：" + jm.encodeHtml(l.couponName) + "</div>");
            j.push("<div>" + LS.useConditionOrderOver + Fai.top._choiceCurrencyVal + l.orderMinPrice + "</div>");
            j.push("<div>" + LS.vilidaty + "：" + l.validity + "</div>");
            j.push("</div>");
            j.push("<div class='coupon' data_id='" + l.cdId + "'>");
            j.push("<div class='coupon-left coupon-" + c.couponColorList[l.bg] + "-left'></div>");
            j.push("<div class='coupon-content coupon-color-" + c.couponColorList[l.bg] + "'>");
            ...
            j.push("</div>");
            j.push("<div class='coupon-right coupon-" + c.couponColorList[l.bg] + "-right'></div>");
    ...
    function a() {
        ...
        var j = {
            ...
            callback: function() {
                var l = Fai.top.document.querySelector(".fk-coupon-panel");
                var k = Fai.top.document.querySelector("#webPagePanelcouponLine");
                window.ontouchmove = function(o) {
                    if (l.scrollHeight == l.offsetHeight && jm(k).css("display") != "none") {
                        o.preventDefault()
                    }
                };
                var m = 1;
                requestAnimationFrame(function n() {
                    l = Fai.top.document.querySelector(".fk-coupon-panel");
                    var p = 0,
                    o = l.scrollHeight - l.clientHeight;
                    if ((o - p) == m) {
                        m = 0.5
                    }
                    var q = l.scrollTop;
...
Mobi.mallStlCalcTotal = function() {
    ...
    if (jm("#mallShipTemplate_province").length > 0) {
        var a = jm("#shipValue");
        a.attr("provinceCode", jm("#mallShipTemplate_areaBoxInput").attr("area1"));
        a.attr("cityCode", jm("#mallShipTemplate_areaBoxInput").attr("area2"));
        a.attr("countyCode", jm("#mallShipTemplate_areaBoxInput").attr("area3"));
        a.attr("streetCode", jm("#mallShipTemplate_areaBoxInput").attr("area4"));
...
Mobi.editInfoSave = function(c) {
    ...
    b.find(".propItemValue").each(function() {
        var D = jm(this).val();
        var E = jm(this).attr("id");
        var C = jm(this).attr("_field");
        if (jm(this).attr("_required") == 1 && !D && !w) {
        ...
        if (D && D.length > 0) {
            ...
            if (C == "mobile" && !Mobi.isNationMobile(D)) {
    ...
    var p = "";
    if (jm("#mallShipTemplate_province").length == 1) {
        var u = parseInt(jm("#mallShipTemplate_areaBoxInput").attr("area2"));
        var r = parseInt(jm("#mallShipTemplate_areaBoxInput").attr("isCus"));
        if (isNaN(u) && !r) {
            Mobi.ing(LS.mallStlSubmitAddrErr);
            return false
        } else {
            p = jm("#mallShipTemplate_areaBoxInput").val().replace(/-/g, "") + jm("#edit_addrDetal").val()
        }
    }
    if (jm("#allArea").length == 1) {
        p = "";
        var q = jm("#areaBoxInput");
        var h = jm("#addrInfo_street");
        var f = parseInt(q.attr("area2"));
        var l = parseInt(q.attr("area1"));
        var t = parseInt(q.attr("area3"));
        var s = parseInt(q.attr("area4"));
        var i = parseInt(q.attr("isCus"));
        var k = (h.attr("_required") == "1");
        if (k && isNaN(l)) {
            Mobi.ing(LS.mallStlSubmitAddrErr);
            return false
        } else {
            if (k && isNaN(f) && !i) {
                ...
                p = q.val().replace(/-/g, "") + jm("#addrInfo_street").val()
            }
        }
        if (isNaN(f)) {
            f = -1
    ...
    if (jm(".assignItem_line").length < 1) {
        ...
        if (Fai.top._templateFrameId >= 2000 && Fai.top._templateFrameId < 3000) {
            ...
            function(B) {
                if ((A[B])["field"] === "name") {
                    d += "<span class='addr_value flex1 info_" + (A[B])["field"] + "' id='info_" + (A[B])["field"] + "'>" + ((A[B])["value"] || "") + "</span>"
                } else {
                    if (((A[B])["field"] === "phone" && (A[B])["value"] != null && (A[B])["value"] != "") || ((A[B])["field"] === "mobile" && (A[B])["value"] != null && (A[B])["value"] != "")) {
                        if (e) {
                            return
                        }
                        e = true;
                        d += "<span class='addr_value flex1 info_phone' id='info_phone'>" + (A[B])["value"] + "</span>"
                    } else {
                        if ((A[B])["field"] === "addr") {
                            z = (A[B])["value"];
                            n = (A[B])["field"]
            ...
            d += "<span class='info_addr' id='info_addr'>" + (m || "") + "</span>";
            ...
            function(B) {
                if ((A[B])["field"] === "name") {
                    d += "<span class='item_value flex1 info_name' id='info_" + (A[B])["field"] + "'>" + (A[B])["value"] + "</span>"
                } else {
                    if (((A[B])["field"] === "phone" && (A[B])["value"] != null && (A[B])["value"] != "") || ((A[B])["field"] === "mobile" && (A[B])["value"] != null && (A[B])["value"] != "")) {
                        if (x) {
                            return
                        ...
                        x = true;
                        d += "<span class='item_value flex1 info_phone' id='info_phone'>" + (A[B])["value"] + "</span>"
                    } else {
                        if ((A[B])["field"] === "addr") {
                            z = (A[B])["value"];
                            n = (A[B])["field"]
            ...
            if (z != "" && n != "") {
                d += "<div class='item_value flex1' id='info_" + n + "'>" + z + "</div>"
            } else {
                if (p != "") {
                    d += "<div class='item_value flex1' id='info_addr'>" + p + "</div>"
                }
            }
            d += "</div>";
            d += "<div class='shipTopBg'></div>"
        ...
        var o = jm(".assignItem_line");
        o.find("#info_name").text("");
        o.find("#info_phone").text("");
        o.find("#info_addr").text("");
        if (y.name) {
            o.find("#info_name").text(y.name)
        }
        if (y.phone) {
            o.find("#info_phone").text(y.phone)
        } else {
            if (y.mobile) {
                o.find("#info_phone").text(y.mobile)
            }
        }
        if (y.addr) {
            o.find("#info_addr").text(y.addr)
        }
    }
    jm("#editCusInfo .g_close").click()
};
Mobi.mallSubmit = function(s, l, e, z, C) {
    if (!l && s === 0) {
    ...
    f.find(".propItemValue").each(function() {
        ...
        G = D.val(),
        H = D.attr("id");
        if (D.attr("_required") == 1 && !G && !w) {
            m = LS.mallStlSubmitInput + D.attr("_prop");
            Mobi.ing(m);
            jm("#linetitle1").click();
            jm("#" + H).trigger("focus");
            w = true;
        ...
        if (G && G.length > 0) {
            if (F === "email" && !jm.isEmail(G)) {
                m = LS.mallStlSubmitInput2 + D.attr("_prop");
                Mobi.ing(m);
                jm("#linetitle1").click();
                jm("#" + H).trigger("focus");
                w = true;
            ...
            if (F == "mobile" && !Mobi.isNationMobile(G)) {
                m = LS.mobileNumRegular;
                Mobi.ing(m);
                jm("#" + H).focus();
                w = true;
                return false
        ...
        if (typeof F !== "undefined") {
            if (F !== "addrDetail" && F !== "addrInfo_street") {
                B[F] = G;
                if (F == "mobile") {
                    var E = jm("#mobileCt").val();
                    if (G.length <= 0) {
                        E = ""
                    }
                    B.mobileCt = E
    ...
    var r = jm("#areaBoxInput");
    if (B.addr == null && r.length == 1) {
        var p = r.val().replace(/-/g, "") + jm("#addrInfo_street").val();
        B.addr = p
    }
    if (Mobi.orderLvMessageOpen) {
        var u = jm("#orderLeveaMsgIn").val();
        if (u.length > Mobi.orderLvMessageMaxNum) {
            u = u.substring(0, Mobi.orderLvMessageMaxNum)
        }
        B.msg = u
    } else {
        B.msg = ""
    ...
    if (jm("#mallShipTemplate_province").length == 1 && b.length == 1) {
        ...
        var q = parseInt(b.attr("cityCode"));
        var i = parseInt(b.attr("countyCode"));
        var k = parseInt(b.attr("streetCode"));
        var v = (jm("#mallShipTemplate_areaBoxInput").attr("isCus") == 1);
        if (!j || isNaN(j)) {
            m = LS.mallStlSubmitAddrErr;
            jm("#linetitle1").click()
        } else {
            if ((!q || isNaN(q)) && !v) {
                m = LS.mallStlSubmitAddrErr;
        ...
        B.shipType = parseInt(jm("#shipValue").attr("shipType"))
    }
    if (m != "") {
        Mobi.ing(m);
        return
    }
    var t = jm("#onlineBankType");
    var c = 0;
    if (t.length == 1) {
        c = parseInt(t.attr("_paymode"));
        if (c < 3) {
            B.payMode = c
        }
    }
    if ((t.length == 1) && (c > 2)) {
        c = parseInt(t.attr("_paymode"));
        if (c != 9 && c != 8 && c != 7) {
            B.payBankType = parseInt(t.attr("_type"))
        }
        B.payMode = parseInt(t.attr("_paymode"))
    }
    if (isNaN(c)) {
    ...
    if (A.length > 0) {
        ...
        if (jm.isInteger(d)) {
            ...
            if (d > a) {
                Mobi.ing(jm.format(LS.integral_notOverCurrent, jm.encodeHtml(x), jm.encodeHtml(x)));
                A.focus();
                return
            }
            if (d > h) {
                Mobi.ing(jm.format(LS.integral_notOver, jm.encodeHtml(x), h));
                A.focus();
                return
            }
            if (d < 0) {
    ...
    if (Mobi.selectCoupon && "id" in Mobi.selectCoupon && Mobi.selectCoupon.id) {
        B.cdId = Number(Mobi.selectCoupon.id)
    }
    ...
    if (l) {
        if (window.self != window.top && /(iPhone|iPad|iPod|safari)/i.test(navigator.userAgent.toLowerCase())) {
            urlArg = "imme&immeData=" + jm.encodeUrl(jm.toJSON(C))
        } else {
            urlArg = "imme"
        }
    }
    ...
    if (!l && e.length > 0) {
        jm.ajax({
            type: "post",
            url: "ajax/order_h.jsp?cmd=delItem&orderId=" + s,
            data: "itemIds=[" + e + "]",
            error: function() {
                Mobi.ing(LS.mallCartUpdateError)
            },
            success: function(D) {
                var D = jm.parseJSON(D);
                if (D.success) {
                    Mobi.ajaxSettleOrder(urlArg, B, z, l, y, s)
                } else {
                    if (D.rt == -9) {
        ...
        success: function(h) {
            ...
            if (h.success) {
                jm.ajax({
                    ...
                    success: function(i) {
                        if (e == "10" || e == "11") {
                            var j = Fai.top._lcid ? "&lcid=" + Fai.top._lcid: "";
                            window.location.href = "/wxPay/mdetail.jsp?id=" + (b ? h.oid: a) + j + "#firstSubmit"
                        } else {
                            if (e == "1" || e == "2") {
                                window.location.href = "mdetail.jsp?id=" + (b ? h.oid: a) + "&suc=true"
                            } else {
                                window.location.href = "mdetail.jsp?id=" + (b ? h.oid: a) + "#firstSubmit"
                            }
                        }
                    }
                })
...
Mobi.printOnlinePayType = function(a) {
    ...
    function(c) {
        ...
        b.push("<div class='pgBoxItem'><span class='icon-payMode payMode" + d.payMode + "'></span><a class='pgName payMode'  onclick='Mobi.setPayOnlineType(this);' _payMode='" + d.payMode + "' _name='" + d.desc + "'>" + d.desc + "</a></div>");
        b.push("</div>")
    });
    b.push("</div></div></div>");
    return b.join("")
...
Mobi.setPayOnlineType = function(d, a) {
    var d = jm(d),
    c = "",
    b = "",
    a = d.attr("_name");
    if (d.hasClass("payMode")) {
        c = d.attr("_payMode");
        jm("#onlineBankType").attr("_payMode", c)
    } else {
        if (d.hasClass("bank")) {
            c = d.attr("_payMode");
            b = d.attr("_type");
    ...
    jm(".icon-selectedPayMode").removeAttr("class").attr("class", "icon-selectedPayMode payMode" + c);
...
Mobi.checkOrderStatue = function(a) {
        ...
        function() {
            ...
            if (j) {
                if (!l) {
                    ...
                    var n = c(this).attr("_appId");
                    Mobi.getWxpayUrl(n, a)
                }
            }
        })
    }
    function e(l) {
        ...
        c.ajax({
            type: "post",
            url: "ajax/order_h.jsp?cmd=checkOrder" + m,
            data: "orderId=" + a + "&isWX=" + l,
            async: false,
            dataType: "json",
            error: function() {
                Mobi.ing(LS.mallStlSubmitError)
                ...
                if (!o.success) {
                    ...
                    if (o.rt == -3) {
                        ...
                        if (o.rt == -9) {
                            ...
                            if (o.rt == Mobi.MallAjaxErrno.outOfMallAmount) {
                                Mobi.ing(c.format(LS.mallAmountOverNameList, o.productsName))
                            } else {
                                if (o.rt == Mobi.MallAjaxErrno.OutOfAllowAmount) {
                                    Mobi.ing(c.format(LS.allowAmountOverNameList, o.productsName))
                                } else {
                                    if (o.rt == Mobi.MallAjaxErrno.payDomainError) {
                                        Mobi.ing(c.format(LS.mallPayDomainError))
                                    } else {
                                        if (o.rt == Mobi.MallAjaxErrno.notAdded) {
...
Mobi.callPay = function(d, a) {
    ...
    jm.ajax({
        ...
        success: function(f) {
            var i = jm.parseJSON(jm.decodeUrl(f));
            Mobi.closeLoading();
            if (i.success) {
                Mobi.callPayAPI(i)
            } else {
                ...
                if (! (h.match(/MicroMessenger/i) == "micromessenger")) {
                    ...
                    Mobi.ing(i.errMsg + "(请联系网站管理员)")
                }
            }
        }
    })
};
Mobi.callPayAPI = function(i) {
    var f = navigator.userAgent.toLowerCase();
    if (! (f.match(/MicroMessenger/i) == "micromessenger")) {
        if (i.result != "SUCCESS") {
            Mobi.ing((i.errMsg ? i.errMsg: "微信支付失败，请尝试在微信端进行支付"));
            return
        }
        ...
        if (a.indexOf("lcid") > 0) {
            ...
            if (j) {
                b = Mobi.getLanCodeFromLcid(j);
                b = b ? b + "/": ""
            }
        }
        var d = window.location.protocol + "//" + window.location.host + "/" + b;
        window.location.href = i.url + "&redirect_url=" + d;
        return
    }
    try {
        ...
        function c() {
            ...
            function(l) {
                if (l.err_msg != "get_brand_wcpay_request:cancel") {
                    WeixinJSBridge.log(l.err_msg)
                }
                if (l.err_msg != "get_brand_wcpay_request:ok") {
                    if (l.err_msg == "get_brand_wcpay_request:cancel") {
                    ...
                    setTimeout(function() {
                        window.location.href = "/wxPay/mdetail.jsp?id=" + jm("#wxpayBtn").attr("_orderid") + m
                    },
                    3000)
                } else {
                    Mobi.showLoading();
                    setTimeout(function() {
                        ...
                        p = "";
                        if (o.indexOf("lcid") > 0) {
                            var q = Mobi.getUrlParam(o, "lcid");
                            if (q) {
                                p = Mobi.getLanCodeFromLcid(q);
                                p = p ? p + "/": ""
                            }
                        }
                        window.location.href = "/" + p + "mdetail.jsp?id=" + jm("#wxpayBtn").attr("_orderid") + "&suc=true"
                    },
                    1000)
                }
            })
...
Mobi.getNewFlowInfo = function(c, a, d) {
    ...
    if (typeof d != "undefined" && d) {
        ...
        jm.ajax({
            ...
            data: "id=" + a,
            success: function(e) {
                var i = jm.parseJSON(e);
                flowMsgList = [];
                if (i.msgList == null || i.msgList.length === 0 || !i.success) {
                    var f = [];
                    flowMsgList.push("<div class='flowInfo'>");
                    flowMsgList.push("<div class='flowBusMsg'>");
                    flowMsgList.push("<span class='flowBusName'>" + i.flowCorpName + "</span>");
                    flowMsgList.push("<span class='flowBusNumber'>" + i.flowBillNum + "</span>");
                    ...
                    if (h > 0) {
                        ...
                        flowMsgList.push("</div>");
                        flowMsgList.push("<div class='flowFlag icon-flowFlag'></div>");
                        flowMsgList.push("<div class='flowLastNews'><span>" + i.msgList[0].context + "</span><span class='icon-flowMoreArrow'></span></div>");
                        flowMsgList.push("<div><span class='flowMsgTime'>" + i.msgList[0].time + "</span>");
                        flowMsgList.push("</div>");
                        flowMsgList.push("</div>")
                    }
                }
...
Mobi.initOrderPopUpPanel = function() {
    ...
    function c(e, i) {
        if (e == "editAddrInfo") {
            jm("#editAddrInfo").find("input,select,textarea").bind("blur",
            function() {
        ...
        if (e == "editCusInfo") {
            if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
                jm("#editCusInfo").find("input,select,textarea").bind("focus",
                function() {
                    jm("#editCusInfo").css("position", "absolute");
                    jm("body").attr("ontouchmove", "return false;")
                }).bind("blur",
                function() {
                    jm("#editCusInfo").css("position", "");
                    jm("body").removeAttr("ontouchmove")
                })
            }
        }
        var f = Fai.top.document.querySelector("#" + e);
        var d = Fai.top.document.querySelector("#webPagePanel" + i);
        window.ontouchmove = function(m) {
            if (f.scrollHeight == f.offsetHeight && jm(d).css("display") != "none") {
                var l = m.target;
                var k = (jm(l).parents(".areaBox").length > 0 || jm(l).parents(".areaBox2").length > 0);
                if (!k) {
                    m.preventDefault()
                }
            }
        ...
        requestAnimationFrame(function j() {
            ...
            var l = 0,
            k = f.scrollHeight - f.clientHeight;
            if ((k - l) == h) {
                h = 0.5
            }
            var m = f.scrollTop;
...
Mobi.changePayMode = function(b, a) {
    ...
    function c(d) {
        ...
        function(f) {
            ...
            e.push("<div class='pgBoxItem'><span class='icon-payMode payMode" + j.payMode + "'></span><a class='pgName payMode'  onclick='Mobi.changePayModeEvent(this);' _orderId='" + b + "'" + h + " _payMode='" + j.payMode + "' _name='" + j.desc + "'>" + j.desc + "</a></div>");
            e.push("</div>")
        });
        e.push("</div></div></div>");
        return e.join("")
...
Mobi.changePayModeEvent = function(e) {
    ...
    jm.ajax({
        type: "post",
        url: "ajax/order_h.jsp?cmd=setOrder" + i,
        ...
        success: function(k) {
            if (k.success) {
                ...
                if (l) {
                    var m;
                    if (j == 3) {
                        m = b + "tenpay.jsp?orderId=" + d
                    } else {
                        if (j == 4 || j == 5 || j == 6 || j == 8 || j == 12 || j == 13) {
                            m = b + "alipay.jsp?orderId=" + d
                        } else {
                            if (j == 7) {
                                m = b + "paypal.jsp?orderId=" + d
                            } else {
                                if (j == 9) {
                                    m = b + "cbpay.jsp?orderId=" + d
                                } else {
                                    if (j == 10 || j == 11) {
                                        m = "/wxPay/mdetail.jsp?id=" + d + i
                                    } else {
                                        document.location.reload();
                                        return
                                    }
                ...
                if (!m.success) {
                    ...
                    if (m.rt == -3) {
                        ...
                        if (m.rt == -9) {
                            ...
                            if (m.rt == Mobi.MallAjaxErrno.outOfMallAmount) {
                                Mobi.ing(jm.format(LS.mallAmountOverNameList, m.productsName))
                            } else {
                                if (m.rt == Mobi.MallAjaxErrno.OutOfAllowAmount) {
                                    Mobi.ing(jm.format(LS.allowAmountOverNameList, m.productsName))
                                } else {
                                    if (m.rt == Mobi.MallAjaxErrno.payDomainError) {
                                        Mobi.ing(jm.format(LS.mallPayDomainError))
                                    } else {
                                        if (m.rt == Mobi.MallAjaxErrno.notAdded) {
                ...
                jm.ajax({
                    ...
                    success: function(i) {
                        ...
                        if (S.success) {
                            ...
                            pdItem.append("<div class='orderButton' _star=" + L + " _iid=" + w + " _iprice='" + s + "' _ipath='" + p + "' _showFlag='check'  _iname='" + z + "' _pid='" + t + "'  _comment='" + jm.encodeHtml(M) + "' _pathList='" + JSON.stringify(S.imgsPathStr) + "'>" + LS.commentView + "</div>");
...
Mobi.onCommFileUploadEvent = function(k, h, d) {
    if (k == "upload") {
        ...
        var a = h.width;
        var i = h.height;
        Mobi.mListCommImgTableCtrl(e, j, c, f, b, d)
    }
};
...
Mobi.initRefundDetail = function(b, h, d, f) {
    ...
    jm("#submitRemark").click(function() {
        ...
        jm.ajax({
            ...
            data: "orderId=" + b + "&speaker=1&itemId=" + h + "&remark=" + jm.encodeUrl(i),
            error: function() {
                e = false;
                Mobi.ing("系统繁忙，请稍后重试。")
            },
            success: function(s) {
                var s = jm.parseJSON(s);
                if (s.success) {
                    Mobi.ing(LS.submitSuccess);
                    var r = new Date(s.remarkTime);
                    var p = r.getFullYear(),
                    o = r.getMonth() + 1,
                    q = r.getDate(),
                    m = r.getHours(),
                    ...
                    var j = p + "-" + o + "-" + q + " " + m + ":" + l + ":" + k;
                    var n = "";
                    n += "<div class='refundItem memberContent'>";
                    n += "<div class='icon-arrow'></div>";
                    n += "<div class='remarkTitle'>";
                    n += "<div class='item1'>" + d + "</div>";
                    n += "<div class='item2'>" + j + "</div>";
                    n += "</div>";
                    n += "<div class='remarkStatus'>" + jm.encodeHtml(i) + "</div>";
                    n += "</div>";
                    jm("#remarkList").prepend(n);
                    jm("#editRemark").hide();
                    jm("#remarkListContainer").show();
...
Mobi.initRefundPicUpload = function(d, c, e, b, i, a) {
...
Mobi.mobiRefundUpload = function(d, b, f, a) {
    ...
    var c = {
        ...
        onUploadSuccess: function(j, l) {
            var k = jm.parseJSON(l);
            if (k.success) {
                var i = {
                    status: "end",
                    id: j.id,
                ...
                1800);
                Mobi.refundPicUploadCallBack(k)
            } else {
                var i = {
                    status: "end",
                    id: j.id,
        ...
        onUploadError: function(i, j) {
            jm("#progressBody_ " + i.id).remove();
            jm("#progressWrap_" + i.id).remove();
            Mobi.ing(jm.format(LS.mobiFormSubmitFileUploadSvrBusy, jm.encodeHtml(i.name)));
            _uTime = new Date().getTime() - _uTime
        },
        view_progress: function(i) {
            var i = Math.ceil(i);
            if (isNaN(i)) {
                return
            }
    ...
    function h(i) {
        if (isNaN(Math.round(i.percent))) {
            return
        }
        if (i.status == "start") {
            var j = ['<div id="progressBody_' + i.id + '" class="bodyDisable"></div>', '<div id="progressWrap_' + i.id + '" class="bodyProgressWrap">', '<div class="progressCenter"></div>', '<div class="progressIngBody">', '<div id="progressTitle' + i.id + '" class="progressIngTitle">' + i.title + "</div>", '<div class="progressIngMission">', '<div class="mission"><div id="progress' + i.id + '" class="progress" style="width:1%;"></div></div>', '<div id="progressNum' + i.id + '" class="progressNum">0%</div>', "</div>", '<div class="progressInfo"><span id="progressTips' + i.id + '" class="progressFileSize"></span><a class="progressCancel" href="javascript:uploadCancel(\'' + i.id + "');\">取消</a></div>", "</div>", "</div>"];
            jm("body").append(j.join(""))
        } else {
            if (i.status == "ing") {
                jm("#progressTitle" + i.id).text(i.title);
                jm("#progress" + i.id).css("width", Math.round(i.percent) + "%");
                jm("#progressNum" + i.id).html(Math.round(i.percent) + "%")
            } else {
                if (i.status == "end") {
                    jm("#progressTitle" + i.id).text(i.title);
                    jm("#progressBody_" + i.id).remove();
                    ...
                    if (i.status == "error") {
                        jm("#progress" + i.id).addClass("progressError")
                    }
                }
            }
        }
...
Mobi.refundPicUploadCallBack = function(b) {
    ...
    var a = b.fileId;
    var d = "";
    d += "<div class='picDiv J_picDiv' _tmpFileId='" + c + "' _fileName='" + i + "' _fileSize='" + h + "' _fileId='" + a + "'>";
...
Mobi.initNewsEvent = function(c, n, k, m) {
    if (!c) {
        return
    }
            ...
            if (k && k.length > 0) {
                ...
                if (Fai.top._manageMode) {
                    if (sessionStorage.getItem("historyList")) {
                        jm(Fai.top.document.getElementById("returnBackButton")).click()
                    } else {
                        window.location.href = "index.jsp"
                    }
                } else {
    ...
    Mobi.scrollFadeIn("productDetailHeader" + c, "newsFigure" + c, n);
    var j = "ajax/newsComment_h.jsp?cmd=submitNewComment";
    var o = {
        triggerId: "postComment",
        panelId: "userCommentPanel",
        callback: function() {
            Mobi.postUserComment(j)
        },
        closeWebPage: "#userCommentPanel .userCommentGoBack"
    };
    Mobi.initWebPage(o);
    var i = jm("#newsDetailPanel");
    var a = i.find("video");
    var l = a.length;
    if (l > 0) {
...
Mobi.initModuleCardGraphicNewsList = function(t) {
    ...
    function s(P) {
        ...
        n = P.pageX;
        var S = n - v,
        R = parseInt(e.css("left") || 0) + S,
        i = r - c,
        Q = parseInt(d.offset().left);
        if (R > 0) {
            R = 0
        } else {
            if (R < i) {
    ...
    function y(i) {
        var i = i || window.event,
        P = i.changedTouches.length > 0 ? i.changedTouches[0] : i.touches[0];
        return {
            pageX: P.pageX,
            pageY: P.pageY
        }
...
Mobi.vote = function(e, h, c, d) {
    ...
    var i = (jm("#voteCodePanel" + e + h).css("display") == "none") ? false: true;
...
Mobi.logoSizeCompressByMargin = function() {
    ...
    n.height(0);
    var b = parseFloat(n.css("margin-top").replace("px", "")),
    i = parseFloat(n.css("margin-bottom").replace("px", "")),
    c = parseFloat(n.css("margin-left").replace("px", "")),
    m = parseFloat(n.css("margin-right").replace("px", "")),
    j = parseFloat(n.height()),
    a = parseInt(n.attr("sid")),
    l = parseInt(n.attr("pw")),
    e = parseInt(n.attr("ph")),
    d = parseFloat(k.height()),
    f = 0,
    h;
    f = Math.floor(d - b - i);
    n.height(f + "px");
    if (a != 0) {
        n.width(parseInt(n.height()) + "px")
    } else {
        h = parseInt(n.height()) * l / e;
        h = (h > k.width()) ? (k.width() - c - m) : h;
        n.width(h + "px")
    }
...
Mobi.titlePositionRefreshByLogo = function() {
    ...
    logoWidth = parseInt(e.width()),
    logoMarginLeft = parseInt(e.css("margin-left").replace("px", "")),
    logoMarginRight = parseInt(e.css("margin-right").replace("px", "")),
    headerPaddingLeft = parseInt(d.css("padding-left").replace("px", "")),
    headerPaddingRight = parseInt(d.css("padding-right").replace("px", "")),
    ...
    if (e.css("display") != "none") {
        ...
        if (d.css("text-align") == "center" && (e.hasClass("left") || e.hasClass("right"))) {
            ...
            if (e.hasClass("left")) {
                ...
                if (jm("#pageTitle").text() != "" && f.offset().left < (e.offset().left + logoWidth)) {
                ...
                if (e.hasClass("right")) {
                    ...
                    if (jm("#pageTitle").text() != "" && (f.offset().left + parseInt(f.width())) > e.offset().left) {
        ...
        if ((e.height() <= f.offset().top) && f.text() == "") {
...
Mobi.changeSiteTitleBg = function(b, f, d, e, j) {
    ...
    Mobi.showSiteTitleBgGloable.linkCoverPreViewPath = j;
    var a = jm("#headerBg");
    var c = jm("#webHeader");
    var i = jm("#headerWhiteBg");
    ...
    if (c.hasClass("mobiTitleClose")) {
        if (Fai.top._templateFrameId >= 1008 && Fai.top._templateFrameId <= 1010) {
            h.css({
                width: "100%",
                height: "0"
            })
...
Mobi.initBannerDefaultDom = function(p) {
    ...
    if (q > 1) {
        for (e = 0; e < q; e++) {
            h.push("<li " + (e == 0 ? "class='on'": "") + "></li>")
        }
    }
    h.push("</ul>");
    h.push("</div>");
    h.push("</div>");
    jm("#webBanner").html("").append(h.join(""))
};
Mobi.initSwipe = function(a, l, f) {
    ...
    if (h === 0) {
        q.querySelector(".defaultBanner").style.height = Mobi.preciseDecimal(i * 300 / 640, 2) + "px"
    } else {
        c = h - t > 0 ? (i * m < i * 300 / 640 ? Mobi.preciseDecimal(i * 300 / 640, 2) : Mobi.preciseDecimal(i * m, 2)) : Mobi.preciseDecimal(i * m, 2);
        q.style.height = c + "px"
    }
    if (!f) {
...
Mobi.bannerAnimate = {}; (function(l, L, m) {
    var f = false,
    R = 1,
    i = 0,
    V = -1,
    ...
    function b() {
        ...
        for (var X = 0; X < u.length; X++) {
            ...
            case 4:
                ...
                break;
            case 9:
                x(ab, "transformOrigin", "50% 50% " + ( - C / 2) + "px");
                x(ab, "animationDuration", U.switchingTime + "ms");
                break;
            case 10:
                x(ab, "transformOrigin", "50% 50% " + ( - Z.find(".billboardAnim").height() / 2) + "px");
                x(ab, "animationDuration", U.switchingTime + "ms");
            ...
            case 13:
                ...
                if (R === 11 || R === 12) {
                    ...
                    if (aa.indexOf("se 2.x") > -1 || aa.indexOf("36") > -1) {
                        x(ab.find(".customBanner"), "backgroundSize", "contain")
                    }
                }
                break;
            default:
...
Mobi.initMallCoupon = function(c) {
    ...
    b.find(".coupon1, .coupon2, .coupon3").bind("click",
    function() {
        if (couponClickLock) {
            clickCoupon(this)
        }
...
function receiveCoupon(a, b) {
    ...
    a.init = function(w, m, o) {
        var t = 5,
        h = e.getPreviewObject("module" + w),
        v = h.querySelectorAll(m + w + "")[0],
        k = h.querySelectorAll(".J_marqueeContainer" + w)[0],
        A;
        if (typeof h != "object" || typeof v != "object" || typeof k != "object") {
            return
        }
        var j = {
            s: true,
        ...
        if (j.sp == "normal") {
            if (j.d == "up" || j.d == "down") {
                t = ((5 * v.offsetWidth) / h.offsetWidth) * (v.offsetHeight / v.offsetWidth)
            } else {
                t = (5 * v.offsetWidth) / h.offsetWidth
            }
        } else {
            if (j.sp == "slow") {
                if (j.d == "up" || j.d == "down") {
                    t = ((10 * v.offsetWidth) / h.offsetWidth) * (v.offsetHeight / v.offsetWidth)
                } else {
                    t = (10 * v.offsetWidth) / h.offsetWidth
                }
            } else {
                if (j.d == "up" || j.d == "down") {
                    t = ((2.5 * v.offsetWidth) / h.offsetWidth) * (v.offsetHeight / v.offsetWidth)
                } else {
                    t = (2.5 * v.offsetWidth) / h.offsetWidth
                }
            }
        }
        b.extend(j, {
        ...
        var x = v.className,
        q = e.createElementByHtml("<div class='J_contentPanelCopy" + w + " f-contentPanel " + x + "'></div>"),
        r = v.parentNode,
        s = b(v).offset(),
        n = "infinite",
        y = "",
        ...
        if (j.d == "up") {
            ...
            if (j.d == "down") {
                ...
                if (j.d == "left" || j.d == "right") {
                    l = (j.d == "left") ? "rightToLeft": "leftToRight";
                    b(q).css({
                        width: s.width + "px",
                        height: s.height + "px",
                        position: "absolute",
        ...
        if (!j.mm) {
            b(r).one("webkitAnimationStart mozAnimationStart MSAnimationStart oanimationstart animationstart",
            function() {
                b(r).removeClass("fk-marqueeMoveInStyle")
            })
        }
        if (!j.mm && j.i) {
            y = "_moveIn";
            ...
            if (j.mm && !j.i) {
                ...
                if (j.mm && j.i) {
                    ...
                    if (!j.mm && !j.i) {
                        y = "_moveIn_discontinuous"
                    }
                }
            }
        }
        z = l + y + " " + (j.sp / i) + "s linear " + n;
        if (Fai.top.Fai.isIE10 && j.mm && j.i && (j.d == "down" || j.d == "right")) {
            setTimeout(function() {
                c(b(r), "animation", z)
            },
            0)
        ...
        if (!j.mm && j.i) {
            b(r).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
            function() {
                z = l + " " + j.sp + "s linear infinite";
                c(b(r), "animation", z)
            })
        } else {
            if (j.mm && !j.i) {
                b(r).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
                function() {
                    z = l + "_moveIn_discontinuous " + j.sp + "s linear infinite";
                    c(b(r), "animation", z)
                })
            }
        }
        if (! (/(iPhone|iPad|iPod|Android)/i.test(u))) {
            b(h).on("mouseover",
            function() {
                c(b(r), "animation-play-state", "paused")
            }).on("mouseout",
            function() {
                c(b(r), "animation-play-state", "running")
            })
        } else {
            b(h).on("touchstart",
            function() {
...
Mobi.shanghuaLoading = {}; (function(v, s, n) {
    var h = new Array(),
    e,
    z,
    o = 0,
    ...
    function D(F) {
        ...
        v.ajax({
            type: "post",
            url: "ajax/order_h.jsp?cmd=getMInfo&moduleId=" + F,
            data: E,
            error: function() {
                Mobi.ing(LS.systemError)
            },
            success: function(G) {
                ...
                if (J.success) {
                    ...
                    q = J.totalSize;
                    i = Math.ceil(q / 100);
                    p = "<div class='pagenationSelectDiv'><select class='pageSelect' onchange='Mobi.shanghuaLoading.jump(this.options[this.selectedIndex].value)'>";
                    for (var I = 0; I < i; I++) {
                        var H = I + 1 + "/" + i;
                        p += "<option class='pageOptions' value=" + I + ">" + H + "</option>"
                    }
                    p += "</select></div>";
                    y = h[k].length;
                    if (h[k].length != 0) {
                        ...
                        function(K, L) {
                            ...
                            o = K;
                            e.find(".orderList").append(L)
                        });
                        o++
                    }
                    w();
                    f();
                    v("#webFooter").css("height", 0)
                } else {
                    e.find(".orderList").append(J.data)
                }
    ...
    function u(E) {
        v.ajax({
            type: "post",
            url: "ajax/order_h.jsp?cmd=getMInfo&moduleId=" + z,
            data: "page=" + k,
            error: function() {
                Mobi.ing(LS.systemError)
            },
            success: function(F) {
                ...
                if (G.success) {
                    ...
                    e.find(".orderList").append(G.data)
                }
                if (E > k) {
                    k++;
                    u(E)
                    ...
                    if (h[k].length != 0) {
                        ...
                        function(I, J) {
                            ...
                            o = I;
                            e.find(".orderList").append(J)
                        });
                        o++
                    }
                    var H = e.find(".orderList_line").length;
                    if (H <= 10 && H == y) {
                        e.find(".orderList").append("<div class='pagenation'><div class='pagePrev icon-pagePrev icon-cnListP'></div>" + p + "</div>");
                        e.find(".pageSelect").val(k);
    ...
    function w() {
        if (q > 10) {
            ...
            e.find(".orderList").append("<div class='pagenation'>" + p + "</div>");
            e.find(".pageSelect").val(k)
        }
        window.onscroll = function() {
            if ((k == 0 && e.find(".orderList_line").length >= y) || (k * 100 + e.find(".orderList_line").length >= k * 100 + y)) {
                e.find(".getMInfo").remove();
                return
            }
            b = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop;
            x = e.find(".getMInfo").offset().top;
            if (x - b <= 740) {
                e.find(".getMInfo").remove();
                C();
                f()
    ...
    function C() {
        ...
        var F = e.find(".orderList_line").length;
        if (F == 100 && F < q && k == 0) {
            e.find(".orderList").append("<div class='pagenation'><div class='pageNext icon-pageNext icon-cnListN'></div>" + p + "</div>");
            e.find(".pageSelect").val(k);
    ...
    function B() {
        ...
        if (h.length > k) {
            ...
            f();
            var E = e.find(".orderList_line").length;
            if (E <= 100 && ((k * 100 + E) == q)) {
                e.find(".orderList").append("<div class='pagenation'><div class='pagePrev icon-pagePrev icon-cnListP'></div>" + p + "</div>");
                e.find(".pageSelect").val(k);
                e.find(".pagePrev").unbind().bind("click",
    ...
    function r() {
        e.find(".orderList").append("<div class='pagenation'><div class='pagePrev icon-pagePrev icon-cnListP'></div>" + p + "<div class='pageNext icon-pageNext icon-cnListN'></div></div>");
        e.find(".pageSelect").val(k);
        e.find(".pagePrev").unbind().bind("click",
        function() {
            k--;
    ...
    function f() {
        Mobi.initOrderDeleteButton(z);
        Mobi.initPayOrderImmediately(z);
        Mobi.initOrderCancelButton(z);
        Mobi.initOrderSureButton(z);
        Mobi.initFlowButton(z);
        Mobi.initCommentBtn(z, c);
        m()
    }
    function m() {
        e.find(".payButton").unbind().bind("click",
        function() {
            var G = v(this).attr("_href");
            var I = v(this).attr("_orderId");
            var E;
            ...
            if (F) {
                if (!H) {
                    ...
                    var J = v(this).attr("_appId");
                    Mobi.getWxpayUrl(J, E)
                }
            }
        })
    }
                ...
                if (!H.success) {
                    ...
                    if (H.rt == -3) {
                        ...
                        if (H.rt == -9) {
                            ...
                            if (H.rt == Mobi.MallAjaxErrno.outOfMallAmount) {
                                Mobi.ing(v.format(LS.mallAmountOverNameList, H.productsName))
                            } else {
                                if (H.rt == Mobi.MallAjaxErrno.OutOfAllowAmount) {
                                    Mobi.ing(v.format(LS.allowAmountOverNameList, H.productsName))
                                } else {
                                    if (H.rt == Mobi.MallAjaxErrno.payDomainError) {
                                        Mobi.ing(v.format(LS.mallPayDomainError))
                                    } else {
                                        if (H.rt == Mobi.MallAjaxErrno.notAdded) {
                                            Mobi.ing(v.format(LS.mallProductNotAdded))
                                        } else {
                                            Mobi.ing(LS.mallStlSubmitError)
                                        }
                                    }
...
Mobi.initFixAreaEvent = function() {
    ...
    function(c) {
        ...
        var d = jm(this);
        d.find(".J_clickAnimate").css("opacity", "0");
...
Mobi.initTabModuleStyle = function(z, F) {
    var b = jm("#module" + z),
    B = b.find(".J_formTabButtonWrap"),
    n = B.find(".J_formTabButtonList"),
    r = n.find(".J_formTabButton"),
    q = b.find(".J_formTabContent"),
    ...
    e,
    w;
    r.off("mouseover.action").on("mouseover.action",
    function() {
    ...
    function() {
        m = jm(this);
        r.removeClass("formTabButtonClick");
        m.addClass("formTabButtonClick");
        A = m.attr("tabmoduleid");
        w = jm("#module" + A);
        if (typeof A == "undefined") {
            return
        }
        b.find(".J_formTabContent").removeClass("formTabCntIdClick");
        b.find("#formTabContent" + A).removeClass("f-hideTabModule").addClass("formTabCntIdClick");
        Mobi.triggerAllLazyLoad();
        Mobi.inTabMaqueeHelper.runInTabMarquee(A);
        if (Fai.top._manageMode) {
            Mobi.refreshEditTabLayoutBorder(z)
        }
        Mobi.tabModuleHelper.autoMoveTabPos(m, B, a);
        Mobi.initFooterHeight()
    });
    if (Fai.top.Mobi.getPreviewDocument().URL.length > 0) {
        var j = Fai.top.Mobi.getPreviewDocument().location.search,
        d = j.indexOf("pageno"),
        i,
        f,
        y,
        ...
        if (d > -1) {
            ...
            i = c.indexOf("m");
            C = parseInt(c.substring(0, i).split("").reverse().join(""));
            if (C > 0) {
                r.each(function(G, H) {
                    if (parseInt(jm(this).attr("tabmoduleid")) == C) {
                        u = G;
                        return false
                    }
                })
    ...
    if (s <= h) {
        n.css("width", "100%");
        B.find(".J_preBtn").remove();
        B.find(".J_nextBtn").remove();
        return
    }
    if (B.find(".J_preBtn").length > 0 || o) {
        return
    }
    jm("<div class='J_preBtn f-preBtn faisco-icons'></div><div class='J_nextBtn f-nextBtn faisco-icons'></div>").appendTo(B);
    p = B.offset();
    B.find(".J_preBtn").on("click",
    function() {
        preBtn = jm(this);
        x = preBtn.siblings(".J_nextBtn");
        r = n.find(".J_formTabButton");
        D = n.offset();
        t = r.eq(0).offset();
        if (t.left >= p.left) {
    ...
    B.find(".J_nextBtn").on("click",
    function() {
        x = jm(this);
        preBtn = x.siblings(".J_preBtn");
        r = n.find(".J_formTabButton");
        D = n.offset();
        t = r.eq(r.length - 1).offset();
        if (t.right <= p.right) {
            return
        }
        e = D.left - l;
        e = e + p.width < p.right ? e: (p.width - (n[0].offsetLeft + n.width()));
        n.css("left", e + "px");
        preBtn.addClass("disable");
        x.addClass("disable");
        setTimeout(function() {
...
Mobi.inTabMaqueeHelper = {
    ...
    a.initTabCallBack = function(e) {
        ...
        f.each(function(i, j) {
            ...
            if (parseInt(h.attr("styleid")) == 41) {
                setTimeout(function() {
                    var k = h.find(".form img"),
                    n = k.length,
                    m = 0;
                    for (var l = 0; l < k.length; l++) {
                        var o = new Image();
                        o.src = k.eq(l).attr("src");
                        o.onload = function() {
                            m++;
                            if (m == n) {
    ...
    a.autoMoveTabPos = function(j, e, r) {
        var n = j.offset(),
        i = parseInt(j.width()),
        k = n.left,
        q = k + i,
        ...
        if (q >= p) {
            ...
            if (k <= d) {
                if (o) {
                    m = e[0].scrollLeft >= i ? i: e[0].scrollLeft;
                    h = setInterval(function() {
                        if (m > 0) {
                            m -= 2;
                            e[0].scrollLeft -= 2
...
Mobi.initSimpleTextContent = function(b, m) {
    var c = jm("#module" + b),
    h = c.find(".fkEditor"),
    d = c.find(".simpleText"),
    k = parseInt(c.css("top") || 0),
    e = parseInt(c.css("left") || 0),
    f = 20.5,
    a = c.width().replace("rem", ""),
    l = 0,
    i = "",
    j = "";
    i = Fai.top._manageMode ? h: d;
    if (m != 1) {
        if (c.is(":visible")) {
            c.css("height", "auto");
            ...
            if (Fai.top._manageMode) {
                l = parseInt(h.attr("_autowidth") || 1);
                l && (a = parseInt(h.attr("_width") || 180) / f)
            } else {
...
var checkNode = {
    ...
    returnChangeUnit: function(a) {
        var b = -1;
        if (this.getIstoRem()) {
            b = a.indexOf("px");
            return (b >= 0) ? parseInt(a) / this._htmlFontSize + "rem": a
        } else {
            b = a.indexOf("rem");
            return (b >= 0) ? Math.round(a.replace("rem", "") * this._htmlFontSize) + "px": a
        }
    },
    ...
    checkCurrentTagStyle: function(h) {
        ...
        for (b = 0; b < e.length; b++) {
            ...
            c = jm.trim(d[0]);
            j = jm.trim(d[1]);
            if (this.checkInArray(f, c)) {
                if (j != undefined) {
                    h.css(c, this.returnChangeUnit(j))
                }
            }
        }
    },
    traverseTagStyle: function(c) {
        if (!c.length) {
            return
        } else {
            this.checkCurrentTagStyle(c)
        }
        var b = c.children(),
        a = 0;
        if (b.length <= 0) {
...
Mobi.changeMorePosition = function(d) {
    ...
    if (d === 1) {
        for (var b = 0; b < a; b++) {
            var i = e[b],
            h = i.id || "",
            c = i.querySelector(".formBannerMore" + h.replace("module", ""));
            if (!c) {
                continue
            }
            i.appendChild(c)
        ...
        for (var b = 0; b < a; b++) {
            var i = e[b],
            f = i.querySelector(".formBannerTitle>.titleCenter"),
            h = i.id || "",
            c = i.querySelector(".formBannerMore" + h.replace("module", ""));
            f.appendChild(c)
        }
...
Mobi.scrollNavFix = function() {
    ...
    function a() {
        var j = f.scrollTop,
        i = document.getElementById("webContainerBox").offsetTop - j;
        if (j > d) {
            if (i < 0) {
...
Mobi.fixImageHeightPhoList = function(b, e) {
            ...
            s.onload = function() {
                ...
                if (e == 2 && o == m) {
                    for (var w = 0; w < m; w++) {
                        ...
                        var t = i / u;
                        if (t <= x) {
                            jm(a[w]).css("width", x * u + "px");
                            jm(a[w]).css("height", u + "px");
                            jm(a[w]).css("maxWidth", "initial");
                            jm(d[w]).css("marginLeft", ((i - x * u) / 2) + "px");
                            jm(h[w]).css({
                                position: "relative",
                                overflow: "hidden"
                            });
                            jm(k[w]).css("display", "none")
                        } else {
                            jm(a[w]).css("height", i / x + "px");
                            jm(a[w]).css("width", i + "px");
                            jm(a[w]).css("marginTop", ((u - i / x) / 2) + "px");
                            jm(d[w]).css("overflow", "hidden");
                            jm(k[w]).css("display", "none")
                        }
                    }
                }
    ...
    function l() {
        var r = 0,
        q = 0,
        s = jm("#" + b).find(".photoListImg"),
        i = jm("#" + b).find(".imgClass_160");
        s.each(function() {
            q = Math.ceil(parseFloat(jm(this).height()));
            if (q > r) {
                r = q
            }
        });
        if (e == 2) {
            ...
            if (r != 0) {
                i.css("height", (r / _htmlFontSize) + "rem")
            }
        }
        o++
    }
...
Mobi.defImageHeightType2 = function(b, e) {
            ...
            v.onload = function() {
                ...
                if (e == 2 && q == n) {
                    for (var z = 0; z < n; z++) {
                        ...
                        var w = i / x;
                        if (w <= A) {
                            jm(a[z]).css("width", A * x + "px");
                            jm(a[z]).css("height", x + "px");
                            jm(a[z]).css("maxWidth", "initial");
                            jm(a[z]).css("marginLeft", ((i - A * x) / 2) + "px");
                            jm(h[z]).css({
                                position: "relative",
                                overflow: "hidden"
                            });
                            jm(l[z]).css("display", "none")
                        } else {
                            jm(a[z]).css("height", i / A + "px");
                            jm(a[z]).css("width", i + "px");
                            jm(a[z]).css("marginTop", ((x - i / A) / 2) + "px");
                            jm(l[z]).css("display", "none")
                        }
                    }
                }
    ...
    function m() {
        var u = 0,
        t = 0,
        v = jm("#" + b).find(".photoListImg"),
        i = jm("#" + b).find(".imgClass_160");
        v.each(function() {
            t = parseInt(jm(this).height());
            if (t > u) {
                u = t
            }
        });
        if (e == 2) {
            ...
            if (u != 0) {
                i.css("height", (u / _htmlFontSize) + "rem")
            }
        }
        q++
    }
...
Mobi.initMobiPageWithLogDog = function() {
    ...
    function a() {
        ...
        n = Fai.top._manageMode ? f: k;
        i = (b.width * d) * (b.height * d);
        n = c(n);
        h = n[i] || n.other;
...
Mobi.bindBodyScrollTypeWritingEvent = function() {
    function d(e, h) {
        ...
        var f = function(i) {
            if (i.target != e && i.target.tagName != "INPUT" && i.target.tagName != "TEXTAREA") {
                setTimeout(function() {
                    e.blur();
...
Mobi.statisticalMobiVisitors = function(k) {
    if (!k) {
        return
    }
    var e = {
    ...
    if (!j.match(/AppleWebKit.*Mobile.*/) && !j.match(/ipad/i)) {
        b = "pc"
    } else {
        if (j.match(/ipad/i)) {
            b = "ipad"
        } else {
            if (j.match(/android/i)) {
                b = "android"
            } else {
                if (j.match(/iphone/i)) {
                    b = "iphone"
    ...
    if (Fai.top._manageMode) {
        ...
        i = Fai.top.Fai.getScreenType(Fai.top.Fai.Screen().width, Fai.top.Fai.Screen().height)
    } else {
        d = Mobi.getBrowserType();
        i = Mobi.getScreenType(Mobi.Screen().width, Mobi.Screen().height);
...
Mobi.bindTouchEvent = function(n, t, d) {
    var p = jm(n),
    s = Fai.top.navigator.userAgent,
    j = /(iPhone|iPad|iPod|iOS|Android)/i.test(s),
    l = /(MQQBrowser)/i.test(s),
    e = /(iPhone|iPad|iPod|iOS)/i.test(s),
    f = Mobi.isWechat(),
    k = _htmlFontSize,
    v = _htmlFontSize,
    o = false,
    ...
    p.each(function(w, x) {
        ...
        function(y) {
            m = u(m);
            i = h(y);
            m.mouseDownX = i.pageX;
            m.mouseDownY = i.pageY;
            if (!t) {
                return
            }
            q(this, t, y);
        ...
        function(y) {
            ...
            m.mouseUpX = i.pageX;
            m.mouseUpY = i.pageY;
            if (! (m.mouseDownX == m.mouseUpX && m.mouseDownY == m.mouseUpY)) {
                m.touchMove = true
            }
            if (m.mouseDownX > (m.mouseUpX + k)) {
                m.toLeft = true
            } else {
                if ((m.mouseDownX + k) < m.mouseUpX) {
                    m.toRight = true
                }
            }
            if (m.mouseUpY - m.mouseDownY > v) {
                m.toBottom = true
            } else {
                if (m.mouseDownY - m.mouseUpY > v) {
                    m.toTop = true
                }
            }
            q(this, d, y);
            if (d.stopPropagation && !j) {
                y.stopPropagation();
                y.preventDefault()
            }
        });
        if (j) {
            ...
            function() {
                i = h(event);
                o = Math.abs(i.pageY - m.mouseDownY) >= v;
                if (d.stopPropagation && !o && !(e && f)) {
    ...
    function q(A, y, z) {
        ...
        for (x = 0; x < y.args.length; x++) {
            w.push(y.args[x])
        }
        w.push(m);
        w.push(z);
        y.callBack.apply(A, w)
    }
    function h(w) {
        var x = w || window.event;
        if ("ontouchstart" in window) {
            x = !!w.changedTouches && w.changedTouches.length > 0 ? w.changedTouches[0] : w.touches[0]
        }
        return {
            pageX: x.pageX,
            pageY: x.pageY
...
Mobi.loadImgAlone = function(i, b) {
    var c = jm("#module" + i),
    d = jm(window).width(),
    h = jm(window).height(),
    a,
    ...
    if (c.hasClass("formStyle3")) {
        ...
        case 1:
        case 31:
            lazyLoadProductList_2(h, i, 1);
            break;
        case 3:
            lazyLoadProductList_2(h, i, 2);
            break;
        case 7:
            lazyLoadProductList_7(d, i);
            break;
        case 8:
            lazyLoadProductList_8(h, i);
            break;
        case 9:
            lazyLoadProductList_9(d, i);
            break;
        default:
        }
    } else {
        if (c.hasClass("formStyle31")) {
            lazyloadCubeNavigation(h, i)
        } else {
            if (c.hasClass("formStyle41")) {
                e = b;
                if (e == 3) {
                    lazyloadMultiPhotoList_3(h, i)
                }
            } else {
